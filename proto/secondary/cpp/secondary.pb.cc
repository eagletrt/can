...
static ::_pb::Metadata file_level_metadata_secondary_2eproto[25];
...
const ::_pbi::DescriptorTable descriptor_table_secondary_2eproto = {
    false, false, 3528, descriptor_table_protodef_secondary_2eproto,
    "secondary.proto",
    &descriptor_table_secondary_2eproto_once, nullptr, 0, 25,
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&apps_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&bse_rear_) -
    reinterpret_cast<char*>(&apps_)) + sizeof(bse_rear_));
}
...
uint8_t* PEDALS_OUTPUT::_InternalSerialize(
  ...
  if (this->_internal_apps() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(1, this->_internal_apps(), target);
  }

  // uint32 bse_front = 2;
  if (this->_internal_bse_front() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(2, this->_internal_bse_front(), target);
  }

  // uint32 bse_rear = 3;
  if (this->_internal_bse_rear() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_bse_rear(), target);
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata CONTROL_OUTPUT::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_secondary_2eproto_getter, &descriptor_table_secondary_2eproto_once,
      file_level_metadata_secondary_2eproto[22]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata STEERING_ANGLE::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_secondary_2eproto_getter, &descriptor_table_secondary_2eproto_once,
      file_level_metadata_secondary_2eproto[23]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Pack::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_secondary_2eproto_getter, &descriptor_table_secondary_2eproto_once,
      file_level_metadata_secondary_2eproto[24]);
}
