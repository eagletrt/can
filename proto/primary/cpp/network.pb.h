...
class MARKER final :
 ...
 public:
  ...
  enum : int {
    kInternalTimestampFieldNumber = 1,
  };
...
class INV_L_SET_TORQUE final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:primary.INV_L_SET_TORQUE) */ {
 public:
  inline INV_L_SET_TORQUE() : INV_L_SET_TORQUE(nullptr) {}
  ~INV_L_SET_TORQUE() override;
  explicit PROTOBUF_CONSTEXPR INV_L_SET_TORQUE(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  INV_L_SET_TORQUE(const INV_L_SET_TORQUE& from);
  INV_L_SET_TORQUE(INV_L_SET_TORQUE&& from) noexcept
    : INV_L_SET_TORQUE() {
    *this = ::std::move(from);
  }

  inline INV_L_SET_TORQUE& operator=(const INV_L_SET_TORQUE& from) {
    CopyFrom(from);
    return *this;
  }
  inline INV_L_SET_TORQUE& operator=(INV_L_SET_TORQUE&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const INV_L_SET_TORQUE& default_instance() {
    return *internal_default_instance();
  }
  static inline const INV_L_SET_TORQUE* internal_default_instance() {
    return reinterpret_cast<const INV_L_SET_TORQUE*>(
  ...
  inline void Swap(INV_L_SET_TORQUE* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(INV_L_SET_TORQUE* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  INV_L_SET_TORQUE* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<INV_L_SET_TORQUE>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const INV_L_SET_TORQUE& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const INV_L_SET_TORQUE& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(INV_L_SET_TORQUE* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "primary.INV_L_SET_TORQUE";
  }
  protected:
  explicit INV_L_SET_TORQUE(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:primary.INV_L_SET_TORQUE)
 private:
  class _Internal;
...
class Pack final :
 ...
 public:
  ...
  enum : int {
    ...
    kTLMSTATUSFieldNumber = 8,
    kSTEERSYSTEMSTATUSFieldNumber = 9,
    kHVVOLTAGEFieldNumber = 10,
  ...
  ::primary::INV_L_SET_TORQUE* mutable_inv_l_set_torque(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::primary::INV_L_SET_TORQUE >*
      mutable_inv_l_set_torque();
  private:
  const ::primary::INV_L_SET_TORQUE& _internal_inv_l_set_torque(int index) const;
  ::primary::INV_L_SET_TORQUE* _internal_add_inv_l_set_torque();
  public:
  const ::primary::INV_L_SET_TORQUE& inv_l_set_torque(int index) const;
  ::primary::INV_L_SET_TORQUE* add_inv_l_set_torque();
...
// uint64 _internal_timestamp = 3;
inline void STEER_VERSION::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t STEER_VERSION::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t STEER_VERSION::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.STEER_VERSION._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void STEER_VERSION::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void STEER_VERSION::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.STEER_VERSION._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void DAS_VERSION::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t DAS_VERSION::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t DAS_VERSION::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.DAS_VERSION._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void DAS_VERSION::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void DAS_VERSION::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.DAS_VERSION._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void HV_VERSION::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_VERSION::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_VERSION::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_VERSION._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_VERSION::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_VERSION::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_VERSION._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void LV_VERSION::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t LV_VERSION::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t LV_VERSION::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.LV_VERSION._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void LV_VERSION::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void LV_VERSION::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.LV_VERSION._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void TLM_VERSION::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t TLM_VERSION::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t TLM_VERSION::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.TLM_VERSION._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void TLM_VERSION::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void TLM_VERSION::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.TLM_VERSION._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void TIMESTAMP::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t TIMESTAMP::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t TIMESTAMP::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.TIMESTAMP._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void TIMESTAMP::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void TIMESTAMP::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.TIMESTAMP._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void SET_TLM_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_TLM_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_TLM_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_TLM_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_TLM_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SET_TLM_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SET_TLM_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void TLM_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t TLM_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t TLM_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.TLM_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void TLM_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void TLM_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.TLM_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void STEER_SYSTEM_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t STEER_SYSTEM_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t STEER_SYSTEM_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.STEER_SYSTEM_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void STEER_SYSTEM_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void STEER_SYSTEM_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.STEER_SYSTEM_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void HV_VOLTAGE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_VOLTAGE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_VOLTAGE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_VOLTAGE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_VOLTAGE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_VOLTAGE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_VOLTAGE._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void HV_CURRENT::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_CURRENT::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_CURRENT::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_CURRENT._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_CURRENT::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_CURRENT::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_CURRENT._internal_timestamp)
}
...
// uint64 _internal_timestamp = 4;
inline void HV_TEMP::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_TEMP::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_TEMP::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_TEMP._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_TEMP::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_TEMP::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_TEMP._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void HV_ERRORS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_ERRORS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_ERRORS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_ERRORS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_ERRORS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_ERRORS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_ERRORS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void TS_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t TS_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t TS_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.TS_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void TS_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void TS_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.TS_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void SET_TS_STATUS_DAS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_TS_STATUS_DAS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_TS_STATUS_DAS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_TS_STATUS_DAS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_TS_STATUS_DAS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SET_TS_STATUS_DAS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SET_TS_STATUS_DAS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void SET_TS_STATUS_HANDCART::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_TS_STATUS_HANDCART::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_TS_STATUS_HANDCART::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_TS_STATUS_HANDCART._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_TS_STATUS_HANDCART::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SET_TS_STATUS_HANDCART::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SET_TS_STATUS_HANDCART._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void STEER_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t STEER_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t STEER_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.STEER_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void STEER_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void STEER_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.STEER_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void SET_CAR_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_CAR_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_CAR_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_CAR_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_CAR_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SET_CAR_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SET_CAR_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 3;
inline void SET_PEDALS_RANGE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_PEDALS_RANGE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_PEDALS_RANGE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_PEDALS_RANGE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_PEDALS_RANGE::_internal_set__internal_timestamp(uint64_t value) {
...
// uint64 _internal_timestamp = 4;
inline void CAR_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t CAR_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t CAR_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.CAR_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void CAR_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void CAR_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.CAR_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void DAS_ERRORS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t DAS_ERRORS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t DAS_ERRORS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.DAS_ERRORS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void DAS_ERRORS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void DAS_ERRORS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.DAS_ERRORS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void LV_CURRENT::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t LV_CURRENT::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t LV_CURRENT::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.LV_CURRENT._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void LV_CURRENT::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void LV_CURRENT::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.LV_CURRENT._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void LV_VOLTAGE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t LV_VOLTAGE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t LV_VOLTAGE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.LV_VOLTAGE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void LV_VOLTAGE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void LV_VOLTAGE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.LV_VOLTAGE._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void LV_TOTAL_VOLTAGE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t LV_TOTAL_VOLTAGE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t LV_TOTAL_VOLTAGE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.LV_TOTAL_VOLTAGE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void LV_TOTAL_VOLTAGE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void LV_TOTAL_VOLTAGE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.LV_TOTAL_VOLTAGE._internal_timestamp)
}
...
inline uint64_t LV_TEMPERATURE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t LV_TEMPERATURE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.LV_TEMPERATURE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void LV_TEMPERATURE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void LV_TEMPERATURE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.LV_TEMPERATURE._internal_timestamp)
}
...
// uint64 _internal_timestamp = 4;
inline void COOLING_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t COOLING_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t COOLING_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.COOLING_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void COOLING_STATUS::_internal_set__internal_timestamp(uint64_t value) {
...
// uint64 _internal_timestamp = 1;
inline void MARKER::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t MARKER::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t MARKER::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.MARKER._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void MARKER::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void MARKER::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.MARKER._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void HV_CELLS_VOLTAGE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_CELLS_VOLTAGE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_CELLS_VOLTAGE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_CELLS_VOLTAGE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_CELLS_VOLTAGE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_CELLS_VOLTAGE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_CELLS_VOLTAGE._internal_timestamp)
}
...
// uint64 _internal_timestamp = 9;
inline void HV_CELLS_TEMP::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_CELLS_TEMP::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_CELLS_TEMP::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_CELLS_TEMP._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_CELLS_TEMP::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_CELLS_TEMP::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_CELLS_TEMP._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void HV_CELL_BALANCING_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HV_CELL_BALANCING_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HV_CELL_BALANCING_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HV_CELL_BALANCING_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HV_CELL_BALANCING_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HV_CELL_BALANCING_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HV_CELL_BALANCING_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void SET_CELL_BALANCING_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SET_CELL_BALANCING_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SET_CELL_BALANCING_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SET_CELL_BALANCING_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SET_CELL_BALANCING_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SET_CELL_BALANCING_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SET_CELL_BALANCING_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 2;
inline void HANDCART_STATUS::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t HANDCART_STATUS::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t HANDCART_STATUS::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.HANDCART_STATUS._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void HANDCART_STATUS::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void HANDCART_STATUS::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.HANDCART_STATUS._internal_timestamp)
}
...
// uint64 _internal_timestamp = 5;
inline void SPEED::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t SPEED::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t SPEED::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.SPEED._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void SPEED::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void SPEED::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.SPEED._internal_timestamp)
}
...
// uint32 reg_id = 1;
inline void INV_L_SET_TORQUE::clear_reg_id() {
  reg_id_ = 0u;
}
inline uint32_t INV_L_SET_TORQUE::_internal_reg_id() const {
  return reg_id_;
}
inline uint32_t INV_L_SET_TORQUE::reg_id() const {
  // @@protoc_insertion_point(field_get:primary.INV_L_SET_TORQUE.reg_id)
  return _internal_reg_id();
}
inline void INV_L_SET_TORQUE::_internal_set_reg_id(uint32_t value) {
  
  reg_id_ = value;
}
inline void INV_L_SET_TORQUE::set_reg_id(uint32_t value) {
  _internal_set_reg_id(value);
  // @@protoc_insertion_point(field_set:primary.INV_L_SET_TORQUE.reg_id)
}

// uint32 lsb = 2;
inline void INV_L_SET_TORQUE::clear_lsb() {
  lsb_ = 0u;
}
inline uint32_t INV_L_SET_TORQUE::_internal_lsb() const {
  return lsb_;
}
inline uint32_t INV_L_SET_TORQUE::lsb() const {
  // @@protoc_insertion_point(field_get:primary.INV_L_SET_TORQUE.lsb)
  return _internal_lsb();
}
inline void INV_L_SET_TORQUE::_internal_set_lsb(uint32_t value) {
  
  lsb_ = value;
}
inline void INV_L_SET_TORQUE::set_lsb(uint32_t value) {
  _internal_set_lsb(value);
  // @@protoc_insertion_point(field_set:primary.INV_L_SET_TORQUE.lsb)
}

// uint32 msb = 3;
inline void INV_L_SET_TORQUE::clear_msb() {
  msb_ = 0u;
}
inline uint32_t INV_L_SET_TORQUE::_internal_msb() const {
  return msb_;
}
inline uint32_t INV_L_SET_TORQUE::msb() const {
  // @@protoc_insertion_point(field_get:primary.INV_L_SET_TORQUE.msb)
  return _internal_msb();
}
inline void INV_L_SET_TORQUE::_internal_set_msb(uint32_t value) {
  
  msb_ = value;
}
inline void INV_L_SET_TORQUE::set_msb(uint32_t value) {
  _internal_set_msb(value);
  // @@protoc_insertion_point(field_set:primary.INV_L_SET_TORQUE.msb)
}

// uint64 _internal_timestamp = 4;
inline void INV_L_SET_TORQUE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t INV_L_SET_TORQUE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t INV_L_SET_TORQUE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.INV_L_SET_TORQUE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void INV_L_SET_TORQUE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void INV_L_SET_TORQUE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.INV_L_SET_TORQUE._internal_timestamp)
}
...
// uint64 _internal_timestamp = 9;
inline void INV_L_RESPONSE::clear__internal_timestamp() {
  _internal_timestamp_ = uint64_t{0u};
}
inline uint64_t INV_L_RESPONSE::_internal__internal_timestamp() const {
  return _internal_timestamp_;
}
inline uint64_t INV_L_RESPONSE::_internal_timestamp() const {
  // @@protoc_insertion_point(field_get:primary.INV_L_RESPONSE._internal_timestamp)
  return _internal__internal_timestamp();
}
inline void INV_L_RESPONSE::_internal_set__internal_timestamp(uint64_t value) {
  
  _internal_timestamp_ = value;
}
inline void INV_L_RESPONSE::set__internal_timestamp(uint64_t value) {
  _internal_set__internal_timestamp(value);
  // @@protoc_insertion_point(field_set:primary.INV_L_RESPONSE._internal_timestamp)
}
...
inline int Pack::inv_l_set_torque_size() const {
  return _internal_inv_l_set_torque_size();
}
inline void Pack::clear_inv_l_set_torque() {
  inv_l_set_torque_.Clear();
}
inline ::primary::INV_L_SET_TORQUE* Pack::mutable_inv_l_set_torque(int index) {
  // @@protoc_insertion_point(field_mutable:primary.Pack.INV_L_SET_TORQUE)
  return inv_l_set_torque_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::primary::INV_L_SET_TORQUE >*
Pack::mutable_inv_l_set_torque() {
  // @@protoc_insertion_point(field_mutable_list:primary.Pack.INV_L_SET_TORQUE)
  return &inv_l_set_torque_;
}
inline const ::primary::INV_L_SET_TORQUE& Pack::_internal_inv_l_set_torque(int index) const {
  return inv_l_set_torque_.Get(index);
}
inline const ::primary::INV_L_SET_TORQUE& Pack::inv_l_set_torque(int index) const {
  // @@protoc_insertion_point(field_get:primary.Pack.INV_L_SET_TORQUE)
  return _internal_inv_l_set_torque(index);
}
inline ::primary::INV_L_SET_TORQUE* Pack::_internal_add_inv_l_set_torque() {
  return inv_l_set_torque_.Add();
}
inline ::primary::INV_L_SET_TORQUE* Pack::add_inv_l_set_torque() {
  ::primary::INV_L_SET_TORQUE* _add = _internal_add_inv_l_set_torque();
  // @@protoc_insertion_point(field_add:primary.Pack.INV_L_SET_TORQUE)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::primary::INV_L_SET_TORQUE >&
Pack::inv_l_set_torque() const {
  // @@protoc_insertion_point(field_list:primary.Pack.INV_L_SET_TORQUE)
  return inv_l_set_torque_;
}
