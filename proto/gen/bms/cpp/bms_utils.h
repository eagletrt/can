...
bms_board_status_p.set__timestamp(bms_board_status_d->);
...
bms_temperatures_p.set__timestamp(bms_temperatures_d->);
...
bms_voltages_p.set__timestamp(bms_voltages_d->);
free(bms_voltages_d);
std::string serialized;
...
bms_balancing_p.set__timestamp(bms_balancing_d->);
...
bms_fw_update_p.set__timestamp(bms_fw_update_d->);
