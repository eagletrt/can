...
secondary_imu_angular_rate_p.set_timestamp(secondary_imu_angular_rate_d->);
...
secondary_imu_acceleration_p.set_timestamp(secondary_imu_acceleration_d->);
...
secondary_irts_fl_0_p.set_timestamp(secondary_irts_fl_0_d->);
...
secondary_irts_fl_1_p.set_timestamp(secondary_irts_fl_1_d->);
...
secondary_irts_fl_2_p.set_timestamp(secondary_irts_fl_2_d->);
...
secondary_irts_fl_3_p.set_timestamp(secondary_irts_fl_3_d->);
...
secondary_irts_fr_0_p.set_timestamp(secondary_irts_fr_0_d->);
...
secondary_irts_fr_1_p.set_timestamp(secondary_irts_fr_1_d->);
...
secondary_irts_fr_2_p.set_timestamp(secondary_irts_fr_2_d->);
...
secondary_irts_fr_3_p.set_timestamp(secondary_irts_fr_3_d->);
...
secondary_irts_rl_0_p.set_timestamp(secondary_irts_rl_0_d->);
...
secondary_irts_rl_1_p.set_timestamp(secondary_irts_rl_1_d->);
...
secondary_irts_rl_2_p.set_timestamp(secondary_irts_rl_2_d->);
...
secondary_irts_rl_3_p.set_timestamp(secondary_irts_rl_3_d->);
...
secondary_irts_rr_0_p.set_timestamp(secondary_irts_rr_0_d->);
...
secondary_irts_rr_1_p.set_timestamp(secondary_irts_rr_1_d->);
...
secondary_irts_rr_2_p.set_timestamp(secondary_irts_rr_2_d->);
...
secondary_irts_rr_3_p.set_timestamp(secondary_irts_rr_3_d->);
...
secondary_gps_coords_p.set_timestamp(secondary_gps_coords_d->);
...
secondary_gps_speed_p.set_timestamp(secondary_gps_speed_d->);
