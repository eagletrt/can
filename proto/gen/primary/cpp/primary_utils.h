...
primary_steer_version_p.set__timestamp(primary_steer_version_d->);
...
primary_das_version_p.set__timestamp(primary_das_version_d->);
...
primary_hv_version_p.set__timestamp(primary_hv_version_d->);
...
primary_lv_version_p.set__timestamp(primary_lv_version_d->);
...
primary_tlm_version_p.set__timestamp(primary_tlm_version_d->);
...
primary_set_tlm_status_p.set__timestamp(primary_set_tlm_status_d->);
...
primary_tlm_status_p.set__timestamp(primary_tlm_status_d->);
...
primary_steer_system_status_p.set__timestamp(primary_steer_system_status_d->);
...
primary_hv_voltage_p.set__timestamp(primary_hv_voltage_d->);
...
primary_hv_current_p.set__timestamp(primary_hv_current_d->);
...
primary_hv_temp_p.set__timestamp(primary_hv_temp_d->);
...
primary_hv_errors_p.set__timestamp(primary_hv_errors_d->);
...
primary_ts_status_p.set__timestamp(primary_ts_status_d->);
...
primary_set_ts_status_p.set__timestamp(primary_set_ts_status_d->);
...
primary_steer_status_p.set__timestamp(primary_steer_status_d->);
...
primary_set_car_status_p.set__timestamp(primary_set_car_status_d->);
...
primary_set_pedals_range_p.set__timestamp(primary_set_pedals_range_d->);
...
primary_car_status_p.set__timestamp(primary_car_status_d->);
...
primary_das_errors_p.set__timestamp(primary_das_errors_d->);
...
primary_lv_current_p.set__timestamp(primary_lv_current_d->);
...
primary_lv_voltage_p.set__timestamp(primary_lv_voltage_d->);
...
primary_lv_total_voltage_p.set__timestamp(primary_lv_total_voltage_d->);
...
primary_lv_temperature_p.set__timestamp(primary_lv_temperature_d->);
...
primary_cooling_status_p.set__timestamp(primary_cooling_status_d->);
...
primary_marker_p.set__timestamp(primary_marker_d->);
...
primary_hv_cells_voltage_p.set__timestamp(primary_hv_cells_voltage_d->);
...
primary_hv_cells_temp_p.set__timestamp(primary_hv_cells_temp_d->);
...
primary_hv_cell_balancing_status_p.set__timestamp(primary_hv_cell_balancing_status_d->);
...
primary_set_cell_balancing_status_p.set__timestamp(primary_set_cell_balancing_status_d->);
...
primary_handcart_status_p.set__timestamp(primary_handcart_status_d->);
...
primary_speed_p.set__timestamp(primary_speed_d->);
...
primary_inv_l_set_torque_p.set__timestamp(primary_inv_l_set_torque_d->);
...
primary_inv_l_response_p.set__timestamp(primary_inv_l_response_d->);
