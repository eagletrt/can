...
void inverters_proto_interface_deserialize(inverters::Pack* pack, network_enums* net_enums, network_signals* net_signals, network_strings* net_strings, uint64_t resample_us) {
    ...
    for(int i = 0; i < pack->inv_l_send_size(); i++){
		...
		(*net_signals)["INV_L_SEND"]["t_dc__start"].push(pack->inv_l_send(i).t_dc__start());
		(*net_signals)["INV_L_SEND"]["v_dc__start"].push(pack->inv_l_send(i).v_dc__start());
		(*net_signals)["INV_L_SEND"]["special__start"].push(pack->inv_l_send(i).special__start());
		(*net_signals)["INV_L_SEND"]["v_min__start"].push(pack->inv_l_send(i).v_min__start());
		(*net_signals)["INV_L_SEND"]["f_min__start"].push(pack->inv_l_send(i).f_min__start());
		(*net_signals)["INV_L_SEND"]["v_corner__start"].push(pack->inv_l_send(i).v_corner__start());
		(*net_signals)["INV_L_SEND"]["f_corner__start"].push(pack->inv_l_send(i).f_corner__start());
		(*net_signals)["INV_L_SEND"]["cos_phi"].push(pack->inv_l_send(i).cos_phi());
		(*net_signals)["INV_L_SEND"]["extra__start"].push(pack->inv_l_send(i).extra__start());
		(*net_signals)["INV_L_SEND"]["capture_channel"].push(pack->inv_l_send(i).capture_channel());
		(*net_signals)["INV_L_SEND"]["trig_level"].push(pack->inv_l_send(i).trig_level());
		(*net_signals)["INV_L_SEND"]["trig_edge"].push(pack->inv_l_send(i).trig_edge());
		(*net_signals)["INV_L_SEND"]["trig_source"].push(pack->inv_l_send(i).trig_source());
		(*net_signals)["INV_L_SEND"]["oszi_source"].push(pack->inv_l_send(i).oszi_source());
		(*net_signals)["INV_L_SEND"]["oszi_skip"].push(pack->inv_l_send(i).oszi_skip());
		(*net_signals)["INV_L_SEND"]["oszi_read_cmd"].push(pack->inv_l_send(i).oszi_read_cmd());
		(*net_signals)["INV_L_SEND"]["oszi_run_cmd"].push(pack->inv_l_send(i).oszi_run_cmd());
		(*net_signals)["INV_L_SEND"]["calib_ref_value"].push(pack->inv_l_send(i).calib_ref_value());
		...
		(*net_signals)["INV_L_SEND"]["cutoffdig"].push(pack->inv_l_send(i).cutoffdig());
		...
		(*net_signals)["INV_L_SEND"]["ain_in_1_offsetval"].push(pack->inv_l_send(i).ain_in_1_offsetval());
		...
		(*net_signals)["INV_L_SEND"]["cs_ain_1_format"].push(pack->inv_l_send(i).cs_ain_1_format());
		...
		(*net_signals)["INV_L_SEND"]["fb_offset"].push(pack->inv_l_send(i).fb_offset());
		...
		(*net_signals)["INV_L_SEND"]["km_rsvd_0"].push(pack->inv_l_send(i).km_rsvd_0());
		...
		(*net_signals)["INV_L_SEND"]["dc_bus_comp"].push(pack->inv_l_send(i).dc_bus_comp());
		...
		(*net_signals)["INV_L_SEND"]["pos_nd_scale"].push(pack->inv_l_send(i).pos_nd_scale());
		(*net_signals)["INV_L_SEND"]["pos_nd_offset"].push(pack->inv_l_send(i).pos_nd_offset());
		(*net_signals)["INV_L_SEND"]["fb2_scale_ext"].push(pack->inv_l_send(i).fb2_scale_ext());
		(*net_signals)["INV_L_SEND"]["pos_offset_slack"].push(pack->inv_l_send(i).pos_offset_slack());
		(*net_signals)["INV_L_SEND"]["pos_diff_slack"].push(pack->inv_l_send(i).pos_diff_slack());
		(*net_enums)["INV_L_SEND"]["eprom131"].push(pack->inv_l_send(i).eprom131());
		inverters_inv_l_send_eprom131_enum_to_string((inverters_inv_l_send_eprom131)pack->inv_l_send(i).eprom131(), buffer);
		(*net_strings)["INV_L_SEND"]["eprom131"].push(buffer);
		(*net_enums)["INV_L_SEND"]["eprom132"].push(pack->inv_l_send(i).eprom132());
		inverters_inv_l_send_eprom132_enum_to_string((inverters_inv_l_send_eprom132)pack->inv_l_send(i).eprom132(), buffer);
		(*net_strings)["INV_L_SEND"]["eprom132"].push(buffer);
		(*net_signals)["INV_L_SEND"]["fun_special"].push(pack->inv_l_send(i).fun_special());
		...
		(*net_signals)["INV_L_SEND"]["operand194"].push(pack->inv_l_send(i).operand194());
		(*net_signals)["INV_L_SEND"]["operand195"].push(pack->inv_l_send(i).operand195());
		(*net_signals)["INV_L_SEND"]["operand218"].push(pack->inv_l_send(i).operand218());
		(*net_signals)["INV_L_SEND"]["operand219"].push(pack->inv_l_send(i).operand219());
		...
		(*net_signals)["INV_L_SEND"]["cmc__bit0__dc_current_sens_ena"].push(pack->inv_l_send(i).cmc__bit0__dc_current_sens_ena());
		...
		(*net_signals)["INV_L_SEND"]["dup__bit7_0__dac_source_channel"].push(pack->inv_l_send(i).dup__bit7_0__dac_source_channel());
		...
		(*net_signals)["INV_L_SEND"]["km_speed_0"].push(pack->inv_l_send(i).km_speed_0());
		(*net_signals)["INV_L_SEND"]["ballast_ext"].push(pack->inv_l_send(i).ballast_ext());
		(*net_signals)["INV_L_SEND"]["cmc__bit1__idc_limit_ena"].push(pack->inv_l_send(i).cmc__bit1__idc_limit_ena());
		(*net_signals)["INV_L_SEND"]["cs_ain_2_format"].push(pack->inv_l_send(i).cs_ain_2_format());
		(*net_signals)["INV_L_SEND"]["km_frg_off"].push(pack->inv_l_send(i).km_frg_off());
		(*net_signals)["INV_L_SEND"]["fb_special"].push(pack->inv_l_send(i).fb_special());
		(*net_signals)["INV_L_SEND"]["cmc__bit2__pdc_limit_usage"].push(pack->inv_l_send(i).cmc__bit2__pdc_limit_usage());
		(*net_signals)["INV_L_SEND"]["km_cal_off"].push(pack->inv_l_send(i).km_cal_off());
		(*net_signals)["INV_L_SEND"]["coaststop"].push(pack->inv_l_send(i).coaststop());
		(*net_signals)["INV_L_SEND"]["cmc__bit3__torqueval_init_ena"].push(pack->inv_l_send(i).cmc__bit3__torqueval_init_ena());
		(*net_enums)["INV_L_SEND"]["cs_ain_1_mode"].push(pack->inv_l_send(i).cs_ain_1_mode());
		inverters_inv_l_send_cs_ain_1_mode_enum_to_string((inverters_inv_l_send_cs_ain_1_mode)pack->inv_l_send(i).cs_ain_1_mode(), buffer);
		(*net_strings)["INV_L_SEND"]["cs_ain_1_mode"].push(buffer);
		(*net_signals)["INV_L_SEND"]["km_tx_tog_stat"].push(pack->inv_l_send(i).km_tx_tog_stat());
		(*net_signals)["INV_L_SEND"]["i_ist_inverse"].push(pack->inv_l_send(i).i_ist_inverse());
		(*net_enums)["INV_L_SEND"]["compare_var194"].push(pack->inv_l_send(i).compare_var194());
		inverters_inv_l_send_compare_var194_enum_to_string((inverters_inv_l_send_compare_var194)pack->inv_l_send(i).compare_var194(), buffer);
		(*net_strings)["INV_L_SEND"]["compare_var194"].push(buffer);
		(*net_enums)["INV_L_SEND"]["compare_var195"].push(pack->inv_l_send(i).compare_var195());
		inverters_inv_l_send_compare_var195_enum_to_string((inverters_inv_l_send_compare_var195)pack->inv_l_send(i).compare_var195(), buffer);
		(*net_strings)["INV_L_SEND"]["compare_var195"].push(buffer);
		(*net_enums)["INV_L_SEND"]["compare_var218"].push(pack->inv_l_send(i).compare_var218());
		inverters_inv_l_send_compare_var218_enum_to_string((inverters_inv_l_send_compare_var218)pack->inv_l_send(i).compare_var218(), buffer);
		(*net_strings)["INV_L_SEND"]["compare_var218"].push(buffer);
		(*net_enums)["INV_L_SEND"]["compare_var219"].push(pack->inv_l_send(i).compare_var219());
		inverters_inv_l_send_compare_var219_enum_to_string((inverters_inv_l_send_compare_var219)pack->inv_l_send(i).compare_var219(), buffer);
		(*net_strings)["INV_L_SEND"]["compare_var219"].push(buffer);
		(*net_signals)["INV_L_SEND"]["cmc__bit4__dig_m_rcpramp_ena"].push(pack->inv_l_send(i).cmc__bit4__dig_m_rcpramp_ena());
		(*net_signals)["INV_L_SEND"]["km_i_limit"].push(pack->inv_l_send(i).km_i_limit());
		(*net_signals)["INV_L_SEND"]["refsoft"].push(pack->inv_l_send(i).refsoft());
		...
		(*net_signals)["INV_L_SEND"]["cmc__bit5__reset_nramp_atnzero"].push(pack->inv_l_send(i).cmc__bit5__reset_nramp_atnzero());
		(*net_signals)["INV_L_SEND"]["km_n_clip"].push(pack->inv_l_send(i).km_n_clip());
		(*net_signals)["INV_L_SEND"]["no_uesp_btb"].push(pack->inv_l_send(i).no_uesp_btb());
		(*net_signals)["INV_L_SEND"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_l_send(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_signals)["INV_L_SEND"]["cs_oora1"].push(pack->inv_l_send(i).cs_oora1());
		(*net_signals)["INV_L_SEND"]["km_mix_ana_on"].push(pack->inv_l_send(i).km_mix_ana_on());
		(*net_signals)["INV_L_SEND"]["vdc_ana"].push(pack->inv_l_send(i).vdc_ana());
		(*net_signals)["INV_L_SEND"]["cmc__bit13_7__free"].push(pack->inv_l_send(i).cmc__bit13_7__free());
		(*net_enums)["INV_L_SEND"]["cs_ain_2_mode"].push(pack->inv_l_send(i).cs_ain_2_mode());
		inverters_inv_l_send_cs_ain_2_mode_enum_to_string((inverters_inv_l_send_cs_ain_2_mode)pack->inv_l_send(i).cs_ain_2_mode(), buffer);
		(*net_strings)["INV_L_SEND"]["cs_ain_2_mode"].push(buffer);
		...
		(*net_signals)["INV_L_SEND"]["km_allow_sync"].push(pack->inv_l_send(i).km_allow_sync());
		(*net_signals)["INV_L_SEND"]["i1_adc_ena"].push(pack->inv_l_send(i).i1_adc_ena());
		...
		(*net_enums)["INV_L_SEND"]["source_id194"].push(pack->inv_l_send(i).source_id194());
		inverters_inv_l_send_source_id194_enum_to_string((inverters_inv_l_send_source_id194)pack->inv_l_send(i).source_id194(), buffer);
		(*net_strings)["INV_L_SEND"]["source_id194"].push(buffer);
		(*net_enums)["INV_L_SEND"]["source_id195"].push(pack->inv_l_send(i).source_id195());
		inverters_inv_l_send_source_id195_enum_to_string((inverters_inv_l_send_source_id195)pack->inv_l_send(i).source_id195(), buffer);
		(*net_strings)["INV_L_SEND"]["source_id195"].push(buffer);
		(*net_enums)["INV_L_SEND"]["source_id218"].push(pack->inv_l_send(i).source_id218());
		inverters_inv_l_send_source_id218_enum_to_string((inverters_inv_l_send_source_id218)pack->inv_l_send(i).source_id218(), buffer);
		(*net_strings)["INV_L_SEND"]["source_id218"].push(buffer);
		(*net_enums)["INV_L_SEND"]["source_id219"].push(pack->inv_l_send(i).source_id219());
		inverters_inv_l_send_source_id219_enum_to_string((inverters_inv_l_send_source_id219)pack->inv_l_send(i).source_id219(), buffer);
		(*net_strings)["INV_L_SEND"]["source_id219"].push(buffer);
		(*net_signals)["INV_L_SEND"]["dup__bit8__can_extended_0"].push(pack->inv_l_send(i).dup__bit8__can_extended_0());
		(*net_signals)["INV_L_SEND"]["km_handwheel"].push(pack->inv_l_send(i).km_handwheel());
		(*net_signals)["INV_L_SEND"]["hxinv"].push(pack->inv_l_send(i).hxinv());
		(*net_signals)["INV_L_SEND"]["dup__bit9__generator"].push(pack->inv_l_send(i).dup__bit9__generator());
		(*net_signals)["INV_L_SEND"]["km_phasing_extend"].push(pack->inv_l_send(i).km_phasing_extend());
		(*net_signals)["INV_L_SEND"]["h2inv"].push(pack->inv_l_send(i).h2inv());
		(*net_signals)["INV_L_SEND"]["dup__bit10__park_rms"].push(pack->inv_l_send(i).dup__bit10__park_rms());
		(*net_signals)["INV_L_SEND"]["cs_oora2"].push(pack->inv_l_send(i).cs_oora2());
		(*net_signals)["INV_L_SEND"]["km_rsvd_11"].push(pack->inv_l_send(i).km_rsvd_11());
		(*net_signals)["INV_L_SEND"]["ol_comp"].push(pack->inv_l_send(i).ol_comp());
		(*net_signals)["INV_L_SEND"]["mo_sc1_comp"].push(pack->inv_l_send(i).mo_sc1_comp());
		(*net_signals)["INV_L_SEND"]["dup__bit11__dcbus_volts"].push(pack->inv_l_send(i).dup__bit11__dcbus_volts());
		(*net_enums)["INV_L_SEND"]["cs_cmd_type"].push(pack->inv_l_send(i).cs_cmd_type());
		inverters_inv_l_send_cs_cmd_type_enum_to_string((inverters_inv_l_send_cs_cmd_type)pack->inv_l_send(i).cs_cmd_type(), buffer);
		(*net_strings)["INV_L_SEND"]["cs_cmd_type"].push(buffer);
		(*net_signals)["INV_L_SEND"]["km_rsvd_12"].push(pack->inv_l_send(i).km_rsvd_12());
		(*net_enums)["INV_L_SEND"]["motortype"].push(pack->inv_l_send(i).motortype());
		inverters_inv_l_send_motortype_enum_to_string((inverters_inv_l_send_motortype)pack->inv_l_send(i).motortype(), buffer);
		(*net_strings)["INV_L_SEND"]["motortype"].push(buffer);
		...
		(*net_signals)["INV_L_SEND"]["dup__bit12__boat_pedal"].push(pack->inv_l_send(i).dup__bit12__boat_pedal());
		(*net_signals)["INV_L_SEND"]["km_rsvd_13"].push(pack->inv_l_send(i).km_rsvd_13());
		(*net_signals)["INV_L_SEND"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_l_send(i).dup__bit13__gen_autoiaclimit());
		(*net_signals)["INV_L_SEND"]["cs_ain_2__i_limit"].push(pack->inv_l_send(i).cs_ain_2__i_limit());
		(*net_signals)["INV_L_SEND"]["km_pseudo_enable"].push(pack->inv_l_send(i).km_pseudo_enable());
		(*net_signals)["INV_L_SEND"]["ana_0up"].push(pack->inv_l_send(i).ana_0up());
		(*net_signals)["INV_L_SEND"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_l_send(i).cmc__bit14__idc_limit_ena_v2());
		(*net_signals)["INV_L_SEND"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_l_send(i).dup__bit14__mtpa_reluct_enab());
		(*net_signals)["INV_L_SEND"]["cs_ain_1__n_limit"].push(pack->inv_l_send(i).cs_ain_1__n_limit());
		(*net_signals)["INV_L_SEND"]["km_debug_test"].push(pack->inv_l_send(i).km_debug_test());
		(*net_signals)["INV_L_SEND"]["lowbd"].push(pack->inv_l_send(i).lowbd());
		(*net_signals)["INV_L_SEND"]["mo_sc2_inv"].push(pack->inv_l_send(i).mo_sc2_inv());
		...
		(*net_signals)["INV_L_SEND"]["cmc__bit15__dig_e_brake_act"].push(pack->inv_l_send(i).cmc__bit15__dig_e_brake_act());
		(*net_signals)["INV_L_SEND"]["dup__bit15__canopen_acv"].push(pack->inv_l_send(i).dup__bit15__canopen_acv());
		(*net_signals)["INV_L_SEND"]["t_dc__stop"].push(pack->inv_l_send(i).t_dc__stop());
		(*net_signals)["INV_L_SEND"]["v_dc__stop"].push(pack->inv_l_send(i).v_dc__stop());
		(*net_signals)["INV_L_SEND"]["special__stop"].push(pack->inv_l_send(i).special__stop());
		(*net_signals)["INV_L_SEND"]["v_min__stop"].push(pack->inv_l_send(i).v_min__stop());
		(*net_signals)["INV_L_SEND"]["f_min__stop"].push(pack->inv_l_send(i).f_min__stop());
		(*net_signals)["INV_L_SEND"]["v_corner__stop"].push(pack->inv_l_send(i).v_corner__stop());
		(*net_signals)["INV_L_SEND"]["f_corner__stop"].push(pack->inv_l_send(i).f_corner__stop());
		...
		(*net_signals)["INV_L_SEND"]["ain_in_1_scaleval"].push(pack->inv_l_send(i).ain_in_1_scaleval());
		(*net_signals)["INV_L_SEND"]["m_r_acc"].push(pack->inv_l_send(i).m_r_acc());
		(*net_signals)["INV_L_SEND"]["sramp"].push(pack->inv_l_send(i).sramp());
		...
		(*net_signals)["INV_L_SEND"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_l_send(i).dup__bit16__bamobil3_2_offcrct());
		(*net_signals)["INV_L_SEND"]["m_r_dec"].push(pack->inv_l_send(i).m_r_dec());
		(*net_signals)["INV_L_SEND"]["ramp4"].push(pack->inv_l_send(i).ramp4());
		(*net_signals)["INV_L_SEND"]["dup__bit19_17__ecode_redefine"].push(pack->inv_l_send(i).dup__bit19_17__ecode_redefine());
		(*net_signals)["INV_L_SEND"]["motbrake"].push(pack->inv_l_send(i).motbrake());
		(*net_signals)["INV_L_SEND"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_l_send(i).cmc__bit18__tractioncontrol_ena());
		(*net_signals)["INV_L_SEND"]["ac_dc"].push(pack->inv_l_send(i).ac_dc());
		(*net_signals)["INV_L_SEND"]["cmc__bit20_19__tc_deltatime_conf"].push(pack->inv_l_send(i).cmc__bit20_19__tc_deltatime_conf());
		(*net_enums)["INV_L_SEND"]["pwm_freq"].push(pack->inv_l_send(i).pwm_freq());
		inverters_inv_l_send_pwm_freq_enum_to_string((inverters_inv_l_send_pwm_freq)pack->inv_l_send(i).pwm_freq(), buffer);
		(*net_strings)["INV_L_SEND"]["pwm_freq"].push(buffer);
		(*net_signals)["INV_L_SEND"]["dup__bit20__hal_extmr_acv"].push(pack->inv_l_send(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_L_SEND"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_l_send(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_signals)["INV_L_SEND"]["dup__bit21__initwith_frg_off"].push(pack->inv_l_send(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_L_SEND"]["dup__bit31_22__free"].push(pack->inv_l_send(i).dup__bit31_22__free());
		(*net_signals)["INV_L_SEND"]["ntc"].push(pack->inv_l_send(i).ntc());
		(*net_signals)["INV_L_SEND"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_l_send(i).cmc__bit23__tc_ncmdrestoption());
		(*net_signals)["INV_L_SEND"]["delta"].push(pack->inv_l_send(i).delta());
		(*net_signals)["INV_L_SEND"]["cmc__bit31_24__free"].push(pack->inv_l_send(i).cmc__bit31_24__free());
		(*net_signals)["INV_L_SEND"]["dc_1qdirvolt"].push(pack->inv_l_send(i).dc_1qdirvolt());
		(*net_signals)["INV_L_SEND"]["dc_field"].push(pack->inv_l_send(i).dc_field());
		(*net_signals)["INV_L_SEND"]["dead_2"].push(pack->inv_l_send(i).dead_2());
		(*net_signals)["INV_L_SEND"]["block"].push(pack->inv_l_send(i).block());
		(*net_signals)["INV_L_SEND"]["dc_1qmv"].push(pack->inv_l_send(i).dc_1qmv());
		(*net_signals)["INV_L_SEND"]["dc_1q3p"].push(pack->inv_l_send(i).dc_1q3p());
		(*net_signals)["INV_L_SEND"]["reducelosses"].push(pack->inv_l_send(i).reducelosses());
    ...
    for(int i = 0; i < pack->inv_l_rcv_size(); i++){
		...
		(*net_signals)["INV_L_RCV"]["ena64"].push(pack->inv_l_rcv(i).ena64());
		...
		(*net_signals)["INV_L_RCV"]["end_1"].push(pack->inv_l_rcv(i).end_1());
		(*net_signals)["INV_L_RCV"]["din_1"].push(pack->inv_l_rcv(i).din_1());
		(*net_signals)["INV_L_RCV"]["end_2"].push(pack->inv_l_rcv(i).end_2());
		(*net_signals)["INV_L_RCV"]["din_2"].push(pack->inv_l_rcv(i).din_2());
		(*net_signals)["INV_L_RCV"]["run232"].push(pack->inv_l_rcv(i).run232());
		(*net_signals)["INV_L_RCV"]["dout_1"].push(pack->inv_l_rcv(i).dout_1());
		(*net_signals)["INV_L_RCV"]["dout_2"].push(pack->inv_l_rcv(i).dout_2());
		(*net_signals)["INV_L_RCV"]["dout_3"].push(pack->inv_l_rcv(i).dout_3());
		(*net_signals)["INV_L_RCV"]["rdy_btb"].push(pack->inv_l_rcv(i).rdy_btb());
		(*net_signals)["INV_L_RCV"]["i_fault"].push(pack->inv_l_rcv(i).i_fault());
		(*net_signals)["INV_L_RCV"]["dout_4"].push(pack->inv_l_rcv(i).dout_4());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit0_firsterrordtcd99"].push(pack->inv_l_rcv(i).ecode_bit0_firsterrordtcd99());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit0_firsterrordtcd148"].push(pack->inv_l_rcv(i).ecode_bit0_firsterrordtcd148());
		...
		(*net_signals)["INV_L_RCV"]["signal_go"].push(pack->inv_l_rcv(i).signal_go());
		(*net_signals)["INV_L_RCV"]["signal_brake"].push(pack->inv_l_rcv(i).signal_brake());
		(*net_signals)["INV_L_RCV"]["signal_icns"].push(pack->inv_l_rcv(i).signal_icns());
		(*net_signals)["INV_L_RCV"]["signal_lessn0"].push(pack->inv_l_rcv(i).signal_lessn0());
		(*net_signals)["INV_L_RCV"]["signal_postolerance"].push(pack->inv_l_rcv(i).signal_postolerance());
		...
		(*net_signals)["INV_L_RCV"]["dc_current_sens_ena_set"].push(pack->inv_l_rcv(i).dc_current_sens_ena_set());
		(*net_signals)["INV_L_RCV"]["cmc__bit0__dc_current_sens_ena"].push(pack->inv_l_rcv(i).cmc__bit0__dc_current_sens_ena());
		...
		(*net_signals)["INV_L_RCV"]["fb_lossofsignal"].push(pack->inv_l_rcv(i).fb_lossofsignal());
		(*net_signals)["INV_L_RCV"]["no_hw_fault"].push(pack->inv_l_rcv(i).no_hw_fault());
		...
		(*net_signals)["INV_L_RCV"]["lmt_1"].push(pack->inv_l_rcv(i).lmt_1());
		(*net_signals)["INV_L_RCV"]["out_1"].push(pack->inv_l_rcv(i).out_1());
		...
		(*net_signals)["INV_L_RCV"]["ncr064"].push(pack->inv_l_rcv(i).ncr064());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit1__hw1_state148"].push(pack->inv_l_rcv(i).ecode_bit1__hw1_state148());
		(*net_signals)["INV_L_RCV"]["dc_i_sensena_set"].push(pack->inv_l_rcv(i).dc_i_sensena_set());
		(*net_signals)["INV_L_RCV"]["cmc__bit1__idc_limit_ena"].push(pack->inv_l_rcv(i).cmc__bit1__idc_limit_ena());
		(*net_signals)["INV_L_RCV"]["lmt_2"].push(pack->inv_l_rcv(i).lmt_2());
		(*net_signals)["INV_L_RCV"]["out_2"].push(pack->inv_l_rcv(i).out_2());
		(*net_signals)["INV_L_RCV"]["fb_special"].push(pack->inv_l_rcv(i).fb_special());
		(*net_signals)["INV_L_RCV"]["lim_plus64"].push(pack->inv_l_rcv(i).lim_plus64());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit2__hw0_state99"].push(pack->inv_l_rcv(i).ecode_bit2__hw0_state99());
		(*net_signals)["INV_L_RCV"]["ecode_bit2__hw0_state148"].push(pack->inv_l_rcv(i).ecode_bit2__hw0_state148());
		(*net_signals)["INV_L_RCV"]["op_mode_quadrant"].push(pack->inv_l_rcv(i).op_mode_quadrant());
		(*net_signals)["INV_L_RCV"]["cmc__bit2__pdc_limit_usage"].push(pack->inv_l_rcv(i).cmc__bit2__pdc_limit_usage());
		(*net_signals)["INV_L_RCV"]["in_2"].push(pack->inv_l_rcv(i).in_2());
		(*net_signals)["INV_L_RCV"]["rdy155"].push(pack->inv_l_rcv(i).rdy155());
		(*net_signals)["INV_L_RCV"]["coaststop"].push(pack->inv_l_rcv(i).coaststop());
		(*net_signals)["INV_L_RCV"]["lim_minus64"].push(pack->inv_l_rcv(i).lim_minus64());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit3__free148"].push(pack->inv_l_rcv(i).ecode_bit3__free148());
		(*net_signals)["INV_L_RCV"]["cmc__bit3__torqueval_init_ena"].push(pack->inv_l_rcv(i).cmc__bit3__torqueval_init_ena());
		(*net_signals)["INV_L_RCV"]["in_1"].push(pack->inv_l_rcv(i).in_1());
		(*net_signals)["INV_L_RCV"]["go155"].push(pack->inv_l_rcv(i).go155());
		(*net_signals)["INV_L_RCV"]["i_ist_inverse"].push(pack->inv_l_rcv(i).i_ist_inverse());
		(*net_signals)["INV_L_RCV"]["ok64"].push(pack->inv_l_rcv(i).ok64());
		(*net_signals)["INV_L_RCV"]["err_feedbacksignal"].push(pack->inv_l_rcv(i).err_feedbacksignal());
		(*net_signals)["INV_L_RCV"]["frgrun"].push(pack->inv_l_rcv(i).frgrun());
		...
		(*net_signals)["INV_L_RCV"]["km_tx_tog_stat"].push(pack->inv_l_rcv(i).km_tx_tog_stat());
		(*net_signals)["INV_L_RCV"]["ok82"].push(pack->inv_l_rcv(i).ok82());
		(*net_signals)["INV_L_RCV"]["ecode_bit4__rdy399"].push(pack->inv_l_rcv(i).ecode_bit4__rdy399());
		(*net_signals)["INV_L_RCV"]["ecode_bit4__rdy3148"].push(pack->inv_l_rcv(i).ecode_bit4__rdy3148());
		...
		(*net_signals)["INV_L_RCV"]["cmc__bit4__dig_m_rcpramp_ena"].push(pack->inv_l_rcv(i).cmc__bit4__dig_m_rcpramp_ena());
		(*net_signals)["INV_L_RCV"]["run152"].push(pack->inv_l_rcv(i).run152());
		(*net_signals)["INV_L_RCV"]["out_3"].push(pack->inv_l_rcv(i).out_3());
		(*net_signals)["INV_L_RCV"]["refsoft"].push(pack->inv_l_rcv(i).refsoft());
		(*net_signals)["INV_L_RCV"]["icns64"].push(pack->inv_l_rcv(i).icns64());
		(*net_signals)["INV_L_RCV"]["err_powervoltage_low"].push(pack->inv_l_rcv(i).err_powervoltage_low());
		(*net_signals)["INV_L_RCV"]["rfe216"].push(pack->inv_l_rcv(i).rfe216());
		(*net_signals)["INV_L_RCV"]["km_i_limit"].push(pack->inv_l_rcv(i).km_i_limit());
		(*net_signals)["INV_L_RCV"]["icns82"].push(pack->inv_l_rcv(i).icns82());
		(*net_signals)["INV_L_RCV"]["ecode_bit5__n_fail99"].push(pack->inv_l_rcv(i).ecode_bit5__n_fail99());
		(*net_signals)["INV_L_RCV"]["ecode_bit5__n_fail148"].push(pack->inv_l_rcv(i).ecode_bit5__n_fail148());
		...
		(*net_signals)["INV_L_RCV"]["recup_is_acv"].push(pack->inv_l_rcv(i).recup_is_acv());
		(*net_signals)["INV_L_RCV"]["cmc__bit5__reset_nramp_atnzero"].push(pack->inv_l_rcv(i).cmc__bit5__reset_nramp_atnzero());
		(*net_signals)["INV_L_RCV"]["rfe152"].push(pack->inv_l_rcv(i).rfe152());
		(*net_signals)["INV_L_RCV"]["out_4"].push(pack->inv_l_rcv(i).out_4());
		(*net_signals)["INV_L_RCV"]["no_uesp_btb"].push(pack->inv_l_rcv(i).no_uesp_btb());
		(*net_signals)["INV_L_RCV"]["tnlim64"].push(pack->inv_l_rcv(i).tnlim64());
		(*net_signals)["INV_L_RCV"]["err_motortemp"].push(pack->inv_l_rcv(i).err_motortemp());
		(*net_signals)["INV_L_RCV"]["km_n_clip"].push(pack->inv_l_rcv(i).km_n_clip());
		(*net_signals)["INV_L_RCV"]["tnlim82"].push(pack->inv_l_rcv(i).tnlim82());
		(*net_signals)["INV_L_RCV"]["ecode_bit6__flths99"].push(pack->inv_l_rcv(i).ecode_bit6__flths99());
		(*net_signals)["INV_L_RCV"]["ecode_bit6__flths148"].push(pack->inv_l_rcv(i).ecode_bit6__flths148());
		(*net_signals)["INV_L_RCV"]["i_dc_limit_is_acv"].push(pack->inv_l_rcv(i).i_dc_limit_is_acv());
		(*net_signals)["INV_L_RCV"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_l_rcv(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_signals)["INV_L_RCV"]["rsvd"].push(pack->inv_l_rcv(i).rsvd());
		(*net_signals)["INV_L_RCV"]["rsvd1"].push(pack->inv_l_rcv(i).rsvd1());
		(*net_signals)["INV_L_RCV"]["vdc_ana"].push(pack->inv_l_rcv(i).vdc_ana());
		(*net_signals)["INV_L_RCV"]["pn64"].push(pack->inv_l_rcv(i).pn64());
		(*net_signals)["INV_L_RCV"]["err_devicetemp"].push(pack->inv_l_rcv(i).err_devicetemp());
		(*net_signals)["INV_L_RCV"]["cs_oora1"].push(pack->inv_l_rcv(i).cs_oora1());
		(*net_signals)["INV_L_RCV"]["km_mix_ana_on"].push(pack->inv_l_rcv(i).km_mix_ana_on());
		(*net_signals)["INV_L_RCV"]["pn82"].push(pack->inv_l_rcv(i).pn82());
		(*net_signals)["INV_L_RCV"]["ecode_bit7__fltls99"].push(pack->inv_l_rcv(i).ecode_bit7__fltls99());
		(*net_signals)["INV_L_RCV"]["ecode_bit7__fltls148"].push(pack->inv_l_rcv(i).ecode_bit7__fltls148());
		...
		(*net_signals)["INV_L_RCV"]["ni64"].push(pack->inv_l_rcv(i).ni64());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit8__fail_idc99"].push(pack->inv_l_rcv(i).ecode_bit8__fail_idc99());
		(*net_signals)["INV_L_RCV"]["ecode_bit8__fail_idc148"].push(pack->inv_l_rcv(i).ecode_bit8__fail_idc148());
		...
		(*net_signals)["INV_L_RCV"]["_n064"].push(pack->inv_l_rcv(i)._n064());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit9__fail_i148"].push(pack->inv_l_rcv(i).ecode_bit9__fail_i148());
		(*net_signals)["INV_L_RCV"]["dup__bit9__generator"].push(pack->inv_l_rcv(i).dup__bit9__generator());
		(*net_signals)["INV_L_RCV"]["h2inv"].push(pack->inv_l_rcv(i).h2inv());
		(*net_signals)["INV_L_RCV"]["rsw64"].push(pack->inv_l_rcv(i).rsw64());
		(*net_signals)["INV_L_RCV"]["err_raceaway"].push(pack->inv_l_rcv(i).err_raceaway());
		(*net_signals)["INV_L_RCV"]["btbrdy"].push(pack->inv_l_rcv(i).btbrdy());
		(*net_signals)["INV_L_RCV"]["km_phasing_extend"].push(pack->inv_l_rcv(i).km_phasing_extend());
		(*net_signals)["INV_L_RCV"]["rsw82"].push(pack->inv_l_rcv(i).rsw82());
		(*net_signals)["INV_L_RCV"]["ecode_bit10__vccm99"].push(pack->inv_l_rcv(i).ecode_bit10__vccm99());
		(*net_signals)["INV_L_RCV"]["ecode_bit10__vccm148"].push(pack->inv_l_rcv(i).ecode_bit10__vccm148());
		(*net_signals)["INV_L_RCV"]["dup__bit10__park_rms"].push(pack->inv_l_rcv(i).dup__bit10__park_rms());
		(*net_signals)["INV_L_RCV"]["ol_comp"].push(pack->inv_l_rcv(i).ol_comp());
		(*net_signals)["INV_L_RCV"]["cal064"].push(pack->inv_l_rcv(i).cal064());
		(*net_signals)["INV_L_RCV"]["err_user"].push(pack->inv_l_rcv(i).err_user());
		(*net_signals)["INV_L_RCV"]["go216"].push(pack->inv_l_rcv(i).go216());
		(*net_signals)["INV_L_RCV"]["cs_oora2"].push(pack->inv_l_rcv(i).cs_oora2());
		(*net_signals)["INV_L_RCV"]["km_rsvd_11"].push(pack->inv_l_rcv(i).km_rsvd_11());
		(*net_signals)["INV_L_RCV"]["cal082"].push(pack->inv_l_rcv(i).cal082());
		(*net_signals)["INV_L_RCV"]["ecode_bit11__15m_minus99"].push(pack->inv_l_rcv(i).ecode_bit11__15m_minus99());
		(*net_signals)["INV_L_RCV"]["ecode_bit11__15m_minus148"].push(pack->inv_l_rcv(i).ecode_bit11__15m_minus148());
		(*net_signals)["INV_L_RCV"]["mo_sc1_comp"].push(pack->inv_l_rcv(i).mo_sc1_comp());
		(*net_signals)["INV_L_RCV"]["dup__bit11__dcbus_volts"].push(pack->inv_l_rcv(i).dup__bit11__dcbus_volts());
		...
		(*net_signals)["INV_L_RCV"]["cal64"].push(pack->inv_l_rcv(i).cal64());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit12__15m_plus148"].push(pack->inv_l_rcv(i).ecode_bit12__15m_plus148());
		...
		(*net_signals)["INV_L_RCV"]["tol64"].push(pack->inv_l_rcv(i).tol64());
		...
		(*net_signals)["INV_L_RCV"]["ecode_bit13__18m_plus148"].push(pack->inv_l_rcv(i).ecode_bit13__18m_plus148());
		(*net_signals)["INV_L_RCV"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_l_rcv(i).dup__bit13__gen_autoiaclimit());
		(*net_signals)["INV_L_RCV"]["ana_0up"].push(pack->inv_l_rcv(i).ana_0up());
		(*net_signals)["INV_L_RCV"]["rdy64"].push(pack->inv_l_rcv(i).rdy64());
		(*net_signals)["INV_L_RCV"]["err_hwerr"].push(pack->inv_l_rcv(i).err_hwerr());
		(*net_signals)["INV_L_RCV"]["goff"].push(pack->inv_l_rcv(i).goff());
		(*net_signals)["INV_L_RCV"]["cs_ain_2__i_limit"].push(pack->inv_l_rcv(i).cs_ain_2__i_limit());
		(*net_signals)["INV_L_RCV"]["km_pseudo_enable"].push(pack->inv_l_rcv(i).km_pseudo_enable());
		(*net_signals)["INV_L_RCV"]["rdy82"].push(pack->inv_l_rcv(i).rdy82());
		(*net_signals)["INV_L_RCV"]["ecode_bit14__ubmam99"].push(pack->inv_l_rcv(i).ecode_bit14__ubmam99());
		(*net_signals)["INV_L_RCV"]["ecode_bit14__ubmam148"].push(pack->inv_l_rcv(i).ecode_bit14__ubmam148());
		(*net_signals)["INV_L_RCV"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_l_rcv(i).cmc__bit14__idc_limit_ena_v2());
		(*net_signals)["INV_L_RCV"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_l_rcv(i).dup__bit14__mtpa_reluct_enab());
		(*net_signals)["INV_L_RCV"]["lowbd"].push(pack->inv_l_rcv(i).lowbd());
		(*net_signals)["INV_L_RCV"]["brk064"].push(pack->inv_l_rcv(i).brk064());
		(*net_signals)["INV_L_RCV"]["err_ballast"].push(pack->inv_l_rcv(i).err_ballast());
		(*net_signals)["INV_L_RCV"]["brk1216"].push(pack->inv_l_rcv(i).brk1216());
		(*net_signals)["INV_L_RCV"]["cs_ain_1__n_limit"].push(pack->inv_l_rcv(i).cs_ain_1__n_limit());
		(*net_signals)["INV_L_RCV"]["km_debug_test"].push(pack->inv_l_rcv(i).km_debug_test());
		(*net_signals)["INV_L_RCV"]["brk082"].push(pack->inv_l_rcv(i).brk082());
		(*net_signals)["INV_L_RCV"]["ecode_bit15__t_igbt99"].push(pack->inv_l_rcv(i).ecode_bit15__t_igbt99());
		(*net_signals)["INV_L_RCV"]["ecode_bit15__t_igbt148"].push(pack->inv_l_rcv(i).ecode_bit15__t_igbt148());
		(*net_signals)["INV_L_RCV"]["mo_sc2_inv"].push(pack->inv_l_rcv(i).mo_sc2_inv());
		...
		(*net_signals)["INV_L_RCV"]["gen_autoiaclimit_is_acv"].push(pack->inv_l_rcv(i).gen_autoiaclimit_is_acv());
		(*net_signals)["INV_L_RCV"]["cmc__bit15__dig_e_brake_act"].push(pack->inv_l_rcv(i).cmc__bit15__dig_e_brake_act());
		(*net_signals)["INV_L_RCV"]["dup__bit15__canopen_acv"].push(pack->inv_l_rcv(i).dup__bit15__canopen_acv());
		(*net_signals)["INV_L_RCV"]["m_r_dec"].push(pack->inv_l_rcv(i).m_r_dec());
		(*net_signals)["INV_L_RCV"]["m_r_rcp"].push(pack->inv_l_rcv(i).m_r_rcp());
		(*net_signals)["INV_L_RCV"]["sramp"].push(pack->inv_l_rcv(i).sramp());
		(*net_signals)["INV_L_RCV"]["signmag64"].push(pack->inv_l_rcv(i).signmag64());
		(*net_signals)["INV_L_RCV"]["warn_warning_0"].push(pack->inv_l_rcv(i).warn_warning_0());
		...
		(*net_signals)["INV_L_RCV"]["signmag82"].push(pack->inv_l_rcv(i).signmag82());
		...
		(*net_signals)["INV_L_RCV"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_l_rcv(i).dup__bit16__bamobil3_2_offcrct());
		...
		(*net_signals)["INV_L_RCV"]["ramp4"].push(pack->inv_l_rcv(i).ramp4());
		(*net_signals)["INV_L_RCV"]["nclip64"].push(pack->inv_l_rcv(i).nclip64());
		(*net_signals)["INV_L_RCV"]["warn_illegal_status"].push(pack->inv_l_rcv(i).warn_illegal_status());
		(*net_signals)["INV_L_RCV"]["nclip82"].push(pack->inv_l_rcv(i).nclip82());
		(*net_signals)["INV_L_RCV"]["dup__bit19_17__ecode_redefine"].push(pack->inv_l_rcv(i).dup__bit19_17__ecode_redefine());
		(*net_signals)["INV_L_RCV"]["motbrake"].push(pack->inv_l_rcv(i).motbrake());
		(*net_signals)["INV_L_RCV"]["nclip_minus64"].push(pack->inv_l_rcv(i).nclip_minus64());
		(*net_signals)["INV_L_RCV"]["warn_safe_in"].push(pack->inv_l_rcv(i).warn_safe_in());
		(*net_signals)["INV_L_RCV"]["nclip_minus82"].push(pack->inv_l_rcv(i).nclip_minus82());
		(*net_signals)["INV_L_RCV"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_l_rcv(i).cmc__bit18__tractioncontrol_ena());
		(*net_signals)["INV_L_RCV"]["ac_dc"].push(pack->inv_l_rcv(i).ac_dc());
		(*net_signals)["INV_L_RCV"]["nclip_plus64"].push(pack->inv_l_rcv(i).nclip_plus64());
		(*net_signals)["INV_L_RCV"]["nclip_plus82"].push(pack->inv_l_rcv(i).nclip_plus82());
		(*net_signals)["INV_L_RCV"]["cmc__bit20_19__tc_deltatime_conf"].push(pack->inv_l_rcv(i).cmc__bit20_19__tc_deltatime_conf());
		(*net_enums)["INV_L_RCV"]["pwm_freq"].push(pack->inv_l_rcv(i).pwm_freq());
		inverters_inv_l_rcv_pwm_freq_enum_to_string((inverters_inv_l_rcv_pwm_freq)pack->inv_l_rcv(i).pwm_freq(), buffer);
		(*net_strings)["INV_L_RCV"]["pwm_freq"].push(buffer);
		(*net_signals)["INV_L_RCV"]["irddig64"].push(pack->inv_l_rcv(i).irddig64());
		(*net_signals)["INV_L_RCV"]["irddig82"].push(pack->inv_l_rcv(i).irddig82());
		(*net_signals)["INV_L_RCV"]["dup__bit20__hal_extmr_acv"].push(pack->inv_l_rcv(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_L_RCV"]["iuserchd64"].push(pack->inv_l_rcv(i).iuserchd64());
		(*net_signals)["INV_L_RCV"]["iuserchd82"].push(pack->inv_l_rcv(i).iuserchd82());
		(*net_signals)["INV_L_RCV"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_l_rcv(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_signals)["INV_L_RCV"]["dup__bit21__initwith_frg_off"].push(pack->inv_l_rcv(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_L_RCV"]["irdn64"].push(pack->inv_l_rcv(i).irdn64());
		(*net_signals)["INV_L_RCV"]["warn_motortemp"].push(pack->inv_l_rcv(i).warn_motortemp());
		(*net_signals)["INV_L_RCV"]["irdn82"].push(pack->inv_l_rcv(i).irdn82());
		(*net_signals)["INV_L_RCV"]["dup__bit31_22__free"].push(pack->inv_l_rcv(i).dup__bit31_22__free());
		(*net_signals)["INV_L_RCV"]["ntc"].push(pack->inv_l_rcv(i).ntc());
		(*net_signals)["INV_L_RCV"]["irdti64"].push(pack->inv_l_rcv(i).irdti64());
		(*net_signals)["INV_L_RCV"]["warn_devicetemp"].push(pack->inv_l_rcv(i).warn_devicetemp());
		(*net_signals)["INV_L_RCV"]["irdti82"].push(pack->inv_l_rcv(i).irdti82());
		(*net_signals)["INV_L_RCV"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_l_rcv(i).cmc__bit23__tc_ncmdrestoption());
		(*net_signals)["INV_L_RCV"]["m_r_acc"].push(pack->inv_l_rcv(i).m_r_acc());
		(*net_signals)["INV_L_RCV"]["delta"].push(pack->inv_l_rcv(i).delta());
		(*net_signals)["INV_L_RCV"]["irdtir64"].push(pack->inv_l_rcv(i).irdtir64());
		(*net_signals)["INV_L_RCV"]["warn_vout_sat"].push(pack->inv_l_rcv(i).warn_vout_sat());
		(*net_signals)["INV_L_RCV"]["irdtir82"].push(pack->inv_l_rcv(i).irdtir82());
		(*net_signals)["INV_L_RCV"]["cmc__bit31_24__free"].push(pack->inv_l_rcv(i).cmc__bit31_24__free());
		(*net_signals)["INV_L_RCV"]["dc_1qdirvolt"].push(pack->inv_l_rcv(i).dc_1qdirvolt());
		(*net_signals)["INV_L_RCV"]["_10hz64"].push(pack->inv_l_rcv(i)._10hz64());
		(*net_signals)["INV_L_RCV"]["warn_ipeak"].push(pack->inv_l_rcv(i).warn_ipeak());
		(*net_signals)["INV_L_RCV"]["_10hz82"].push(pack->inv_l_rcv(i)._10hz82());
		(*net_signals)["INV_L_RCV"]["dc_field"].push(pack->inv_l_rcv(i).dc_field());
		(*net_signals)["INV_L_RCV"]["irdtm64"].push(pack->inv_l_rcv(i).irdtm64());
		(*net_signals)["INV_L_RCV"]["warn_raceaway"].push(pack->inv_l_rcv(i).warn_raceaway());
		(*net_signals)["INV_L_RCV"]["irdtm82"].push(pack->inv_l_rcv(i).irdtm82());
		(*net_signals)["INV_L_RCV"]["dead_2"].push(pack->inv_l_rcv(i).dead_2());
		(*net_signals)["INV_L_RCV"]["irdana64"].push(pack->inv_l_rcv(i).irdana64());
		(*net_signals)["INV_L_RCV"]["irdana82"].push(pack->inv_l_rcv(i).irdana82());
		(*net_signals)["INV_L_RCV"]["block"].push(pack->inv_l_rcv(i).block());
		(*net_signals)["INV_L_RCV"]["iwcns64"].push(pack->inv_l_rcv(i).iwcns64());
		(*net_signals)["INV_L_RCV"]["iwcns82"].push(pack->inv_l_rcv(i).iwcns82());
		(*net_signals)["INV_L_RCV"]["dc_1qmv"].push(pack->inv_l_rcv(i).dc_1qmv());
		(*net_signals)["INV_L_RCV"]["rfepulse64"].push(pack->inv_l_rcv(i).rfepulse64());
		(*net_signals)["INV_L_RCV"]["rfepulse82"].push(pack->inv_l_rcv(i).rfepulse82());
		(*net_signals)["INV_L_RCV"]["dc_1q3p"].push(pack->inv_l_rcv(i).dc_1q3p());
		(*net_signals)["INV_L_RCV"]["md64"].push(pack->inv_l_rcv(i).md64());
		(*net_signals)["INV_L_RCV"]["md82"].push(pack->inv_l_rcv(i).md82());
		(*net_signals)["INV_L_RCV"]["reducelosses"].push(pack->inv_l_rcv(i).reducelosses());
		(*net_signals)["INV_L_RCV"]["hndwhl64"].push(pack->inv_l_rcv(i).hndwhl64());
		(*net_signals)["INV_L_RCV"]["warn_ballast"].push(pack->inv_l_rcv(i).warn_ballast());
		(*net_signals)["INV_L_RCV"]["hndwhl82"].push(pack->inv_l_rcv(i).hndwhl82());
    ...
    for(int i = 0; i < pack->inv_r_send_size(); i++){
		...
		(*net_signals)["INV_R_SEND"]["t_dc__start"].push(pack->inv_r_send(i).t_dc__start());
		(*net_signals)["INV_R_SEND"]["v_dc__start"].push(pack->inv_r_send(i).v_dc__start());
		(*net_signals)["INV_R_SEND"]["special__start"].push(pack->inv_r_send(i).special__start());
		(*net_signals)["INV_R_SEND"]["v_min__start"].push(pack->inv_r_send(i).v_min__start());
		(*net_signals)["INV_R_SEND"]["f_min__start"].push(pack->inv_r_send(i).f_min__start());
		(*net_signals)["INV_R_SEND"]["v_corner__start"].push(pack->inv_r_send(i).v_corner__start());
		(*net_signals)["INV_R_SEND"]["f_corner__start"].push(pack->inv_r_send(i).f_corner__start());
		(*net_signals)["INV_R_SEND"]["cos_phi"].push(pack->inv_r_send(i).cos_phi());
		(*net_signals)["INV_R_SEND"]["extra__start"].push(pack->inv_r_send(i).extra__start());
		(*net_signals)["INV_R_SEND"]["capture_channel"].push(pack->inv_r_send(i).capture_channel());
		(*net_signals)["INV_R_SEND"]["trig_level"].push(pack->inv_r_send(i).trig_level());
		(*net_signals)["INV_R_SEND"]["trig_edge"].push(pack->inv_r_send(i).trig_edge());
		(*net_signals)["INV_R_SEND"]["trig_source"].push(pack->inv_r_send(i).trig_source());
		(*net_signals)["INV_R_SEND"]["oszi_source"].push(pack->inv_r_send(i).oszi_source());
		(*net_signals)["INV_R_SEND"]["oszi_skip"].push(pack->inv_r_send(i).oszi_skip());
		(*net_signals)["INV_R_SEND"]["oszi_read_cmd"].push(pack->inv_r_send(i).oszi_read_cmd());
		(*net_signals)["INV_R_SEND"]["oszi_run_cmd"].push(pack->inv_r_send(i).oszi_run_cmd());
		(*net_signals)["INV_R_SEND"]["calib_ref_value"].push(pack->inv_r_send(i).calib_ref_value());
		...
		(*net_signals)["INV_R_SEND"]["cutoffdig"].push(pack->inv_r_send(i).cutoffdig());
		...
		(*net_signals)["INV_R_SEND"]["ain_in_1_offsetval"].push(pack->inv_r_send(i).ain_in_1_offsetval());
		...
		(*net_signals)["INV_R_SEND"]["cs_ain_1_format"].push(pack->inv_r_send(i).cs_ain_1_format());
		...
		(*net_signals)["INV_R_SEND"]["fb_offset"].push(pack->inv_r_send(i).fb_offset());
		...
		(*net_signals)["INV_R_SEND"]["km_rsvd_0"].push(pack->inv_r_send(i).km_rsvd_0());
		...
		(*net_signals)["INV_R_SEND"]["dc_bus_comp"].push(pack->inv_r_send(i).dc_bus_comp());
		...
		(*net_signals)["INV_R_SEND"]["pos_nd_scale"].push(pack->inv_r_send(i).pos_nd_scale());
		(*net_signals)["INV_R_SEND"]["pos_nd_offset"].push(pack->inv_r_send(i).pos_nd_offset());
		(*net_signals)["INV_R_SEND"]["fb2_scale_ext"].push(pack->inv_r_send(i).fb2_scale_ext());
		(*net_signals)["INV_R_SEND"]["pos_offset_slack"].push(pack->inv_r_send(i).pos_offset_slack());
		(*net_signals)["INV_R_SEND"]["pos_diff_slack"].push(pack->inv_r_send(i).pos_diff_slack());
		(*net_enums)["INV_R_SEND"]["eprom131"].push(pack->inv_r_send(i).eprom131());
		inverters_inv_r_send_eprom131_enum_to_string((inverters_inv_r_send_eprom131)pack->inv_r_send(i).eprom131(), buffer);
		(*net_strings)["INV_R_SEND"]["eprom131"].push(buffer);
		(*net_enums)["INV_R_SEND"]["eprom132"].push(pack->inv_r_send(i).eprom132());
		inverters_inv_r_send_eprom132_enum_to_string((inverters_inv_r_send_eprom132)pack->inv_r_send(i).eprom132(), buffer);
		(*net_strings)["INV_R_SEND"]["eprom132"].push(buffer);
		(*net_signals)["INV_R_SEND"]["fun_special"].push(pack->inv_r_send(i).fun_special());
		...
		(*net_signals)["INV_R_SEND"]["operand194"].push(pack->inv_r_send(i).operand194());
		(*net_signals)["INV_R_SEND"]["operand195"].push(pack->inv_r_send(i).operand195());
		(*net_signals)["INV_R_SEND"]["operand218"].push(pack->inv_r_send(i).operand218());
		(*net_signals)["INV_R_SEND"]["operand219"].push(pack->inv_r_send(i).operand219());
		...
		(*net_signals)["INV_R_SEND"]["cmc__bit0__dc_current_sens_ena"].push(pack->inv_r_send(i).cmc__bit0__dc_current_sens_ena());
		...
		(*net_signals)["INV_R_SEND"]["dup__bit7_0__dac_source_channel"].push(pack->inv_r_send(i).dup__bit7_0__dac_source_channel());
		...
		(*net_signals)["INV_R_SEND"]["km_speed_0"].push(pack->inv_r_send(i).km_speed_0());
		(*net_signals)["INV_R_SEND"]["ballast_ext"].push(pack->inv_r_send(i).ballast_ext());
		(*net_signals)["INV_R_SEND"]["cmc__bit1__idc_limit_ena"].push(pack->inv_r_send(i).cmc__bit1__idc_limit_ena());
		(*net_signals)["INV_R_SEND"]["cs_ain_2_format"].push(pack->inv_r_send(i).cs_ain_2_format());
		(*net_signals)["INV_R_SEND"]["km_frg_off"].push(pack->inv_r_send(i).km_frg_off());
		(*net_signals)["INV_R_SEND"]["fb_special"].push(pack->inv_r_send(i).fb_special());
		(*net_signals)["INV_R_SEND"]["cmc__bit2__pdc_limit_usage"].push(pack->inv_r_send(i).cmc__bit2__pdc_limit_usage());
		(*net_signals)["INV_R_SEND"]["km_cal_off"].push(pack->inv_r_send(i).km_cal_off());
		(*net_signals)["INV_R_SEND"]["coaststop"].push(pack->inv_r_send(i).coaststop());
		(*net_signals)["INV_R_SEND"]["cmc__bit3__torqueval_init_ena"].push(pack->inv_r_send(i).cmc__bit3__torqueval_init_ena());
		(*net_enums)["INV_R_SEND"]["cs_ain_1_mode"].push(pack->inv_r_send(i).cs_ain_1_mode());
		inverters_inv_r_send_cs_ain_1_mode_enum_to_string((inverters_inv_r_send_cs_ain_1_mode)pack->inv_r_send(i).cs_ain_1_mode(), buffer);
		(*net_strings)["INV_R_SEND"]["cs_ain_1_mode"].push(buffer);
		(*net_signals)["INV_R_SEND"]["km_tx_tog_stat"].push(pack->inv_r_send(i).km_tx_tog_stat());
		(*net_signals)["INV_R_SEND"]["i_ist_inverse"].push(pack->inv_r_send(i).i_ist_inverse());
		(*net_enums)["INV_R_SEND"]["compare_var194"].push(pack->inv_r_send(i).compare_var194());
		inverters_inv_r_send_compare_var194_enum_to_string((inverters_inv_r_send_compare_var194)pack->inv_r_send(i).compare_var194(), buffer);
		(*net_strings)["INV_R_SEND"]["compare_var194"].push(buffer);
		(*net_enums)["INV_R_SEND"]["compare_var195"].push(pack->inv_r_send(i).compare_var195());
		inverters_inv_r_send_compare_var195_enum_to_string((inverters_inv_r_send_compare_var195)pack->inv_r_send(i).compare_var195(), buffer);
		(*net_strings)["INV_R_SEND"]["compare_var195"].push(buffer);
		(*net_enums)["INV_R_SEND"]["compare_var218"].push(pack->inv_r_send(i).compare_var218());
		inverters_inv_r_send_compare_var218_enum_to_string((inverters_inv_r_send_compare_var218)pack->inv_r_send(i).compare_var218(), buffer);
		(*net_strings)["INV_R_SEND"]["compare_var218"].push(buffer);
		(*net_enums)["INV_R_SEND"]["compare_var219"].push(pack->inv_r_send(i).compare_var219());
		inverters_inv_r_send_compare_var219_enum_to_string((inverters_inv_r_send_compare_var219)pack->inv_r_send(i).compare_var219(), buffer);
		(*net_strings)["INV_R_SEND"]["compare_var219"].push(buffer);
		(*net_signals)["INV_R_SEND"]["cmc__bit4__dig_m_rcpramp_ena"].push(pack->inv_r_send(i).cmc__bit4__dig_m_rcpramp_ena());
		(*net_signals)["INV_R_SEND"]["km_i_limit"].push(pack->inv_r_send(i).km_i_limit());
		(*net_signals)["INV_R_SEND"]["refsoft"].push(pack->inv_r_send(i).refsoft());
		...
		(*net_signals)["INV_R_SEND"]["cmc__bit5__reset_nramp_atnzero"].push(pack->inv_r_send(i).cmc__bit5__reset_nramp_atnzero());
		(*net_signals)["INV_R_SEND"]["km_n_clip"].push(pack->inv_r_send(i).km_n_clip());
		(*net_signals)["INV_R_SEND"]["no_uesp_btb"].push(pack->inv_r_send(i).no_uesp_btb());
		(*net_signals)["INV_R_SEND"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_r_send(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_signals)["INV_R_SEND"]["cs_oora1"].push(pack->inv_r_send(i).cs_oora1());
		(*net_signals)["INV_R_SEND"]["km_mix_ana_on"].push(pack->inv_r_send(i).km_mix_ana_on());
		(*net_signals)["INV_R_SEND"]["vdc_ana"].push(pack->inv_r_send(i).vdc_ana());
		(*net_signals)["INV_R_SEND"]["cmc__bit13_7__free"].push(pack->inv_r_send(i).cmc__bit13_7__free());
		(*net_enums)["INV_R_SEND"]["cs_ain_2_mode"].push(pack->inv_r_send(i).cs_ain_2_mode());
		inverters_inv_r_send_cs_ain_2_mode_enum_to_string((inverters_inv_r_send_cs_ain_2_mode)pack->inv_r_send(i).cs_ain_2_mode(), buffer);
		(*net_strings)["INV_R_SEND"]["cs_ain_2_mode"].push(buffer);
		...
		(*net_signals)["INV_R_SEND"]["km_allow_sync"].push(pack->inv_r_send(i).km_allow_sync());
		(*net_signals)["INV_R_SEND"]["i1_adc_ena"].push(pack->inv_r_send(i).i1_adc_ena());
		...
		(*net_enums)["INV_R_SEND"]["source_id194"].push(pack->inv_r_send(i).source_id194());
		inverters_inv_r_send_source_id194_enum_to_string((inverters_inv_r_send_source_id194)pack->inv_r_send(i).source_id194(), buffer);
		(*net_strings)["INV_R_SEND"]["source_id194"].push(buffer);
		(*net_enums)["INV_R_SEND"]["source_id195"].push(pack->inv_r_send(i).source_id195());
		inverters_inv_r_send_source_id195_enum_to_string((inverters_inv_r_send_source_id195)pack->inv_r_send(i).source_id195(), buffer);
		(*net_strings)["INV_R_SEND"]["source_id195"].push(buffer);
		(*net_enums)["INV_R_SEND"]["source_id218"].push(pack->inv_r_send(i).source_id218());
		inverters_inv_r_send_source_id218_enum_to_string((inverters_inv_r_send_source_id218)pack->inv_r_send(i).source_id218(), buffer);
		(*net_strings)["INV_R_SEND"]["source_id218"].push(buffer);
		(*net_enums)["INV_R_SEND"]["source_id219"].push(pack->inv_r_send(i).source_id219());
		inverters_inv_r_send_source_id219_enum_to_string((inverters_inv_r_send_source_id219)pack->inv_r_send(i).source_id219(), buffer);
		(*net_strings)["INV_R_SEND"]["source_id219"].push(buffer);
		(*net_signals)["INV_R_SEND"]["dup__bit8__can_extended_0"].push(pack->inv_r_send(i).dup__bit8__can_extended_0());
		(*net_signals)["INV_R_SEND"]["km_handwheel"].push(pack->inv_r_send(i).km_handwheel());
		(*net_signals)["INV_R_SEND"]["hxinv"].push(pack->inv_r_send(i).hxinv());
		(*net_signals)["INV_R_SEND"]["dup__bit9__generator"].push(pack->inv_r_send(i).dup__bit9__generator());
		(*net_signals)["INV_R_SEND"]["km_phasing_extend"].push(pack->inv_r_send(i).km_phasing_extend());
		(*net_signals)["INV_R_SEND"]["h2inv"].push(pack->inv_r_send(i).h2inv());
		(*net_signals)["INV_R_SEND"]["dup__bit10__park_rms"].push(pack->inv_r_send(i).dup__bit10__park_rms());
		(*net_signals)["INV_R_SEND"]["cs_oora2"].push(pack->inv_r_send(i).cs_oora2());
		(*net_signals)["INV_R_SEND"]["km_rsvd_11"].push(pack->inv_r_send(i).km_rsvd_11());
		(*net_signals)["INV_R_SEND"]["ol_comp"].push(pack->inv_r_send(i).ol_comp());
		(*net_signals)["INV_R_SEND"]["mo_sc1_comp"].push(pack->inv_r_send(i).mo_sc1_comp());
		(*net_signals)["INV_R_SEND"]["dup__bit11__dcbus_volts"].push(pack->inv_r_send(i).dup__bit11__dcbus_volts());
		(*net_enums)["INV_R_SEND"]["cs_cmd_type"].push(pack->inv_r_send(i).cs_cmd_type());
		inverters_inv_r_send_cs_cmd_type_enum_to_string((inverters_inv_r_send_cs_cmd_type)pack->inv_r_send(i).cs_cmd_type(), buffer);
		(*net_strings)["INV_R_SEND"]["cs_cmd_type"].push(buffer);
		(*net_signals)["INV_R_SEND"]["km_rsvd_12"].push(pack->inv_r_send(i).km_rsvd_12());
		(*net_enums)["INV_R_SEND"]["motortype"].push(pack->inv_r_send(i).motortype());
		inverters_inv_r_send_motortype_enum_to_string((inverters_inv_r_send_motortype)pack->inv_r_send(i).motortype(), buffer);
		(*net_strings)["INV_R_SEND"]["motortype"].push(buffer);
		...
		(*net_signals)["INV_R_SEND"]["dup__bit12__boat_pedal"].push(pack->inv_r_send(i).dup__bit12__boat_pedal());
		(*net_signals)["INV_R_SEND"]["km_rsvd_13"].push(pack->inv_r_send(i).km_rsvd_13());
		(*net_signals)["INV_R_SEND"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_r_send(i).dup__bit13__gen_autoiaclimit());
		(*net_signals)["INV_R_SEND"]["cs_ain_2__i_limit"].push(pack->inv_r_send(i).cs_ain_2__i_limit());
		(*net_signals)["INV_R_SEND"]["km_pseudo_enable"].push(pack->inv_r_send(i).km_pseudo_enable());
		(*net_signals)["INV_R_SEND"]["ana_0up"].push(pack->inv_r_send(i).ana_0up());
		(*net_signals)["INV_R_SEND"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_r_send(i).cmc__bit14__idc_limit_ena_v2());
		(*net_signals)["INV_R_SEND"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_r_send(i).dup__bit14__mtpa_reluct_enab());
		(*net_signals)["INV_R_SEND"]["cs_ain_1__n_limit"].push(pack->inv_r_send(i).cs_ain_1__n_limit());
		(*net_signals)["INV_R_SEND"]["km_debug_test"].push(pack->inv_r_send(i).km_debug_test());
		(*net_signals)["INV_R_SEND"]["lowbd"].push(pack->inv_r_send(i).lowbd());
		(*net_signals)["INV_R_SEND"]["mo_sc2_inv"].push(pack->inv_r_send(i).mo_sc2_inv());
		...
		(*net_signals)["INV_R_SEND"]["cmc__bit15__dig_e_brake_act"].push(pack->inv_r_send(i).cmc__bit15__dig_e_brake_act());
		(*net_signals)["INV_R_SEND"]["dup__bit15__canopen_acv"].push(pack->inv_r_send(i).dup__bit15__canopen_acv());
		(*net_signals)["INV_R_SEND"]["t_dc__stop"].push(pack->inv_r_send(i).t_dc__stop());
		(*net_signals)["INV_R_SEND"]["v_dc__stop"].push(pack->inv_r_send(i).v_dc__stop());
		(*net_signals)["INV_R_SEND"]["special__stop"].push(pack->inv_r_send(i).special__stop());
		(*net_signals)["INV_R_SEND"]["v_min__stop"].push(pack->inv_r_send(i).v_min__stop());
		(*net_signals)["INV_R_SEND"]["f_min__stop"].push(pack->inv_r_send(i).f_min__stop());
		(*net_signals)["INV_R_SEND"]["v_corner__stop"].push(pack->inv_r_send(i).v_corner__stop());
		(*net_signals)["INV_R_SEND"]["f_corner__stop"].push(pack->inv_r_send(i).f_corner__stop());
		...
		(*net_signals)["INV_R_SEND"]["ain_in_1_scaleval"].push(pack->inv_r_send(i).ain_in_1_scaleval());
		(*net_signals)["INV_R_SEND"]["m_r_acc"].push(pack->inv_r_send(i).m_r_acc());
		(*net_signals)["INV_R_SEND"]["sramp"].push(pack->inv_r_send(i).sramp());
		...
		(*net_signals)["INV_R_SEND"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_r_send(i).dup__bit16__bamobil3_2_offcrct());
		(*net_signals)["INV_R_SEND"]["m_r_dec"].push(pack->inv_r_send(i).m_r_dec());
		(*net_signals)["INV_R_SEND"]["ramp4"].push(pack->inv_r_send(i).ramp4());
		(*net_signals)["INV_R_SEND"]["dup__bit19_17__ecode_redefine"].push(pack->inv_r_send(i).dup__bit19_17__ecode_redefine());
		(*net_signals)["INV_R_SEND"]["motbrake"].push(pack->inv_r_send(i).motbrake());
		(*net_signals)["INV_R_SEND"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_r_send(i).cmc__bit18__tractioncontrol_ena());
		(*net_signals)["INV_R_SEND"]["ac_dc"].push(pack->inv_r_send(i).ac_dc());
		(*net_signals)["INV_R_SEND"]["cmc__bit20_19__tc_deltatime_conf"].push(pack->inv_r_send(i).cmc__bit20_19__tc_deltatime_conf());
		(*net_enums)["INV_R_SEND"]["pwm_freq"].push(pack->inv_r_send(i).pwm_freq());
		inverters_inv_r_send_pwm_freq_enum_to_string((inverters_inv_r_send_pwm_freq)pack->inv_r_send(i).pwm_freq(), buffer);
		(*net_strings)["INV_R_SEND"]["pwm_freq"].push(buffer);
		(*net_signals)["INV_R_SEND"]["dup__bit20__hal_extmr_acv"].push(pack->inv_r_send(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_R_SEND"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_r_send(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_signals)["INV_R_SEND"]["dup__bit21__initwith_frg_off"].push(pack->inv_r_send(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_R_SEND"]["dup__bit31_22__free"].push(pack->inv_r_send(i).dup__bit31_22__free());
		(*net_signals)["INV_R_SEND"]["ntc"].push(pack->inv_r_send(i).ntc());
		(*net_signals)["INV_R_SEND"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_r_send(i).cmc__bit23__tc_ncmdrestoption());
		(*net_signals)["INV_R_SEND"]["delta"].push(pack->inv_r_send(i).delta());
		(*net_signals)["INV_R_SEND"]["cmc__bit31_24__free"].push(pack->inv_r_send(i).cmc__bit31_24__free());
		(*net_signals)["INV_R_SEND"]["dc_1qdirvolt"].push(pack->inv_r_send(i).dc_1qdirvolt());
		(*net_signals)["INV_R_SEND"]["dc_field"].push(pack->inv_r_send(i).dc_field());
		(*net_signals)["INV_R_SEND"]["dead_2"].push(pack->inv_r_send(i).dead_2());
		(*net_signals)["INV_R_SEND"]["block"].push(pack->inv_r_send(i).block());
		(*net_signals)["INV_R_SEND"]["dc_1qmv"].push(pack->inv_r_send(i).dc_1qmv());
		(*net_signals)["INV_R_SEND"]["dc_1q3p"].push(pack->inv_r_send(i).dc_1q3p());
		(*net_signals)["INV_R_SEND"]["reducelosses"].push(pack->inv_r_send(i).reducelosses());
    ...
    for(int i = 0; i < pack->inv_r_rcv_size(); i++){
		...
		(*net_signals)["INV_R_RCV"]["ena64"].push(pack->inv_r_rcv(i).ena64());
		...
		(*net_signals)["INV_R_RCV"]["end_1"].push(pack->inv_r_rcv(i).end_1());
		(*net_signals)["INV_R_RCV"]["din_1"].push(pack->inv_r_rcv(i).din_1());
		(*net_signals)["INV_R_RCV"]["end_2"].push(pack->inv_r_rcv(i).end_2());
		(*net_signals)["INV_R_RCV"]["din_2"].push(pack->inv_r_rcv(i).din_2());
		(*net_signals)["INV_R_RCV"]["run232"].push(pack->inv_r_rcv(i).run232());
		(*net_signals)["INV_R_RCV"]["dout_1"].push(pack->inv_r_rcv(i).dout_1());
		(*net_signals)["INV_R_RCV"]["dout_2"].push(pack->inv_r_rcv(i).dout_2());
		(*net_signals)["INV_R_RCV"]["dout_3"].push(pack->inv_r_rcv(i).dout_3());
		(*net_signals)["INV_R_RCV"]["rdy_btb"].push(pack->inv_r_rcv(i).rdy_btb());
		(*net_signals)["INV_R_RCV"]["i_fault"].push(pack->inv_r_rcv(i).i_fault());
		(*net_signals)["INV_R_RCV"]["dout_4"].push(pack->inv_r_rcv(i).dout_4());
		...
		(*net_enums)["INV_R_RCV"]["activecontrolmode"].push(pack->inv_r_rcv(i).activecontrolmode());
		inverters_inv_r_rcv_activecontrolmode_enum_to_string((inverters_inv_r_rcv_activecontrolmode)pack->inv_r_rcv(i).activecontrolmode(), buffer);
		(*net_strings)["INV_R_RCV"]["activecontrolmode"].push(buffer);
		(*net_signals)["INV_R_RCV"]["km_rsvd_0"].push(pack->inv_r_rcv(i).km_rsvd_0());
		(*net_signals)["INV_R_RCV"]["ena82"].push(pack->inv_r_rcv(i).ena82());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit0_firsterrordtcd99"].push(pack->inv_r_rcv(i).ecode_bit0_firsterrordtcd99());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit0_firsterrordtcd148"].push(pack->inv_r_rcv(i).ecode_bit0_firsterrordtcd148());
		...
		(*net_signals)["INV_R_RCV"]["signal_go"].push(pack->inv_r_rcv(i).signal_go());
		(*net_signals)["INV_R_RCV"]["signal_brake"].push(pack->inv_r_rcv(i).signal_brake());
		(*net_signals)["INV_R_RCV"]["signal_icns"].push(pack->inv_r_rcv(i).signal_icns());
		(*net_signals)["INV_R_RCV"]["signal_lessn0"].push(pack->inv_r_rcv(i).signal_lessn0());
		(*net_signals)["INV_R_RCV"]["signal_postolerance"].push(pack->inv_r_rcv(i).signal_postolerance());
		...
		(*net_signals)["INV_R_RCV"]["dc_current_sens_ena_set"].push(pack->inv_r_rcv(i).dc_current_sens_ena_set());
		(*net_signals)["INV_R_RCV"]["cmc__bit0__dc_current_sens_ena"].push(pack->inv_r_rcv(i).cmc__bit0__dc_current_sens_ena());
		...
		(*net_signals)["INV_R_RCV"]["fb_lossofsignal"].push(pack->inv_r_rcv(i).fb_lossofsignal());
		(*net_signals)["INV_R_RCV"]["no_hw_fault"].push(pack->inv_r_rcv(i).no_hw_fault());
		...
		(*net_signals)["INV_R_RCV"]["lmt_1"].push(pack->inv_r_rcv(i).lmt_1());
		(*net_signals)["INV_R_RCV"]["out_1"].push(pack->inv_r_rcv(i).out_1());
		...
		(*net_signals)["INV_R_RCV"]["ncr064"].push(pack->inv_r_rcv(i).ncr064());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit1__hw1_state148"].push(pack->inv_r_rcv(i).ecode_bit1__hw1_state148());
		(*net_signals)["INV_R_RCV"]["dc_i_sensena_set"].push(pack->inv_r_rcv(i).dc_i_sensena_set());
		(*net_signals)["INV_R_RCV"]["cmc__bit1__idc_limit_ena"].push(pack->inv_r_rcv(i).cmc__bit1__idc_limit_ena());
		(*net_signals)["INV_R_RCV"]["lmt_2"].push(pack->inv_r_rcv(i).lmt_2());
		(*net_signals)["INV_R_RCV"]["out_2"].push(pack->inv_r_rcv(i).out_2());
		(*net_signals)["INV_R_RCV"]["fb_special"].push(pack->inv_r_rcv(i).fb_special());
		(*net_signals)["INV_R_RCV"]["lim_plus64"].push(pack->inv_r_rcv(i).lim_plus64());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit2__hw0_state99"].push(pack->inv_r_rcv(i).ecode_bit2__hw0_state99());
		(*net_signals)["INV_R_RCV"]["ecode_bit2__hw0_state148"].push(pack->inv_r_rcv(i).ecode_bit2__hw0_state148());
		(*net_signals)["INV_R_RCV"]["op_mode_quadrant"].push(pack->inv_r_rcv(i).op_mode_quadrant());
		(*net_signals)["INV_R_RCV"]["cmc__bit2__pdc_limit_usage"].push(pack->inv_r_rcv(i).cmc__bit2__pdc_limit_usage());
		(*net_signals)["INV_R_RCV"]["in_2"].push(pack->inv_r_rcv(i).in_2());
		(*net_signals)["INV_R_RCV"]["rdy155"].push(pack->inv_r_rcv(i).rdy155());
		(*net_signals)["INV_R_RCV"]["coaststop"].push(pack->inv_r_rcv(i).coaststop());
		(*net_signals)["INV_R_RCV"]["lim_minus64"].push(pack->inv_r_rcv(i).lim_minus64());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit3__free148"].push(pack->inv_r_rcv(i).ecode_bit3__free148());
		(*net_signals)["INV_R_RCV"]["cmc__bit3__torqueval_init_ena"].push(pack->inv_r_rcv(i).cmc__bit3__torqueval_init_ena());
		(*net_signals)["INV_R_RCV"]["in_1"].push(pack->inv_r_rcv(i).in_1());
		(*net_signals)["INV_R_RCV"]["go155"].push(pack->inv_r_rcv(i).go155());
		(*net_signals)["INV_R_RCV"]["i_ist_inverse"].push(pack->inv_r_rcv(i).i_ist_inverse());
		(*net_signals)["INV_R_RCV"]["ok64"].push(pack->inv_r_rcv(i).ok64());
		(*net_signals)["INV_R_RCV"]["err_feedbacksignal"].push(pack->inv_r_rcv(i).err_feedbacksignal());
		(*net_signals)["INV_R_RCV"]["frgrun"].push(pack->inv_r_rcv(i).frgrun());
		...
		(*net_signals)["INV_R_RCV"]["km_tx_tog_stat"].push(pack->inv_r_rcv(i).km_tx_tog_stat());
		(*net_signals)["INV_R_RCV"]["ok82"].push(pack->inv_r_rcv(i).ok82());
		(*net_signals)["INV_R_RCV"]["ecode_bit4__rdy399"].push(pack->inv_r_rcv(i).ecode_bit4__rdy399());
		(*net_signals)["INV_R_RCV"]["ecode_bit4__rdy3148"].push(pack->inv_r_rcv(i).ecode_bit4__rdy3148());
		...
		(*net_signals)["INV_R_RCV"]["cmc__bit4__dig_m_rcpramp_ena"].push(pack->inv_r_rcv(i).cmc__bit4__dig_m_rcpramp_ena());
		(*net_signals)["INV_R_RCV"]["run152"].push(pack->inv_r_rcv(i).run152());
		(*net_signals)["INV_R_RCV"]["out_3"].push(pack->inv_r_rcv(i).out_3());
		(*net_signals)["INV_R_RCV"]["refsoft"].push(pack->inv_r_rcv(i).refsoft());
		(*net_signals)["INV_R_RCV"]["icns64"].push(pack->inv_r_rcv(i).icns64());
		(*net_signals)["INV_R_RCV"]["err_powervoltage_low"].push(pack->inv_r_rcv(i).err_powervoltage_low());
		(*net_signals)["INV_R_RCV"]["rfe216"].push(pack->inv_r_rcv(i).rfe216());
		(*net_signals)["INV_R_RCV"]["km_i_limit"].push(pack->inv_r_rcv(i).km_i_limit());
		(*net_signals)["INV_R_RCV"]["icns82"].push(pack->inv_r_rcv(i).icns82());
		(*net_signals)["INV_R_RCV"]["ecode_bit5__n_fail99"].push(pack->inv_r_rcv(i).ecode_bit5__n_fail99());
		(*net_signals)["INV_R_RCV"]["ecode_bit5__n_fail148"].push(pack->inv_r_rcv(i).ecode_bit5__n_fail148());
		...
		(*net_signals)["INV_R_RCV"]["recup_is_acv"].push(pack->inv_r_rcv(i).recup_is_acv());
		(*net_signals)["INV_R_RCV"]["cmc__bit5__reset_nramp_atnzero"].push(pack->inv_r_rcv(i).cmc__bit5__reset_nramp_atnzero());
		(*net_signals)["INV_R_RCV"]["rfe152"].push(pack->inv_r_rcv(i).rfe152());
		(*net_signals)["INV_R_RCV"]["out_4"].push(pack->inv_r_rcv(i).out_4());
		(*net_signals)["INV_R_RCV"]["no_uesp_btb"].push(pack->inv_r_rcv(i).no_uesp_btb());
		(*net_signals)["INV_R_RCV"]["tnlim64"].push(pack->inv_r_rcv(i).tnlim64());
		(*net_signals)["INV_R_RCV"]["err_motortemp"].push(pack->inv_r_rcv(i).err_motortemp());
		(*net_signals)["INV_R_RCV"]["km_n_clip"].push(pack->inv_r_rcv(i).km_n_clip());
		(*net_signals)["INV_R_RCV"]["tnlim82"].push(pack->inv_r_rcv(i).tnlim82());
		(*net_signals)["INV_R_RCV"]["ecode_bit6__flths99"].push(pack->inv_r_rcv(i).ecode_bit6__flths99());
		(*net_signals)["INV_R_RCV"]["ecode_bit6__flths148"].push(pack->inv_r_rcv(i).ecode_bit6__flths148());
		(*net_signals)["INV_R_RCV"]["i_dc_limit_is_acv"].push(pack->inv_r_rcv(i).i_dc_limit_is_acv());
		(*net_signals)["INV_R_RCV"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_r_rcv(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_signals)["INV_R_RCV"]["rsvd"].push(pack->inv_r_rcv(i).rsvd());
		(*net_signals)["INV_R_RCV"]["rsvd1"].push(pack->inv_r_rcv(i).rsvd1());
		(*net_signals)["INV_R_RCV"]["vdc_ana"].push(pack->inv_r_rcv(i).vdc_ana());
		(*net_signals)["INV_R_RCV"]["pn64"].push(pack->inv_r_rcv(i).pn64());
		(*net_signals)["INV_R_RCV"]["err_devicetemp"].push(pack->inv_r_rcv(i).err_devicetemp());
		(*net_signals)["INV_R_RCV"]["cs_oora1"].push(pack->inv_r_rcv(i).cs_oora1());
		(*net_signals)["INV_R_RCV"]["km_mix_ana_on"].push(pack->inv_r_rcv(i).km_mix_ana_on());
		(*net_signals)["INV_R_RCV"]["pn82"].push(pack->inv_r_rcv(i).pn82());
		(*net_signals)["INV_R_RCV"]["ecode_bit7__fltls99"].push(pack->inv_r_rcv(i).ecode_bit7__fltls99());
		(*net_signals)["INV_R_RCV"]["ecode_bit7__fltls148"].push(pack->inv_r_rcv(i).ecode_bit7__fltls148());
		...
		(*net_signals)["INV_R_RCV"]["ni64"].push(pack->inv_r_rcv(i).ni64());
		...
		(*net_enums)["INV_R_RCV"]["ctrlsubmode"].push(pack->inv_r_rcv(i).ctrlsubmode());
		inverters_inv_r_rcv_ctrlsubmode_enum_to_string((inverters_inv_r_rcv_ctrlsubmode)pack->inv_r_rcv(i).ctrlsubmode(), buffer);
		(*net_strings)["INV_R_RCV"]["ctrlsubmode"].push(buffer);
		(*net_signals)["INV_R_RCV"]["km_allow_sync"].push(pack->inv_r_rcv(i).km_allow_sync());
		(*net_signals)["INV_R_RCV"]["ni82"].push(pack->inv_r_rcv(i).ni82());
		(*net_signals)["INV_R_RCV"]["ain_in_2_filter"].push(pack->inv_r_rcv(i).ain_in_2_filter());
		(*net_signals)["INV_R_RCV"]["ecode_bit8__fail_idc99"].push(pack->inv_r_rcv(i).ecode_bit8__fail_idc99());
		(*net_signals)["INV_R_RCV"]["ecode_bit8__fail_idc148"].push(pack->inv_r_rcv(i).ecode_bit8__fail_idc148());
		...
		(*net_signals)["INV_R_RCV"]["_n064"].push(pack->inv_r_rcv(i)._n064());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit9__fail_i148"].push(pack->inv_r_rcv(i).ecode_bit9__fail_i148());
		(*net_signals)["INV_R_RCV"]["dup__bit9__generator"].push(pack->inv_r_rcv(i).dup__bit9__generator());
		(*net_signals)["INV_R_RCV"]["h2inv"].push(pack->inv_r_rcv(i).h2inv());
		(*net_signals)["INV_R_RCV"]["rsw64"].push(pack->inv_r_rcv(i).rsw64());
		(*net_signals)["INV_R_RCV"]["err_raceaway"].push(pack->inv_r_rcv(i).err_raceaway());
		(*net_signals)["INV_R_RCV"]["btbrdy"].push(pack->inv_r_rcv(i).btbrdy());
		(*net_signals)["INV_R_RCV"]["km_phasing_extend"].push(pack->inv_r_rcv(i).km_phasing_extend());
		(*net_signals)["INV_R_RCV"]["rsw82"].push(pack->inv_r_rcv(i).rsw82());
		(*net_signals)["INV_R_RCV"]["ecode_bit10__vccm99"].push(pack->inv_r_rcv(i).ecode_bit10__vccm99());
		(*net_signals)["INV_R_RCV"]["ecode_bit10__vccm148"].push(pack->inv_r_rcv(i).ecode_bit10__vccm148());
		(*net_signals)["INV_R_RCV"]["dup__bit10__park_rms"].push(pack->inv_r_rcv(i).dup__bit10__park_rms());
		(*net_signals)["INV_R_RCV"]["ol_comp"].push(pack->inv_r_rcv(i).ol_comp());
		(*net_signals)["INV_R_RCV"]["cal064"].push(pack->inv_r_rcv(i).cal064());
		(*net_signals)["INV_R_RCV"]["err_user"].push(pack->inv_r_rcv(i).err_user());
		(*net_signals)["INV_R_RCV"]["go216"].push(pack->inv_r_rcv(i).go216());
		(*net_signals)["INV_R_RCV"]["cs_oora2"].push(pack->inv_r_rcv(i).cs_oora2());
		(*net_signals)["INV_R_RCV"]["km_rsvd_11"].push(pack->inv_r_rcv(i).km_rsvd_11());
		(*net_signals)["INV_R_RCV"]["cal082"].push(pack->inv_r_rcv(i).cal082());
		(*net_signals)["INV_R_RCV"]["ecode_bit11__15m_minus99"].push(pack->inv_r_rcv(i).ecode_bit11__15m_minus99());
		(*net_signals)["INV_R_RCV"]["ecode_bit11__15m_minus148"].push(pack->inv_r_rcv(i).ecode_bit11__15m_minus148());
		(*net_signals)["INV_R_RCV"]["mo_sc1_comp"].push(pack->inv_r_rcv(i).mo_sc1_comp());
		(*net_signals)["INV_R_RCV"]["dup__bit11__dcbus_volts"].push(pack->inv_r_rcv(i).dup__bit11__dcbus_volts());
		...
		(*net_signals)["INV_R_RCV"]["cal64"].push(pack->inv_r_rcv(i).cal64());
		...
		(*net_enums)["INV_R_RCV"]["currentmode"].push(pack->inv_r_rcv(i).currentmode());
		inverters_inv_r_rcv_currentmode_enum_to_string((inverters_inv_r_rcv_currentmode)pack->inv_r_rcv(i).currentmode(), buffer);
		(*net_strings)["INV_R_RCV"]["currentmode"].push(buffer);
		(*net_signals)["INV_R_RCV"]["km_rsvd_12"].push(pack->inv_r_rcv(i).km_rsvd_12());
		(*net_signals)["INV_R_RCV"]["cal82"].push(pack->inv_r_rcv(i).cal82());
		(*net_signals)["INV_R_RCV"]["ecode_bit12__15m_plus99"].push(pack->inv_r_rcv(i).ecode_bit12__15m_plus99());
		(*net_signals)["INV_R_RCV"]["ecode_bit12__15m_plus148"].push(pack->inv_r_rcv(i).ecode_bit12__15m_plus148());
		...
		(*net_signals)["INV_R_RCV"]["tol64"].push(pack->inv_r_rcv(i).tol64());
		...
		(*net_signals)["INV_R_RCV"]["ecode_bit13__18m_plus148"].push(pack->inv_r_rcv(i).ecode_bit13__18m_plus148());
		(*net_signals)["INV_R_RCV"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_r_rcv(i).dup__bit13__gen_autoiaclimit());
		(*net_signals)["INV_R_RCV"]["ana_0up"].push(pack->inv_r_rcv(i).ana_0up());
		(*net_signals)["INV_R_RCV"]["rdy64"].push(pack->inv_r_rcv(i).rdy64());
		(*net_signals)["INV_R_RCV"]["err_hwerr"].push(pack->inv_r_rcv(i).err_hwerr());
		(*net_signals)["INV_R_RCV"]["goff"].push(pack->inv_r_rcv(i).goff());
		(*net_signals)["INV_R_RCV"]["cs_ain_2__i_limit"].push(pack->inv_r_rcv(i).cs_ain_2__i_limit());
		(*net_signals)["INV_R_RCV"]["km_pseudo_enable"].push(pack->inv_r_rcv(i).km_pseudo_enable());
		(*net_signals)["INV_R_RCV"]["rdy82"].push(pack->inv_r_rcv(i).rdy82());
		(*net_signals)["INV_R_RCV"]["ecode_bit14__ubmam99"].push(pack->inv_r_rcv(i).ecode_bit14__ubmam99());
		(*net_signals)["INV_R_RCV"]["ecode_bit14__ubmam148"].push(pack->inv_r_rcv(i).ecode_bit14__ubmam148());
		(*net_signals)["INV_R_RCV"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_r_rcv(i).cmc__bit14__idc_limit_ena_v2());
		(*net_signals)["INV_R_RCV"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_r_rcv(i).dup__bit14__mtpa_reluct_enab());
		(*net_signals)["INV_R_RCV"]["lowbd"].push(pack->inv_r_rcv(i).lowbd());
		(*net_signals)["INV_R_RCV"]["brk064"].push(pack->inv_r_rcv(i).brk064());
		(*net_signals)["INV_R_RCV"]["err_ballast"].push(pack->inv_r_rcv(i).err_ballast());
		(*net_signals)["INV_R_RCV"]["brk1216"].push(pack->inv_r_rcv(i).brk1216());
		(*net_signals)["INV_R_RCV"]["cs_ain_1__n_limit"].push(pack->inv_r_rcv(i).cs_ain_1__n_limit());
		(*net_signals)["INV_R_RCV"]["km_debug_test"].push(pack->inv_r_rcv(i).km_debug_test());
		(*net_signals)["INV_R_RCV"]["brk082"].push(pack->inv_r_rcv(i).brk082());
		(*net_signals)["INV_R_RCV"]["ecode_bit15__t_igbt99"].push(pack->inv_r_rcv(i).ecode_bit15__t_igbt99());
		(*net_signals)["INV_R_RCV"]["ecode_bit15__t_igbt148"].push(pack->inv_r_rcv(i).ecode_bit15__t_igbt148());
		(*net_signals)["INV_R_RCV"]["mo_sc2_inv"].push(pack->inv_r_rcv(i).mo_sc2_inv());
		...
		(*net_signals)["INV_R_RCV"]["gen_autoiaclimit_is_acv"].push(pack->inv_r_rcv(i).gen_autoiaclimit_is_acv());
		(*net_signals)["INV_R_RCV"]["cmc__bit15__dig_e_brake_act"].push(pack->inv_r_rcv(i).cmc__bit15__dig_e_brake_act());
		(*net_signals)["INV_R_RCV"]["dup__bit15__canopen_acv"].push(pack->inv_r_rcv(i).dup__bit15__canopen_acv());
		(*net_signals)["INV_R_RCV"]["m_r_dec"].push(pack->inv_r_rcv(i).m_r_dec());
		(*net_signals)["INV_R_RCV"]["m_r_rcp"].push(pack->inv_r_rcv(i).m_r_rcp());
		(*net_signals)["INV_R_RCV"]["sramp"].push(pack->inv_r_rcv(i).sramp());
		(*net_signals)["INV_R_RCV"]["signmag64"].push(pack->inv_r_rcv(i).signmag64());
		(*net_signals)["INV_R_RCV"]["warn_warning_0"].push(pack->inv_r_rcv(i).warn_warning_0());
		...
		(*net_signals)["INV_R_RCV"]["signmag82"].push(pack->inv_r_rcv(i).signmag82());
		...
		(*net_signals)["INV_R_RCV"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_r_rcv(i).dup__bit16__bamobil3_2_offcrct());
		...
		(*net_signals)["INV_R_RCV"]["ramp4"].push(pack->inv_r_rcv(i).ramp4());
		(*net_signals)["INV_R_RCV"]["nclip64"].push(pack->inv_r_rcv(i).nclip64());
		(*net_signals)["INV_R_RCV"]["warn_illegal_status"].push(pack->inv_r_rcv(i).warn_illegal_status());
		(*net_signals)["INV_R_RCV"]["nclip82"].push(pack->inv_r_rcv(i).nclip82());
		(*net_signals)["INV_R_RCV"]["dup__bit19_17__ecode_redefine"].push(pack->inv_r_rcv(i).dup__bit19_17__ecode_redefine());
		(*net_signals)["INV_R_RCV"]["motbrake"].push(pack->inv_r_rcv(i).motbrake());
		(*net_signals)["INV_R_RCV"]["nclip_minus64"].push(pack->inv_r_rcv(i).nclip_minus64());
		(*net_signals)["INV_R_RCV"]["warn_safe_in"].push(pack->inv_r_rcv(i).warn_safe_in());
		(*net_signals)["INV_R_RCV"]["nclip_minus82"].push(pack->inv_r_rcv(i).nclip_minus82());
		(*net_signals)["INV_R_RCV"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_r_rcv(i).cmc__bit18__tractioncontrol_ena());
		(*net_signals)["INV_R_RCV"]["ac_dc"].push(pack->inv_r_rcv(i).ac_dc());
		(*net_signals)["INV_R_RCV"]["nclip_plus64"].push(pack->inv_r_rcv(i).nclip_plus64());
		(*net_signals)["INV_R_RCV"]["nclip_plus82"].push(pack->inv_r_rcv(i).nclip_plus82());
		(*net_signals)["INV_R_RCV"]["cmc__bit20_19__tc_deltatime_conf"].push(pack->inv_r_rcv(i).cmc__bit20_19__tc_deltatime_conf());
		(*net_enums)["INV_R_RCV"]["pwm_freq"].push(pack->inv_r_rcv(i).pwm_freq());
		inverters_inv_r_rcv_pwm_freq_enum_to_string((inverters_inv_r_rcv_pwm_freq)pack->inv_r_rcv(i).pwm_freq(), buffer);
		(*net_strings)["INV_R_RCV"]["pwm_freq"].push(buffer);
		(*net_signals)["INV_R_RCV"]["irddig64"].push(pack->inv_r_rcv(i).irddig64());
		(*net_signals)["INV_R_RCV"]["irddig82"].push(pack->inv_r_rcv(i).irddig82());
		(*net_signals)["INV_R_RCV"]["dup__bit20__hal_extmr_acv"].push(pack->inv_r_rcv(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_R_RCV"]["iuserchd64"].push(pack->inv_r_rcv(i).iuserchd64());
		(*net_signals)["INV_R_RCV"]["iuserchd82"].push(pack->inv_r_rcv(i).iuserchd82());
		(*net_signals)["INV_R_RCV"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_r_rcv(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_signals)["INV_R_RCV"]["dup__bit21__initwith_frg_off"].push(pack->inv_r_rcv(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_R_RCV"]["irdn64"].push(pack->inv_r_rcv(i).irdn64());
		(*net_signals)["INV_R_RCV"]["warn_motortemp"].push(pack->inv_r_rcv(i).warn_motortemp());
		(*net_signals)["INV_R_RCV"]["irdn82"].push(pack->inv_r_rcv(i).irdn82());
		(*net_signals)["INV_R_RCV"]["dup__bit31_22__free"].push(pack->inv_r_rcv(i).dup__bit31_22__free());
		(*net_signals)["INV_R_RCV"]["ntc"].push(pack->inv_r_rcv(i).ntc());
		(*net_signals)["INV_R_RCV"]["irdti64"].push(pack->inv_r_rcv(i).irdti64());
		(*net_signals)["INV_R_RCV"]["warn_devicetemp"].push(pack->inv_r_rcv(i).warn_devicetemp());
		(*net_signals)["INV_R_RCV"]["irdti82"].push(pack->inv_r_rcv(i).irdti82());
		(*net_signals)["INV_R_RCV"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_r_rcv(i).cmc__bit23__tc_ncmdrestoption());
		(*net_signals)["INV_R_RCV"]["m_r_acc"].push(pack->inv_r_rcv(i).m_r_acc());
		(*net_signals)["INV_R_RCV"]["delta"].push(pack->inv_r_rcv(i).delta());
		(*net_signals)["INV_R_RCV"]["irdtir64"].push(pack->inv_r_rcv(i).irdtir64());
		(*net_signals)["INV_R_RCV"]["warn_vout_sat"].push(pack->inv_r_rcv(i).warn_vout_sat());
		(*net_signals)["INV_R_RCV"]["irdtir82"].push(pack->inv_r_rcv(i).irdtir82());
		(*net_signals)["INV_R_RCV"]["cmc__bit31_24__free"].push(pack->inv_r_rcv(i).cmc__bit31_24__free());
		(*net_signals)["INV_R_RCV"]["dc_1qdirvolt"].push(pack->inv_r_rcv(i).dc_1qdirvolt());
		(*net_signals)["INV_R_RCV"]["_10hz64"].push(pack->inv_r_rcv(i)._10hz64());
		(*net_signals)["INV_R_RCV"]["warn_ipeak"].push(pack->inv_r_rcv(i).warn_ipeak());
		(*net_signals)["INV_R_RCV"]["_10hz82"].push(pack->inv_r_rcv(i)._10hz82());
		(*net_signals)["INV_R_RCV"]["dc_field"].push(pack->inv_r_rcv(i).dc_field());
		(*net_signals)["INV_R_RCV"]["irdtm64"].push(pack->inv_r_rcv(i).irdtm64());
		(*net_signals)["INV_R_RCV"]["warn_raceaway"].push(pack->inv_r_rcv(i).warn_raceaway());
		(*net_signals)["INV_R_RCV"]["irdtm82"].push(pack->inv_r_rcv(i).irdtm82());
		(*net_signals)["INV_R_RCV"]["dead_2"].push(pack->inv_r_rcv(i).dead_2());
		(*net_signals)["INV_R_RCV"]["irdana64"].push(pack->inv_r_rcv(i).irdana64());
		(*net_signals)["INV_R_RCV"]["irdana82"].push(pack->inv_r_rcv(i).irdana82());
		(*net_signals)["INV_R_RCV"]["block"].push(pack->inv_r_rcv(i).block());
		(*net_signals)["INV_R_RCV"]["iwcns64"].push(pack->inv_r_rcv(i).iwcns64());
		(*net_signals)["INV_R_RCV"]["iwcns82"].push(pack->inv_r_rcv(i).iwcns82());
		(*net_signals)["INV_R_RCV"]["dc_1qmv"].push(pack->inv_r_rcv(i).dc_1qmv());
		(*net_signals)["INV_R_RCV"]["rfepulse64"].push(pack->inv_r_rcv(i).rfepulse64());
		(*net_signals)["INV_R_RCV"]["rfepulse82"].push(pack->inv_r_rcv(i).rfepulse82());
		(*net_signals)["INV_R_RCV"]["dc_1q3p"].push(pack->inv_r_rcv(i).dc_1q3p());
		(*net_signals)["INV_R_RCV"]["md64"].push(pack->inv_r_rcv(i).md64());
		(*net_signals)["INV_R_RCV"]["md82"].push(pack->inv_r_rcv(i).md82());
		(*net_signals)["INV_R_RCV"]["reducelosses"].push(pack->inv_r_rcv(i).reducelosses());
		(*net_signals)["INV_R_RCV"]["hndwhl64"].push(pack->inv_r_rcv(i).hndwhl64());
		(*net_signals)["INV_R_RCV"]["warn_ballast"].push(pack->inv_r_rcv(i).warn_ballast());
		(*net_signals)["INV_R_RCV"]["hndwhl82"].push(pack->inv_r_rcv(i).hndwhl82());
...
void inverters_proto_interface_serialize_from_id(canlib_message_id id, inverters::Pack* pack, inverters_devices* map) {
    ...
    switch(id) {
        ...
        case 513: {
			...
			proto_msg->set_eprom131((inverters::inverters_inv_l_send_eprom131)msg->eprom131);
			proto_msg->set_eprom132((inverters::inverters_inv_l_send_eprom132)msg->eprom132);
			...
			proto_msg->set_cs_ain_1_mode((inverters::inverters_inv_l_send_cs_ain_1_mode)msg->cs_ain_1_mode);
			proto_msg->set_km_tx_tog_stat(msg->km_tx_tog_stat);
			proto_msg->set_i_ist_inverse(msg->i_ist_inverse);
			proto_msg->set_compare_var194((inverters::inverters_inv_l_send_compare_var194)msg->compare_var194);
			proto_msg->set_compare_var195((inverters::inverters_inv_l_send_compare_var195)msg->compare_var195);
			proto_msg->set_compare_var218((inverters::inverters_inv_l_send_compare_var218)msg->compare_var218);
			proto_msg->set_compare_var219((inverters::inverters_inv_l_send_compare_var219)msg->compare_var219);
			...
			proto_msg->set_cs_ain_2_mode((inverters::inverters_inv_l_send_cs_ain_2_mode)msg->cs_ain_2_mode);
			...
			proto_msg->set_source_id194((inverters::inverters_inv_l_send_source_id194)msg->source_id194);
			proto_msg->set_source_id195((inverters::inverters_inv_l_send_source_id195)msg->source_id195);
			proto_msg->set_source_id218((inverters::inverters_inv_l_send_source_id218)msg->source_id218);
			proto_msg->set_source_id219((inverters::inverters_inv_l_send_source_id219)msg->source_id219);
			...
			proto_msg->set_cs_cmd_type((inverters::inverters_inv_l_send_cs_cmd_type)msg->cs_cmd_type);
			proto_msg->set_km_rsvd_12(msg->km_rsvd_12);
			proto_msg->set_motortype((inverters::inverters_inv_l_send_motortype)msg->motortype);
			...
			proto_msg->set_pwm_freq((inverters::inverters_inv_l_send_pwm_freq)msg->pwm_freq);
        ...
        case 385: {
			...
			proto_msg->set_cmc__bit20_19__tc_deltatime_conf(msg->cmc__bit20_19__tc_deltatime_conf);
			proto_msg->set_pwm_freq((inverters::inverters_inv_l_rcv_pwm_freq)msg->pwm_freq);
        ...
        case 514: {
			...
			proto_msg->set_pos_offset_slack(msg->pos_offset_slack);
			proto_msg->set_pos_diff_slack(msg->pos_diff_slack);
			proto_msg->set_eprom131((inverters::inverters_inv_r_send_eprom131)msg->eprom131);
			proto_msg->set_eprom132((inverters::inverters_inv_r_send_eprom132)msg->eprom132);
			proto_msg->set_fun_special(msg->fun_special);
			proto_msg->set_can_id_2_rx(msg->can_id_2_rx);
			proto_msg->set_can_id_2_tx(msg->can_id_2_tx);
			proto_msg->set_v_ref(msg->v_ref);
			...
			proto_msg->set_coaststop(msg->coaststop);
			proto_msg->set_cmc__bit3__torqueval_init_ena(msg->cmc__bit3__torqueval_init_ena);
			proto_msg->set_cs_ain_1_mode((inverters::inverters_inv_r_send_cs_ain_1_mode)msg->cs_ain_1_mode);
			proto_msg->set_km_tx_tog_stat(msg->km_tx_tog_stat);
			proto_msg->set_i_ist_inverse(msg->i_ist_inverse);
			proto_msg->set_compare_var194((inverters::inverters_inv_r_send_compare_var194)msg->compare_var194);
			proto_msg->set_compare_var195((inverters::inverters_inv_r_send_compare_var195)msg->compare_var195);
			proto_msg->set_compare_var218((inverters::inverters_inv_r_send_compare_var218)msg->compare_var218);
			proto_msg->set_compare_var219((inverters::inverters_inv_r_send_compare_var219)msg->compare_var219);
			proto_msg->set_cmc__bit4__dig_m_rcpramp_ena(msg->cmc__bit4__dig_m_rcpramp_ena);
			proto_msg->set_km_i_limit(msg->km_i_limit);
			proto_msg->set_refsoft(msg->refsoft);
			...
			proto_msg->set_vdc_ana(msg->vdc_ana);
			proto_msg->set_cmc__bit13_7__free(msg->cmc__bit13_7__free);
			proto_msg->set_cs_ain_2_mode((inverters::inverters_inv_r_send_cs_ain_2_mode)msg->cs_ain_2_mode);
			...
			proto_msg->set_source_id194((inverters::inverters_inv_r_send_source_id194)msg->source_id194);
			proto_msg->set_source_id195((inverters::inverters_inv_r_send_source_id195)msg->source_id195);
			proto_msg->set_source_id218((inverters::inverters_inv_r_send_source_id218)msg->source_id218);
			proto_msg->set_source_id219((inverters::inverters_inv_r_send_source_id219)msg->source_id219);
			proto_msg->set_dup__bit8__can_extended_0(msg->dup__bit8__can_extended_0);
			proto_msg->set_km_handwheel(msg->km_handwheel);
			proto_msg->set_hxinv(msg->hxinv);
			proto_msg->set_dup__bit9__generator(msg->dup__bit9__generator);
			...
			proto_msg->set_mo_sc1_comp(msg->mo_sc1_comp);
			proto_msg->set_dup__bit11__dcbus_volts(msg->dup__bit11__dcbus_volts);
			proto_msg->set_cs_cmd_type((inverters::inverters_inv_r_send_cs_cmd_type)msg->cs_cmd_type);
			proto_msg->set_km_rsvd_12(msg->km_rsvd_12);
			proto_msg->set_motortype((inverters::inverters_inv_r_send_motortype)msg->motortype);
			...
			proto_msg->set_ac_dc(msg->ac_dc);
			proto_msg->set_cmc__bit20_19__tc_deltatime_conf(msg->cmc__bit20_19__tc_deltatime_conf);
			proto_msg->set_pwm_freq((inverters::inverters_inv_r_send_pwm_freq)msg->pwm_freq);
			proto_msg->set_dup__bit20__hal_extmr_acv(msg->dup__bit20__hal_extmr_acv);
			proto_msg->set_cmc__bit22_21__tc_minspeed_conf(msg->cmc__bit22_21__tc_minspeed_conf);
			proto_msg->set_dup__bit21__initwith_frg_off(msg->dup__bit21__initwith_frg_off);
			proto_msg->set_dup__bit31_22__free(msg->dup__bit31_22__free);
        ...
        case 386: {
			...
			proto_msg->set_motor_pole(msg->motor_pole);
			proto_msg->set_ain_in_1_cutoff(msg->ain_in_1_cutoff);
			proto_msg->set_activecontrolmode((inverters::inverters_inv_r_rcv_activecontrolmode)msg->activecontrolmode);
			proto_msg->set_km_rsvd_0(msg->km_rsvd_0);
			proto_msg->set_ena82(msg->ena82);
			proto_msg->set_ain_in_2_cutoff(msg->ain_in_2_cutoff);
			proto_msg->set_i_limit_inuse_ramp(msg->i_limit_inuse_ramp);
			...
			proto_msg->set_ctrlsubmode((inverters::inverters_inv_r_rcv_ctrlsubmode)msg->ctrlsubmode);
			proto_msg->set_km_allow_sync(msg->km_allow_sync);
			proto_msg->set_ni82(msg->ni82);
			proto_msg->set_ain_in_2_filter(msg->ain_in_2_filter);
			proto_msg->set_ecode_bit8__fail_idc99(msg->ecode_bit8__fail_idc99);
			...
			proto_msg->set_currentmode((inverters::inverters_inv_r_rcv_currentmode)msg->currentmode);
			proto_msg->set_km_rsvd_12(msg->km_rsvd_12);
			proto_msg->set_cal82(msg->cal82);
			proto_msg->set_ecode_bit12__15m_plus99(msg->ecode_bit12__15m_plus99);
			proto_msg->set_ecode_bit12__15m_plus148(msg->ecode_bit12__15m_plus148);
			...
			proto_msg->set_nclip_plus82(msg->nclip_plus82);
			proto_msg->set_cmc__bit20_19__tc_deltatime_conf(msg->cmc__bit20_19__tc_deltatime_conf);
			proto_msg->set_pwm_freq((inverters::inverters_inv_r_rcv_pwm_freq)msg->pwm_freq);
			proto_msg->set_irddig64(msg->irddig64);
			proto_msg->set_irddig82(msg->irddig82);
			proto_msg->set_dup__bit20__hal_extmr_acv(msg->dup__bit20__hal_extmr_acv);
			proto_msg->set_iuserchd64(msg->iuserchd64);
