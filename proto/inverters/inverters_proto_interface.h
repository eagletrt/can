...
void inverters_proto_interface_deserialize(inverters::Pack* pack, network_enums* net_enums, network_signals* net_signals, network_strings* net_strings, uint64_t resample_us) {
    ...
    for(int i = 0; i < pack->inv_r_send_size(); i++){
		...
		(*net_enums)["INV_R_SEND"]["dc_bus_comp"].push(pack->inv_r_send(i).dc_bus_comp());
		...
		(*net_enums)["INV_R_SEND"]["ballast_ext"].push(pack->inv_r_send(i).ballast_ext());
		...
		(*net_enums)["INV_R_SEND"]["fb_special"].push(pack->inv_r_send(i).fb_special());
		...
		(*net_enums)["INV_R_SEND"]["coaststop"].push(pack->inv_r_send(i).coaststop());
		...
		(*net_enums)["INV_R_SEND"]["i_ist_inverse"].push(pack->inv_r_send(i).i_ist_inverse());
		...
		(*net_enums)["INV_R_SEND"]["refsoft"].push(pack->inv_r_send(i).refsoft());
		...
		(*net_enums)["INV_R_SEND"]["no_uesp_btb"].push(pack->inv_r_send(i).no_uesp_btb());
		(*net_enums)["INV_R_SEND"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_r_send(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_enums)["INV_R_SEND"]["cs_oora1"].push(pack->inv_r_send(i).cs_oora1());
		(*net_enums)["INV_R_SEND"]["km_mix_ana_on"].push(pack->inv_r_send(i).km_mix_ana_on());
		(*net_enums)["INV_R_SEND"]["vdc_ana"].push(pack->inv_r_send(i).vdc_ana());
		...
		(*net_enums)["INV_R_SEND"]["i1_adc_ena"].push(pack->inv_r_send(i).i1_adc_ena());
		...
		(*net_enums)["INV_R_SEND"]["dup__bit8__can_extended_0"].push(pack->inv_r_send(i).dup__bit8__can_extended_0());
		(*net_enums)["INV_R_SEND"]["km_handwheel"].push(pack->inv_r_send(i).km_handwheel());
		(*net_enums)["INV_R_SEND"]["hxinv"].push(pack->inv_r_send(i).hxinv());
		(*net_enums)["INV_R_SEND"]["dup__bit9__generator"].push(pack->inv_r_send(i).dup__bit9__generator());
		(*net_enums)["INV_R_SEND"]["km_phasing_extend"].push(pack->inv_r_send(i).km_phasing_extend());
		(*net_enums)["INV_R_SEND"]["h2inv"].push(pack->inv_r_send(i).h2inv());
		(*net_enums)["INV_R_SEND"]["dup__bit10__park_rms"].push(pack->inv_r_send(i).dup__bit10__park_rms());
		(*net_enums)["INV_R_SEND"]["cs_oora2"].push(pack->inv_r_send(i).cs_oora2());
		(*net_enums)["INV_R_SEND"]["km_rsvd_11"].push(pack->inv_r_send(i).km_rsvd_11());
		(*net_enums)["INV_R_SEND"]["ol_comp"].push(pack->inv_r_send(i).ol_comp());
		(*net_enums)["INV_R_SEND"]["mo_sc1_comp"].push(pack->inv_r_send(i).mo_sc1_comp());
		(*net_enums)["INV_R_SEND"]["dup__bit11__dcbus_volts"].push(pack->inv_r_send(i).dup__bit11__dcbus_volts());
		...
		(*net_enums)["INV_R_SEND"]["dup__bit12__boat_pedal"].push(pack->inv_r_send(i).dup__bit12__boat_pedal());
		(*net_enums)["INV_R_SEND"]["km_rsvd_13"].push(pack->inv_r_send(i).km_rsvd_13());
		(*net_enums)["INV_R_SEND"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_r_send(i).dup__bit13__gen_autoiaclimit());
		(*net_enums)["INV_R_SEND"]["cs_ain_2__i_limit"].push(pack->inv_r_send(i).cs_ain_2__i_limit());
		(*net_enums)["INV_R_SEND"]["km_pseudo_enable"].push(pack->inv_r_send(i).km_pseudo_enable());
		(*net_enums)["INV_R_SEND"]["ana_0up"].push(pack->inv_r_send(i).ana_0up());
		(*net_enums)["INV_R_SEND"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_r_send(i).cmc__bit14__idc_limit_ena_v2());
		(*net_enums)["INV_R_SEND"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_r_send(i).dup__bit14__mtpa_reluct_enab());
		(*net_enums)["INV_R_SEND"]["cs_ain_1__n_limit"].push(pack->inv_r_send(i).cs_ain_1__n_limit());
		(*net_enums)["INV_R_SEND"]["km_debug_test"].push(pack->inv_r_send(i).km_debug_test());
		(*net_enums)["INV_R_SEND"]["lowbd"].push(pack->inv_r_send(i).lowbd());
		...
		(*net_enums)["INV_R_SEND"]["dup__bit15__canopen_acv"].push(pack->inv_r_send(i).dup__bit15__canopen_acv());
		...
		(*net_enums)["INV_R_SEND"]["sramp"].push(pack->inv_r_send(i).sramp());
		...
		(*net_enums)["INV_R_SEND"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_r_send(i).dup__bit16__bamobil3_2_offcrct());
		(*net_signals)["INV_R_SEND"]["m_r_dec"].push(pack->inv_r_send(i).m_r_dec());
		(*net_enums)["INV_R_SEND"]["ramp4"].push(pack->inv_r_send(i).ramp4());
		(*net_signals)["INV_R_SEND"]["dup__bit19_17__ecode_redefine"].push(pack->inv_r_send(i).dup__bit19_17__ecode_redefine());
		(*net_enums)["INV_R_SEND"]["motbrake"].push(pack->inv_r_send(i).motbrake());
		(*net_enums)["INV_R_SEND"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_r_send(i).cmc__bit18__tractioncontrol_ena());
		(*net_enums)["INV_R_SEND"]["ac_dc"].push(pack->inv_r_send(i).ac_dc());
		...
		(*net_enums)["INV_R_SEND"]["dup__bit20__hal_extmr_acv"].push(pack->inv_r_send(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_R_SEND"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_r_send(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_enums)["INV_R_SEND"]["dup__bit21__initwith_frg_off"].push(pack->inv_r_send(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_R_SEND"]["dup__bit31_22__free"].push(pack->inv_r_send(i).dup__bit31_22__free());
		(*net_enums)["INV_R_SEND"]["ntc"].push(pack->inv_r_send(i).ntc());
		(*net_enums)["INV_R_SEND"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_r_send(i).cmc__bit23__tc_ncmdrestoption());
		(*net_enums)["INV_R_SEND"]["delta"].push(pack->inv_r_send(i).delta());
		(*net_signals)["INV_R_SEND"]["cmc__bit31_24__free"].push(pack->inv_r_send(i).cmc__bit31_24__free());
		(*net_enums)["INV_R_SEND"]["dc_1qdirvolt"].push(pack->inv_r_send(i).dc_1qdirvolt());
		(*net_enums)["INV_R_SEND"]["dc_field"].push(pack->inv_r_send(i).dc_field());
		(*net_enums)["INV_R_SEND"]["dead_2"].push(pack->inv_r_send(i).dead_2());
		(*net_enums)["INV_R_SEND"]["block"].push(pack->inv_r_send(i).block());
		(*net_enums)["INV_R_SEND"]["dc_1qmv"].push(pack->inv_r_send(i).dc_1qmv());
		(*net_enums)["INV_R_SEND"]["dc_1q3p"].push(pack->inv_r_send(i).dc_1q3p());
		(*net_enums)["INV_R_SEND"]["reducelosses"].push(pack->inv_r_send(i).reducelosses());
    ...
    for(int i = 0; i < pack->inv_r_rcv_size(); i++){
		...
		(*net_enums)["INV_R_RCV"]["dc_bus_comp"].push(pack->inv_r_rcv(i).dc_bus_comp());
		...
		(*net_enums)["INV_R_RCV"]["ballast_ext"].push(pack->inv_r_rcv(i).ballast_ext());
		...
		(*net_enums)["INV_R_RCV"]["fb_special"].push(pack->inv_r_rcv(i).fb_special());
		...
		(*net_enums)["INV_R_RCV"]["coaststop"].push(pack->inv_r_rcv(i).coaststop());
		...
		(*net_enums)["INV_R_RCV"]["i_ist_inverse"].push(pack->inv_r_rcv(i).i_ist_inverse());
		...
		(*net_enums)["INV_R_RCV"]["refsoft"].push(pack->inv_r_rcv(i).refsoft());
		...
		(*net_enums)["INV_R_RCV"]["no_uesp_btb"].push(pack->inv_r_rcv(i).no_uesp_btb());
		...
		(*net_enums)["INV_R_RCV"]["vdc_ana"].push(pack->inv_r_rcv(i).vdc_ana());
		...
		(*net_enums)["INV_R_RCV"]["i1_adc_ena"].push(pack->inv_r_rcv(i).i1_adc_ena());
		...
		(*net_enums)["INV_R_RCV"]["hxinv"].push(pack->inv_r_rcv(i).hxinv());
		...
		(*net_enums)["INV_R_RCV"]["h2inv"].push(pack->inv_r_rcv(i).h2inv());
		...
		(*net_enums)["INV_R_RCV"]["ol_comp"].push(pack->inv_r_rcv(i).ol_comp());
		...
		(*net_enums)["INV_R_RCV"]["ana_0up"].push(pack->inv_r_rcv(i).ana_0up());
		...
		(*net_enums)["INV_R_RCV"]["lowbd"].push(pack->inv_r_rcv(i).lowbd());
		...
		(*net_enums)["INV_R_RCV"]["sramp"].push(pack->inv_r_rcv(i).sramp());
		...
		(*net_enums)["INV_R_RCV"]["ramp4"].push(pack->inv_r_rcv(i).ramp4());
		...
		(*net_enums)["INV_R_RCV"]["motbrake"].push(pack->inv_r_rcv(i).motbrake());
		...
		(*net_enums)["INV_R_RCV"]["ac_dc"].push(pack->inv_r_rcv(i).ac_dc());
		...
		(*net_enums)["INV_R_RCV"]["ntc"].push(pack->inv_r_rcv(i).ntc());
		...
		(*net_enums)["INV_R_RCV"]["delta"].push(pack->inv_r_rcv(i).delta());
		...
		(*net_enums)["INV_R_RCV"]["dc_1qdirvolt"].push(pack->inv_r_rcv(i).dc_1qdirvolt());
		(*net_enums)["INV_R_RCV"]["warn_ipeak"].push(pack->inv_r_rcv(i).warn_ipeak());
		(*net_enums)["INV_R_RCV"]["_10hz82"].push(pack->inv_r_rcv(i)._10hz82());
		(*net_enums)["INV_R_RCV"]["dc_field"].push(pack->inv_r_rcv(i).dc_field());
		...
		(*net_enums)["INV_R_RCV"]["dead_2"].push(pack->inv_r_rcv(i).dead_2());
		(*net_enums)["INV_R_RCV"]["irdana82"].push(pack->inv_r_rcv(i).irdana82());
		(*net_enums)["INV_R_RCV"]["block"].push(pack->inv_r_rcv(i).block());
		(*net_enums)["INV_R_RCV"]["iwcns82"].push(pack->inv_r_rcv(i).iwcns82());
		(*net_enums)["INV_R_RCV"]["dc_1qmv"].push(pack->inv_r_rcv(i).dc_1qmv());
		(*net_enums)["INV_R_RCV"]["rfepulse82"].push(pack->inv_r_rcv(i).rfepulse82());
		(*net_enums)["INV_R_RCV"]["dc_1q3p"].push(pack->inv_r_rcv(i).dc_1q3p());
		(*net_enums)["INV_R_RCV"]["md82"].push(pack->inv_r_rcv(i).md82());
		(*net_enums)["INV_R_RCV"]["reducelosses"].push(pack->inv_r_rcv(i).reducelosses());
    ...
    for(int i = 0; i < pack->inv_l_send_size(); i++){
		...
		(*net_enums)["INV_L_SEND"]["dc_bus_comp"].push(pack->inv_l_send(i).dc_bus_comp());
		...
		(*net_enums)["INV_L_SEND"]["ballast_ext"].push(pack->inv_l_send(i).ballast_ext());
		...
		(*net_enums)["INV_L_SEND"]["fb_special"].push(pack->inv_l_send(i).fb_special());
		...
		(*net_enums)["INV_L_SEND"]["coaststop"].push(pack->inv_l_send(i).coaststop());
		...
		(*net_enums)["INV_L_SEND"]["i_ist_inverse"].push(pack->inv_l_send(i).i_ist_inverse());
		...
		(*net_enums)["INV_L_SEND"]["refsoft"].push(pack->inv_l_send(i).refsoft());
		...
		(*net_enums)["INV_L_SEND"]["no_uesp_btb"].push(pack->inv_l_send(i).no_uesp_btb());
		(*net_enums)["INV_L_SEND"]["cmc__bit6__torquetimeout_100ms_e"].push(pack->inv_l_send(i).cmc__bit6__torquetimeout_100ms_e());
		(*net_enums)["INV_L_SEND"]["cs_oora1"].push(pack->inv_l_send(i).cs_oora1());
		(*net_enums)["INV_L_SEND"]["km_mix_ana_on"].push(pack->inv_l_send(i).km_mix_ana_on());
		(*net_enums)["INV_L_SEND"]["vdc_ana"].push(pack->inv_l_send(i).vdc_ana());
		...
		(*net_enums)["INV_L_SEND"]["i1_adc_ena"].push(pack->inv_l_send(i).i1_adc_ena());
		...
		(*net_enums)["INV_L_SEND"]["dup__bit8__can_extended_0"].push(pack->inv_l_send(i).dup__bit8__can_extended_0());
		(*net_enums)["INV_L_SEND"]["km_handwheel"].push(pack->inv_l_send(i).km_handwheel());
		(*net_enums)["INV_L_SEND"]["hxinv"].push(pack->inv_l_send(i).hxinv());
		(*net_enums)["INV_L_SEND"]["dup__bit9__generator"].push(pack->inv_l_send(i).dup__bit9__generator());
		(*net_enums)["INV_L_SEND"]["km_phasing_extend"].push(pack->inv_l_send(i).km_phasing_extend());
		(*net_enums)["INV_L_SEND"]["h2inv"].push(pack->inv_l_send(i).h2inv());
		(*net_enums)["INV_L_SEND"]["dup__bit10__park_rms"].push(pack->inv_l_send(i).dup__bit10__park_rms());
		(*net_enums)["INV_L_SEND"]["cs_oora2"].push(pack->inv_l_send(i).cs_oora2());
		(*net_enums)["INV_L_SEND"]["km_rsvd_11"].push(pack->inv_l_send(i).km_rsvd_11());
		(*net_enums)["INV_L_SEND"]["ol_comp"].push(pack->inv_l_send(i).ol_comp());
		(*net_enums)["INV_L_SEND"]["mo_sc1_comp"].push(pack->inv_l_send(i).mo_sc1_comp());
		(*net_enums)["INV_L_SEND"]["dup__bit11__dcbus_volts"].push(pack->inv_l_send(i).dup__bit11__dcbus_volts());
		...
		(*net_enums)["INV_L_SEND"]["dup__bit12__boat_pedal"].push(pack->inv_l_send(i).dup__bit12__boat_pedal());
		(*net_enums)["INV_L_SEND"]["km_rsvd_13"].push(pack->inv_l_send(i).km_rsvd_13());
		(*net_enums)["INV_L_SEND"]["dup__bit13__gen_autoiaclimit"].push(pack->inv_l_send(i).dup__bit13__gen_autoiaclimit());
		(*net_enums)["INV_L_SEND"]["cs_ain_2__i_limit"].push(pack->inv_l_send(i).cs_ain_2__i_limit());
		(*net_enums)["INV_L_SEND"]["km_pseudo_enable"].push(pack->inv_l_send(i).km_pseudo_enable());
		(*net_enums)["INV_L_SEND"]["ana_0up"].push(pack->inv_l_send(i).ana_0up());
		(*net_enums)["INV_L_SEND"]["cmc__bit14__idc_limit_ena_v2"].push(pack->inv_l_send(i).cmc__bit14__idc_limit_ena_v2());
		(*net_enums)["INV_L_SEND"]["dup__bit14__mtpa_reluct_enab"].push(pack->inv_l_send(i).dup__bit14__mtpa_reluct_enab());
		(*net_enums)["INV_L_SEND"]["cs_ain_1__n_limit"].push(pack->inv_l_send(i).cs_ain_1__n_limit());
		(*net_enums)["INV_L_SEND"]["km_debug_test"].push(pack->inv_l_send(i).km_debug_test());
		(*net_enums)["INV_L_SEND"]["lowbd"].push(pack->inv_l_send(i).lowbd());
		...
		(*net_enums)["INV_L_SEND"]["dup__bit15__canopen_acv"].push(pack->inv_l_send(i).dup__bit15__canopen_acv());
		...
		(*net_enums)["INV_L_SEND"]["sramp"].push(pack->inv_l_send(i).sramp());
		...
		(*net_enums)["INV_L_SEND"]["dup__bit16__bamobil3_2_offcrct"].push(pack->inv_l_send(i).dup__bit16__bamobil3_2_offcrct());
		(*net_signals)["INV_L_SEND"]["m_r_dec"].push(pack->inv_l_send(i).m_r_dec());
		(*net_enums)["INV_L_SEND"]["ramp4"].push(pack->inv_l_send(i).ramp4());
		(*net_signals)["INV_L_SEND"]["dup__bit19_17__ecode_redefine"].push(pack->inv_l_send(i).dup__bit19_17__ecode_redefine());
		(*net_enums)["INV_L_SEND"]["motbrake"].push(pack->inv_l_send(i).motbrake());
		(*net_enums)["INV_L_SEND"]["cmc__bit18__tractioncontrol_ena"].push(pack->inv_l_send(i).cmc__bit18__tractioncontrol_ena());
		(*net_enums)["INV_L_SEND"]["ac_dc"].push(pack->inv_l_send(i).ac_dc());
		...
		(*net_enums)["INV_L_SEND"]["dup__bit20__hal_extmr_acv"].push(pack->inv_l_send(i).dup__bit20__hal_extmr_acv());
		(*net_signals)["INV_L_SEND"]["cmc__bit22_21__tc_minspeed_conf"].push(pack->inv_l_send(i).cmc__bit22_21__tc_minspeed_conf());
		(*net_enums)["INV_L_SEND"]["dup__bit21__initwith_frg_off"].push(pack->inv_l_send(i).dup__bit21__initwith_frg_off());
		(*net_signals)["INV_L_SEND"]["dup__bit31_22__free"].push(pack->inv_l_send(i).dup__bit31_22__free());
		(*net_enums)["INV_L_SEND"]["ntc"].push(pack->inv_l_send(i).ntc());
		(*net_enums)["INV_L_SEND"]["cmc__bit23__tc_ncmdrestoption"].push(pack->inv_l_send(i).cmc__bit23__tc_ncmdrestoption());
		(*net_enums)["INV_L_SEND"]["delta"].push(pack->inv_l_send(i).delta());
		(*net_signals)["INV_L_SEND"]["cmc__bit31_24__free"].push(pack->inv_l_send(i).cmc__bit31_24__free());
		(*net_enums)["INV_L_SEND"]["dc_1qdirvolt"].push(pack->inv_l_send(i).dc_1qdirvolt());
		(*net_enums)["INV_L_SEND"]["dc_field"].push(pack->inv_l_send(i).dc_field());
		(*net_enums)["INV_L_SEND"]["dead_2"].push(pack->inv_l_send(i).dead_2());
		(*net_enums)["INV_L_SEND"]["block"].push(pack->inv_l_send(i).block());
		(*net_enums)["INV_L_SEND"]["dc_1qmv"].push(pack->inv_l_send(i).dc_1qmv());
		(*net_enums)["INV_L_SEND"]["dc_1q3p"].push(pack->inv_l_send(i).dc_1q3p());
		(*net_enums)["INV_L_SEND"]["reducelosses"].push(pack->inv_l_send(i).reducelosses());
    ...
    for(int i = 0; i < pack->inv_l_rcv_size(); i++){
		...
		(*net_enums)["INV_L_RCV"]["dc_bus_comp"].push(pack->inv_l_rcv(i).dc_bus_comp());
		...
		(*net_enums)["INV_L_RCV"]["ballast_ext"].push(pack->inv_l_rcv(i).ballast_ext());
		...
		(*net_enums)["INV_L_RCV"]["fb_special"].push(pack->inv_l_rcv(i).fb_special());
		...
		(*net_enums)["INV_L_RCV"]["coaststop"].push(pack->inv_l_rcv(i).coaststop());
		...
		(*net_enums)["INV_L_RCV"]["i_ist_inverse"].push(pack->inv_l_rcv(i).i_ist_inverse());
		...
		(*net_enums)["INV_L_RCV"]["refsoft"].push(pack->inv_l_rcv(i).refsoft());
		...
		(*net_enums)["INV_L_RCV"]["no_uesp_btb"].push(pack->inv_l_rcv(i).no_uesp_btb());
		...
		(*net_enums)["INV_L_RCV"]["vdc_ana"].push(pack->inv_l_rcv(i).vdc_ana());
		...
		(*net_enums)["INV_L_RCV"]["i1_adc_ena"].push(pack->inv_l_rcv(i).i1_adc_ena());
		...
		(*net_enums)["INV_L_RCV"]["hxinv"].push(pack->inv_l_rcv(i).hxinv());
		...
		(*net_enums)["INV_L_RCV"]["h2inv"].push(pack->inv_l_rcv(i).h2inv());
		...
		(*net_enums)["INV_L_RCV"]["ol_comp"].push(pack->inv_l_rcv(i).ol_comp());
		...
		(*net_enums)["INV_L_RCV"]["ana_0up"].push(pack->inv_l_rcv(i).ana_0up());
		...
		(*net_enums)["INV_L_RCV"]["lowbd"].push(pack->inv_l_rcv(i).lowbd());
		...
		(*net_enums)["INV_L_RCV"]["sramp"].push(pack->inv_l_rcv(i).sramp());
		...
		(*net_enums)["INV_L_RCV"]["ramp4"].push(pack->inv_l_rcv(i).ramp4());
		...
		(*net_enums)["INV_L_RCV"]["motbrake"].push(pack->inv_l_rcv(i).motbrake());
		...
		(*net_enums)["INV_L_RCV"]["ac_dc"].push(pack->inv_l_rcv(i).ac_dc());
		...
		(*net_enums)["INV_L_RCV"]["ntc"].push(pack->inv_l_rcv(i).ntc());
		...
		(*net_enums)["INV_L_RCV"]["delta"].push(pack->inv_l_rcv(i).delta());
		...
		(*net_enums)["INV_L_RCV"]["dc_1qdirvolt"].push(pack->inv_l_rcv(i).dc_1qdirvolt());
		(*net_enums)["INV_L_RCV"]["warn_ipeak"].push(pack->inv_l_rcv(i).warn_ipeak());
		(*net_enums)["INV_L_RCV"]["_10hz82"].push(pack->inv_l_rcv(i)._10hz82());
		(*net_enums)["INV_L_RCV"]["dc_field"].push(pack->inv_l_rcv(i).dc_field());
		...
		(*net_enums)["INV_L_RCV"]["dead_2"].push(pack->inv_l_rcv(i).dead_2());
		(*net_enums)["INV_L_RCV"]["irdana82"].push(pack->inv_l_rcv(i).irdana82());
		(*net_enums)["INV_L_RCV"]["block"].push(pack->inv_l_rcv(i).block());
		(*net_enums)["INV_L_RCV"]["iwcns82"].push(pack->inv_l_rcv(i).iwcns82());
		(*net_enums)["INV_L_RCV"]["dc_1qmv"].push(pack->inv_l_rcv(i).dc_1qmv());
		(*net_enums)["INV_L_RCV"]["rfepulse82"].push(pack->inv_l_rcv(i).rfepulse82());
		(*net_enums)["INV_L_RCV"]["dc_1q3p"].push(pack->inv_l_rcv(i).dc_1q3p());
		(*net_enums)["INV_L_RCV"]["md82"].push(pack->inv_l_rcv(i).md82());
		(*net_enums)["INV_L_RCV"]["reducelosses"].push(pack->inv_l_rcv(i).reducelosses());
