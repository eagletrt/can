...
#ifndef ivts_PROTO_INTERFACE_H
#define ivts_PROTO_INTERFACE_H
...
#ifdef ivts_IMPLEMENTATION
#undef ivts_IMPLEMENTATION
#define __ivts_IMPLEMENTATION
#endif

#include "../../lib/ivts/ivts_network.h"

#ifdef __ivts_IMPLEMENTATION
#undef __ivts_IMPLEMENTATION
#define ivts_IMPLEMENTATION
#endif
...
void ivts_proto_interface_serialize_from_id(canlib_message_id id, ivts::Pack* pack, device_t* device);
void ivts_proto_interface_deserialize(ivts::Pack* pack, network_enums* net_enums, network_signals* net_signals, network_strings* net_strings, uint64_t resample_us);

#ifdef ivts_PROTO_INTERAFCE_IMPLEMENTATION
...
void ivts_proto_interface_deserialize(ivts::Pack* pack, network_enums* net_enums, network_signals* net_signals, network_strings* net_strings, uint64_t resample_us) {
    ...
    for(int i = 0; i < pack->ivt_msg_result_wh_size(); i++){
		...
		ivts_ivt_msg_result_wh_ivt_id_result_wh_enum_to_string((ivts_ivt_msg_result_wh_ivt_id_result_wh)pack->ivt_msg_result_wh(i).ivt_id_result_wh(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_as_size(); i++){
		...
		ivts_ivt_msg_result_as_ivt_id_result_as_enum_to_string((ivts_ivt_msg_result_as_ivt_id_result_as)pack->ivt_msg_result_as(i).ivt_id_result_as(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_w_size(); i++){
		...
		ivts_ivt_msg_result_w_ivt_id_result_w_enum_to_string((ivts_ivt_msg_result_w_ivt_id_result_w)pack->ivt_msg_result_w(i).ivt_id_result_w(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_response_size(); i++){
		...
		ivts_ivt_msg_response_ivt_id_response_enum_to_string((ivts_ivt_msg_response_ivt_id_response)pack->ivt_msg_response(i).ivt_id_response(), buffer);
		...
		ivts_ivt_msg_response__80_resp_measerror_item_enum_to_string((ivts_ivt_msg_response__80_resp_measerror_item)pack->ivt_msg_response(i)._80_resp_measerror_item(), buffer);
		...
		ivts_ivt_msg_response__81_resp_systemerror_item_enum_to_string((ivts_ivt_msg_response__81_resp_systemerror_item)pack->ivt_msg_response(i)._81_resp_systemerror_item(), buffer);
		...
		ivts_ivt_msg_response__82_resp_alllogdata_item_enum_to_string((ivts_ivt_msg_response__82_resp_alllogdata_item)pack->ivt_msg_response(i)._82_resp_alllogdata_item(), buffer);
		...
		ivts_ivt_msg_response__83_resp_logdata_item_enum_to_string((ivts_ivt_msg_response__83_resp_logdata_item)pack->ivt_msg_response(i)._83_resp_logdata_item(), buffer);
		...
		ivts_ivt_msg_response__b0_resp_reset_item_enum_to_string((ivts_ivt_msg_response__b0_resp_reset_item)pack->ivt_msg_response(i)._b0_resp_reset_item(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_type_enum_to_string((ivts_ivt_msg_response__b9_resp_device_type)pack->ivt_msg_response(i)._b9_resp_device_type(), buffer);
		...
		ivts_ivt_msg_response__a0_resp_triggermode_i_enum_to_string((ivts_ivt_msg_response__a0_resp_triggermode_i)pack->ivt_msg_response(i)._a0_resp_triggermode_i(), buffer);
		...
		ivts_ivt_msg_response__a1_resp_triggermode_u1_enum_to_string((ivts_ivt_msg_response__a1_resp_triggermode_u1)pack->ivt_msg_response(i)._a1_resp_triggermode_u1(), buffer);
		...
		ivts_ivt_msg_response__a2_resp_triggermode_u2_enum_to_string((ivts_ivt_msg_response__a2_resp_triggermode_u2)pack->ivt_msg_response(i)._a2_resp_triggermode_u2(), buffer);
		...
		ivts_ivt_msg_response__a3_resp_triggermode_u3_enum_to_string((ivts_ivt_msg_response__a3_resp_triggermode_u3)pack->ivt_msg_response(i)._a3_resp_triggermode_u3(), buffer);
		...
		ivts_ivt_msg_response__a4_resp_triggermode_t_enum_to_string((ivts_ivt_msg_response__a4_resp_triggermode_t)pack->ivt_msg_response(i)._a4_resp_triggermode_t(), buffer);
		...
		ivts_ivt_msg_response__a5_resp_triggermode_w_enum_to_string((ivts_ivt_msg_response__a5_resp_triggermode_w)pack->ivt_msg_response(i)._a5_resp_triggermode_w(), buffer);
		...
		ivts_ivt_msg_response__a6_resp_triggermode_as_enum_to_string((ivts_ivt_msg_response__a6_resp_triggermode_as)pack->ivt_msg_response(i)._a6_resp_triggermode_as(), buffer);
		...
		ivts_ivt_msg_response__a7_resp_triggermode_wh_enum_to_string((ivts_ivt_msg_response__a7_resp_triggermode_wh)pack->ivt_msg_response(i)._a7_resp_triggermode_wh(), buffer);
		...
		ivts_ivt_msg_response__b4_resp_actual_mode_enum_to_string((ivts_ivt_msg_response__b4_resp_actual_mode)pack->ivt_msg_response(i)._b4_resp_actual_mode(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_current_enum_to_string((ivts_ivt_msg_response__b9_resp_device_current)pack->ivt_msg_response(i)._b9_resp_device_current(), buffer);
		...
		ivts_ivt_msg_response__b4_resp_startup_mode_enum_to_string((ivts_ivt_msg_response__b4_resp_startup_mode)pack->ivt_msg_response(i)._b4_resp_startup_mode(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_voltage_chan_enum_to_string((ivts_ivt_msg_response__b9_resp_device_voltage_chan)pack->ivt_msg_response(i)._b9_resp_device_voltage_chan(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_toi_enum_to_string((ivts_ivt_msg_response__b9_resp_device_toi)pack->ivt_msg_response(i)._b9_resp_device_toi(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_com_enum_to_string((ivts_ivt_msg_response__b9_resp_device_com)pack->ivt_msg_response(i)._b9_resp_device_com(), buffer);
		...
		ivts_ivt_msg_response__b9_resp_device_v_supply_enum_to_string((ivts_ivt_msg_response__b9_resp_device_v_supply)pack->ivt_msg_response(i)._b9_resp_device_v_supply(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_t_size(); i++){
		...
		ivts_ivt_msg_result_t_ivt_id_result_t_enum_to_string((ivts_ivt_msg_result_t_ivt_id_result_t)pack->ivt_msg_result_t(i).ivt_id_result_t(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_u3_size(); i++){
		...
		ivts_ivt_msg_result_u3_ivt_id_result_u3_enum_to_string((ivts_ivt_msg_result_u3_ivt_id_result_u3)pack->ivt_msg_result_u3(i).ivt_id_result_u3(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_u2_size(); i++){
		...
		ivts_ivt_msg_result_u2_ivt_id_result_u2_enum_to_string((ivts_ivt_msg_result_u2_ivt_id_result_u2)pack->ivt_msg_result_u2(i).ivt_id_result_u2(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_u1_size(); i++){
		...
		ivts_ivt_msg_result_u1_ivt_id_result_u1_enum_to_string((ivts_ivt_msg_result_u1_ivt_id_result_u1)pack->ivt_msg_result_u1(i).ivt_id_result_u1(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_result_i_size(); i++){
		...
		ivts_ivt_msg_result_i_ivt_id_result_i_enum_to_string((ivts_ivt_msg_result_i_ivt_id_result_i)pack->ivt_msg_result_i(i).ivt_id_result_i(), buffer);
    ...
    for(int i = 0; i < pack->ivt_msg_cmd_size(); i++){
		...
		ivts_ivt_msg_cmd_ivt_id_cmd_enum_to_string((ivts_ivt_msg_cmd_ivt_id_cmd)pack->ivt_msg_cmd(i).ivt_id_cmd(), buffer);
		...
		ivts_ivt_msg_cmd__30_reset_item_enum_to_string((ivts_ivt_msg_cmd__30_reset_item)pack->ivt_msg_cmd(i)._30_reset_item(), buffer);
		...
		ivts_ivt_msg_cmd__3a_restart_to_bitrate_enum_to_string((ivts_ivt_msg_cmd__3a_restart_to_bitrate)pack->ivt_msg_cmd(i)._3a_restart_to_bitrate(), buffer);
		...
		ivts_ivt_msg_cmd__40_get_measerror_item_enum_to_string((ivts_ivt_msg_cmd__40_get_measerror_item)pack->ivt_msg_cmd(i)._40_get_measerror_item(), buffer);
		...
		ivts_ivt_msg_cmd__41_get_systemerror_item_enum_to_string((ivts_ivt_msg_cmd__41_get_systemerror_item)pack->ivt_msg_cmd(i)._41_get_systemerror_item(), buffer);
		...
		ivts_ivt_msg_cmd__42_get_alllogdata_item_enum_to_string((ivts_ivt_msg_cmd__42_get_alllogdata_item)pack->ivt_msg_cmd(i)._42_get_alllogdata_item(), buffer);
		...
		ivts_ivt_msg_cmd__43_get_logdata_item_enum_to_string((ivts_ivt_msg_cmd__43_get_logdata_item)pack->ivt_msg_cmd(i)._43_get_logdata_item(), buffer);
		...
		ivts_ivt_msg_cmd__20_conf_triggermode_i_enum_to_string((ivts_ivt_msg_cmd__20_conf_triggermode_i)pack->ivt_msg_cmd(i)._20_conf_triggermode_i(), buffer);
		...
		ivts_ivt_msg_cmd__21_conf_triggermode_u1_enum_to_string((ivts_ivt_msg_cmd__21_conf_triggermode_u1)pack->ivt_msg_cmd(i)._21_conf_triggermode_u1(), buffer);
		...
		ivts_ivt_msg_cmd__22_conf_triggermode_u2_enum_to_string((ivts_ivt_msg_cmd__22_conf_triggermode_u2)pack->ivt_msg_cmd(i)._22_conf_triggermode_u2(), buffer);
		...
		ivts_ivt_msg_cmd__23_conf_triggermode_u3_enum_to_string((ivts_ivt_msg_cmd__23_conf_triggermode_u3)pack->ivt_msg_cmd(i)._23_conf_triggermode_u3(), buffer);
		...
		ivts_ivt_msg_cmd__24_conf_triggermode_t_enum_to_string((ivts_ivt_msg_cmd__24_conf_triggermode_t)pack->ivt_msg_cmd(i)._24_conf_triggermode_t(), buffer);
		...
		ivts_ivt_msg_cmd__25_conf_triggermode_w_enum_to_string((ivts_ivt_msg_cmd__25_conf_triggermode_w)pack->ivt_msg_cmd(i)._25_conf_triggermode_w(), buffer);
		...
		ivts_ivt_msg_cmd__26_conf_triggermode_as_enum_to_string((ivts_ivt_msg_cmd__26_conf_triggermode_as)pack->ivt_msg_cmd(i)._26_conf_triggermode_as(), buffer);
		...
		ivts_ivt_msg_cmd__27_conf_triggermode_wh_enum_to_string((ivts_ivt_msg_cmd__27_conf_triggermode_wh)pack->ivt_msg_cmd(i)._27_conf_triggermode_wh(), buffer);
		...
		ivts_ivt_msg_cmd__34_actual_mode_enum_to_string((ivts_ivt_msg_cmd__34_actual_mode)pack->ivt_msg_cmd(i)._34_actual_mode(), buffer);
		...
		ivts_ivt_msg_cmd__34_startup_mode_enum_to_string((ivts_ivt_msg_cmd__34_startup_mode)pack->ivt_msg_cmd(i)._34_startup_mode(), buffer);
...
void ivts_proto_interface_serialize_from_id(canlib_message_id id, ivts::Pack* pack, device_t* device) {
    int index = ivts_index_from_id(id);
    ...
    switch(id) {
        ...
        case 1320: {
            ivts_ivt_msg_result_wh_t* msg = (ivts_ivt_msg_result_wh_t*)(device->message);
            ivts::IVT_MSG_RESULT_WH* proto_msg = pack->add_ivt_msg_result_wh();
			proto_msg->set_ivt_id_result_wh((ivts::ivts_ivt_msg_result_wh_ivt_id_result_wh)msg->ivt_id_result_wh);
        ...
        case 1319: {
            ivts_ivt_msg_result_as_t* msg = (ivts_ivt_msg_result_as_t*)(device->message);
            ivts::IVT_MSG_RESULT_AS* proto_msg = pack->add_ivt_msg_result_as();
			proto_msg->set_ivt_id_result_as((ivts::ivts_ivt_msg_result_as_ivt_id_result_as)msg->ivt_id_result_as);
        ...
        case 1318: {
            ivts_ivt_msg_result_w_t* msg = (ivts_ivt_msg_result_w_t*)(device->message);
            ivts::IVT_MSG_RESULT_W* proto_msg = pack->add_ivt_msg_result_w();
			proto_msg->set_ivt_id_result_w((ivts::ivts_ivt_msg_result_w_ivt_id_result_w)msg->ivt_id_result_w);
        ...
        case 1297: {
            ivts_ivt_msg_response_t* msg = (ivts_ivt_msg_response_t*)(device->message);
            ivts::IVT_MSG_RESPONSE* proto_msg = pack->add_ivt_msg_response();
			proto_msg->set_ivt_id_response((ivts::ivts_ivt_msg_response_ivt_id_response)msg->ivt_id_response);
			...
			proto_msg->set__80_resp_measerror_item((ivts::ivts_ivt_msg_response__80_resp_measerror_item)msg->_80_resp_measerror_item);
			proto_msg->set__81_resp_systemerror_item((ivts::ivts_ivt_msg_response__81_resp_systemerror_item)msg->_81_resp_systemerror_item);
			proto_msg->set__82_resp_alllogdata_item((ivts::ivts_ivt_msg_response__82_resp_alllogdata_item)msg->_82_resp_alllogdata_item);
			proto_msg->set__83_resp_logdata_item((ivts::ivts_ivt_msg_response__83_resp_logdata_item)msg->_83_resp_logdata_item);
			...
			proto_msg->set__b0_resp_reset_item((ivts::ivts_ivt_msg_response__b0_resp_reset_item)msg->_b0_resp_reset_item);
			...
			proto_msg->set__b9_resp_device_type((ivts::ivts_ivt_msg_response__b9_resp_device_type)msg->_b9_resp_device_type);
			...
			proto_msg->set__a0_resp_triggermode_i((ivts::ivts_ivt_msg_response__a0_resp_triggermode_i)msg->_a0_resp_triggermode_i);
			proto_msg->set__a1_resp_triggermode_u1((ivts::ivts_ivt_msg_response__a1_resp_triggermode_u1)msg->_a1_resp_triggermode_u1);
			proto_msg->set__a2_resp_triggermode_u2((ivts::ivts_ivt_msg_response__a2_resp_triggermode_u2)msg->_a2_resp_triggermode_u2);
			proto_msg->set__a3_resp_triggermode_u3((ivts::ivts_ivt_msg_response__a3_resp_triggermode_u3)msg->_a3_resp_triggermode_u3);
			proto_msg->set__a4_resp_triggermode_t((ivts::ivts_ivt_msg_response__a4_resp_triggermode_t)msg->_a4_resp_triggermode_t);
			proto_msg->set__a5_resp_triggermode_w((ivts::ivts_ivt_msg_response__a5_resp_triggermode_w)msg->_a5_resp_triggermode_w);
			proto_msg->set__a6_resp_triggermode_as((ivts::ivts_ivt_msg_response__a6_resp_triggermode_as)msg->_a6_resp_triggermode_as);
			proto_msg->set__a7_resp_triggermode_wh((ivts::ivts_ivt_msg_response__a7_resp_triggermode_wh)msg->_a7_resp_triggermode_wh);
			proto_msg->set__b4_resp_actual_mode((ivts::ivts_ivt_msg_response__b4_resp_actual_mode)msg->_b4_resp_actual_mode);
			...
			proto_msg->set__b9_resp_device_current((ivts::ivts_ivt_msg_response__b9_resp_device_current)msg->_b9_resp_device_current);
			...
			proto_msg->set__b4_resp_startup_mode((ivts::ivts_ivt_msg_response__b4_resp_startup_mode)msg->_b4_resp_startup_mode);
			...
			proto_msg->set__b9_resp_device_voltage_chan((ivts::ivts_ivt_msg_response__b9_resp_device_voltage_chan)msg->_b9_resp_device_voltage_chan);
			proto_msg->set__ba_resp_sw_ver_vear(msg->_ba_resp_sw_ver_vear);
			proto_msg->set__b9_resp_device_toi((ivts::ivts_ivt_msg_response__b9_resp_device_toi)msg->_b9_resp_device_toi);
			proto_msg->set__ba_resp_sw_ver_month(msg->_ba_resp_sw_ver_month);
			proto_msg->set__b9_resp_device_com((ivts::ivts_ivt_msg_response__b9_resp_device_com)msg->_b9_resp_device_com);
			proto_msg->set__ba_resp_sw_ver_day(msg->_ba_resp_sw_ver_day);
			proto_msg->set__b9_resp_device_v_supply((ivts::ivts_ivt_msg_response__b9_resp_device_v_supply)msg->_b9_resp_device_v_supply);
        ...
        case 1317: {
            ivts_ivt_msg_result_t_converted_t* msg = (ivts_ivt_msg_result_t_converted_t*)(device->message);
            ivts::IVT_MSG_RESULT_T* proto_msg = pack->add_ivt_msg_result_t();
			proto_msg->set_ivt_id_result_t((ivts::ivts_ivt_msg_result_t_ivt_id_result_t)msg->ivt_id_result_t);
        ...
        case 1316: {
            ivts_ivt_msg_result_u3_t* msg = (ivts_ivt_msg_result_u3_t*)(device->message);
            ivts::IVT_MSG_RESULT_U3* proto_msg = pack->add_ivt_msg_result_u3();
			proto_msg->set_ivt_id_result_u3((ivts::ivts_ivt_msg_result_u3_ivt_id_result_u3)msg->ivt_id_result_u3);
        ...
        case 1315: {
            ivts_ivt_msg_result_u2_t* msg = (ivts_ivt_msg_result_u2_t*)(device->message);
            ivts::IVT_MSG_RESULT_U2* proto_msg = pack->add_ivt_msg_result_u2();
			proto_msg->set_ivt_id_result_u2((ivts::ivts_ivt_msg_result_u2_ivt_id_result_u2)msg->ivt_id_result_u2);
        ...
        case 1314: {
            ivts_ivt_msg_result_u1_t* msg = (ivts_ivt_msg_result_u1_t*)(device->message);
            ivts::IVT_MSG_RESULT_U1* proto_msg = pack->add_ivt_msg_result_u1();
			proto_msg->set_ivt_id_result_u1((ivts::ivts_ivt_msg_result_u1_ivt_id_result_u1)msg->ivt_id_result_u1);
        ...
        case 1313: {
            ivts_ivt_msg_result_i_t* msg = (ivts_ivt_msg_result_i_t*)(device->message);
            ivts::IVT_MSG_RESULT_I* proto_msg = pack->add_ivt_msg_result_i();
			proto_msg->set_ivt_id_result_i((ivts::ivts_ivt_msg_result_i_ivt_id_result_i)msg->ivt_id_result_i);
        ...
        case 1041: {
            ivts_ivt_msg_cmd_t* msg = (ivts_ivt_msg_cmd_t*)(device->message);
            ivts::IVT_MSG_CMD* proto_msg = pack->add_ivt_msg_cmd();
			proto_msg->set_ivt_id_cmd((ivts::ivts_ivt_msg_cmd_ivt_id_cmd)msg->ivt_id_cmd);
			...
			proto_msg->set__30_reset_item((ivts::ivts_ivt_msg_cmd__30_reset_item)msg->_30_reset_item);
			...
			proto_msg->set__3a_restart_to_bitrate((ivts::ivts_ivt_msg_cmd__3a_restart_to_bitrate)msg->_3a_restart_to_bitrate);
			...
			proto_msg->set__40_get_measerror_item((ivts::ivts_ivt_msg_cmd__40_get_measerror_item)msg->_40_get_measerror_item);
			proto_msg->set__41_get_systemerror_item((ivts::ivts_ivt_msg_cmd__41_get_systemerror_item)msg->_41_get_systemerror_item);
			proto_msg->set__42_get_alllogdata_item((ivts::ivts_ivt_msg_cmd__42_get_alllogdata_item)msg->_42_get_alllogdata_item);
			proto_msg->set__43_get_logdata_item((ivts::ivts_ivt_msg_cmd__43_get_logdata_item)msg->_43_get_logdata_item);
			...
			proto_msg->set__20_conf_triggermode_i((ivts::ivts_ivt_msg_cmd__20_conf_triggermode_i)msg->_20_conf_triggermode_i);
			proto_msg->set__21_conf_triggermode_u1((ivts::ivts_ivt_msg_cmd__21_conf_triggermode_u1)msg->_21_conf_triggermode_u1);
			proto_msg->set__22_conf_triggermode_u2((ivts::ivts_ivt_msg_cmd__22_conf_triggermode_u2)msg->_22_conf_triggermode_u2);
			proto_msg->set__23_conf_triggermode_u3((ivts::ivts_ivt_msg_cmd__23_conf_triggermode_u3)msg->_23_conf_triggermode_u3);
			proto_msg->set__24_conf_triggermode_t((ivts::ivts_ivt_msg_cmd__24_conf_triggermode_t)msg->_24_conf_triggermode_t);
			proto_msg->set__25_conf_triggermode_w((ivts::ivts_ivt_msg_cmd__25_conf_triggermode_w)msg->_25_conf_triggermode_w);
			proto_msg->set__26_conf_triggermode_as((ivts::ivts_ivt_msg_cmd__26_conf_triggermode_as)msg->_26_conf_triggermode_as);
			proto_msg->set__27_conf_triggermode_wh((ivts::ivts_ivt_msg_cmd__27_conf_triggermode_wh)msg->_27_conf_triggermode_wh);
			proto_msg->set__34_actual_mode((ivts::ivts_ivt_msg_cmd__34_actual_mode)msg->_34_actual_mode);
			...
			proto_msg->set__34_startup_mode((ivts::ivts_ivt_msg_cmd__34_startup_mode)msg->_34_startup_mode);
...
#endif // ivts_PROTO_INTERAFCE_IMPLEMENTATION

#endif // ivts_PROTO_INTERFACE_H
