...
wget -q "https://github.com/eagletrt/canutils/releases/download/$RELEASE/eagle_cansniffer_x86_64" -O eagle_cansniffer
chmod +x eagle_cansniffer

wget -q "https://github.com/eagletrt/canutils/releases/download/$RELEASE/eagle_candump_x86_64" -O eagle_candump
