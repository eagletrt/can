...
int secondary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1688: return SECONDARY_INTERVAL_FRONT_AMMO_COMPRESSION;
       case 1696: return SECONDARY_INTERVAL_REAR_AMMO_COMPRESSION;
       case 1704: return SECONDARY_INTERVAL_ACQUISINATOR_CALIBRATIONS_OFFSETS;
       case 1712: return SECONDARY_INTERVAL_ACQUISINATOR_ERRORS;
       case 1720: return SECONDARY_INTERVAL_LINK_DEFORMATION_DEBUG_VOLTAGES;
       case 1728: return SECONDARY_INTERVAL_LINK_DEFORMATION_FL_WHEEL;
       case 1736: return SECONDARY_INTERVAL_LINK_DEFORMATION_FR_WHEEL;
       case 1744: return SECONDARY_INTERVAL_LINK_DEFORMATION_RL_WHEEL;
       case 1752: return SECONDARY_INTERVAL_LINK_DEFORMATION_RR_WHEEL;
       case 1760: return SECONDARY_INTERVAL_DEBUG_SIGNAL_5;
       case 1768: return SECONDARY_INTERVAL_DEBUG_SIGNAL_6;
       case 1776: return SECONDARY_INTERVAL_DEBUG_SIGNAL_7;
...
int secondary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1688: return SECONDARY_INDEX_FRONT_AMMO_COMPRESSION;
       case 1696: return SECONDARY_INDEX_REAR_AMMO_COMPRESSION;
       case 1704: return SECONDARY_INDEX_ACQUISINATOR_CALIBRATIONS_OFFSETS;
       case 1712: return SECONDARY_INDEX_ACQUISINATOR_ERRORS;
       case 1720: return SECONDARY_INDEX_LINK_DEFORMATION_DEBUG_VOLTAGES;
       case 1728: return SECONDARY_INDEX_LINK_DEFORMATION_FL_WHEEL;
       case 1736: return SECONDARY_INDEX_LINK_DEFORMATION_FR_WHEEL;
       case 1744: return SECONDARY_INDEX_LINK_DEFORMATION_RL_WHEEL;
       case 1752: return SECONDARY_INDEX_LINK_DEFORMATION_RR_WHEEL;
       ...
       case 1760: return SECONDARY_INDEX_DEBUG_SIGNAL_5;
       case 1768: return SECONDARY_INDEX_DEBUG_SIGNAL_6;
       case 1776: return SECONDARY_INDEX_DEBUG_SIGNAL_7;
...
void secondary_watchdog_timeout(secondary_watchdog *watchdog, canlib_watchdog_timestamp timestamp) {
    ...
    if (
        CANLIB_BITTEST_ARRAY(watchdog->activated, SECONDARY_INDEX_FRONT_AMMO_COMPRESSION)
        && timestamp - watchdog->last_reset[SECONDARY_INDEX_FRONT_AMMO_COMPRESSION] > SECONDARY_INTERVAL_FRONT_AMMO_COMPRESSION * 3
    ) {
        CANLIB_BITSET_ARRAY(watchdog->timeout, SECONDARY_INDEX_FRONT_AMMO_COMPRESSION);
    }

    if (
        CANLIB_BITTEST_ARRAY(watchdog->activated, SECONDARY_INDEX_REAR_AMMO_COMPRESSION)
        && timestamp - watchdog->last_reset[SECONDARY_INDEX_REAR_AMMO_COMPRESSION] > SECONDARY_INTERVAL_REAR_AMMO_COMPRESSION * 3
    ) {
        CANLIB_BITSET_ARRAY(watchdog->timeout, SECONDARY_INDEX_REAR_AMMO_COMPRESSION);
    }
