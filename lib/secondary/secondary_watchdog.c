...
int secondary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1284: return SECONDARY_INTERVAL_CONTROL_STATE;
       case 259: return SECONDARY_INTERVAL_TIMESTAMP;
