...
int secondary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1656: return SECONDARY_INTERVAL_LINK_DEFORMATION_FL_WHEEL;
       case 1664: return SECONDARY_INTERVAL_LINK_DEFORMATION_FR_WHEEL;
       case 1672: return SECONDARY_INTERVAL_LINK_DEFORMATION_RL_WHEEL;
       case 1680: return SECONDARY_INTERVAL_LINK_DEFORMATION_RR_WHEEL;
       case 1688: return SECONDARY_INTERVAL_DEBUG_SIGNAL_1;
       case 1696: return SECONDARY_INTERVAL_DEBUG_SIGNAL_2;
       case 1704: return SECONDARY_INTERVAL_COOLING_TEMP_PUMPS;
       case 1712: return SECONDARY_INTERVAL_COOLING_TEMP_RADIATORS;
...
int secondary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1656: return SECONDARY_INDEX_LINK_DEFORMATION_FL_WHEEL;
       case 1664: return SECONDARY_INDEX_LINK_DEFORMATION_FR_WHEEL;
       ...
       case 1712: return SECONDARY_INDEX_COOLING_TEMP_RADIATORS;
