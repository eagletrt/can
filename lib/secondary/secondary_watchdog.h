...
#define SECONDARY_INTERVAL_ROD_ELONGATION 10
...
#define SECONDARY_INDEX_ROD_ELONGATION 29
#define SECONDARY_INDEX_DEBUG_SIGNAL 30
#define SECONDARY_INDEX_COOLING_TEMP 31
