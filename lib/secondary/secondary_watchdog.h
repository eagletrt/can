...
#define SECONDARY_INDEX_LINK_DEFORMATION_FL_WHEEL 100
#define SECONDARY_INDEX_LINK_DEFORMATION_FR_WHEEL 101
#define SECONDARY_INDEX_LINK_DEFORMATION_RL_WHEEL 102
#define SECONDARY_INDEX_LINK_DEFORMATION_RR_WHEEL 103
#define SECONDARY_INDEX_LINK_DEFORMATION_SET_CALIBRATION 104
#define SECONDARY_INDEX_AMMO_COMPRESSION_SET_CALIBRATION 105
#define SECONDARY_INDEX_DEBUG_SIGNAL_1 106
#define SECONDARY_INDEX_DEBUG_SIGNAL_2 107
#define SECONDARY_INDEX_COOLING_TEMP_PUMPS 108
#define SECONDARY_INDEX_COOLING_TEMP_RADIATORS 109
...
typedef struct {
    ...
    uint8_t timeout[14];
    canlib_watchdog_timestamp last_reset[110];
} secondary_watchdog;
