...
#define secondary_INTERVAL_WITH_THRESHOLD_IMU_ANGULAR_RATE (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IMU_ACCELERATION -1
#define secondary_INTERVAL_WITH_THRESHOLD_IMU_ACCELERATION (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FL_0 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FL_0 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FL_1 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FL_1 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FL_2 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FL_2 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FL_3 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FL_3 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FR_0 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FR_0 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FR_1 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FR_1 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FR_2 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FR_2 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_FR_3 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_FR_3 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RL_0 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RL_0 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RL_1 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RL_1 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RL_2 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RL_2 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RL_3 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RL_3 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RR_0 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RR_0 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RR_1 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RR_1 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RR_2 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RR_2 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_IRTS_RR_3 -1
#define secondary_INTERVAL_WITH_THRESHOLD_IRTS_RR_3 (-1 + CANLIB_INTERVAL_THRESHOLD)
#define secondary_INTERVAL_GPS_COORDS -1
#define secondary_INTERVAL_WITH_THRESHOLD_GPS_COORDS (-1 + CANLIB_INTERVAL_THRESHOLD)
...
static inline int secondary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
        ...
        case 1: return secondary_INTERVAL_TPMS;
    }
    return -1;
}
...
static inline int secondary_watchdog_index_from_id(canlib_message_id id) {
    switch (id) {
        ...
        case 1: return secondary_WATCHDOG_INDEX_TPMS;
    }
    return 25; // invalid
}
