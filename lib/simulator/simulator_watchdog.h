...
#define SIMULATOR_INTERVAL_FRONT_ANGULAR_VELOCITY 10
#define SIMULATOR_INTERVAL_DEBUG_SIGNAL_2 10
#define SIMULATOR_INTERVAL_INV_L_RCV 10
#define SIMULATOR_INTERVAL_INV_R_RCV 10
#define SIMULATOR_INTERVAL_AS_COMMANDS_STATUS 200
#define SIMULATOR_INTERVAL_AS_COMMANDS_SET_STATUS 200
#define SIMULATOR_INTERVAL_AS_COMMANDS_SET_VALUE 50
#define SIMULATOR_INTERVAL_VEHICLE_POSITION 10
#define SIMULATOR_INTERVAL_VEHICLE_SPEED 10
...
#define SIMULATOR_INDEX_FRONT_ANGULAR_VELOCITY 7
#define SIMULATOR_INDEX_DEBUG_SIGNAL_2 8
#define SIMULATOR_INDEX_INV_L_RCV 9
#define SIMULATOR_INDEX_INV_R_RCV 10
#define SIMULATOR_INDEX_AS_COMMANDS_STATUS 11
#define SIMULATOR_INDEX_AS_COMMANDS_SET_STATUS 12
#define SIMULATOR_INDEX_AS_COMMANDS_SET_VALUE 13
#define SIMULATOR_INDEX_VEHICLE_POSITION 14
#define SIMULATOR_INDEX_VEHICLE_SPEED 15
...
typedef struct {
    uint8_t activated[2];
    uint8_t timeout[2];
    canlib_watchdog_timestamp last_reset[16];
} simulator_watchdog;
