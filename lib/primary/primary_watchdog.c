...
int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 261: return PRIMARY_INTERVAL_SET_INVERTER_CONNECTION_STATUS;
...
int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 41: return PRIMARY_INDEX_HV_CAN_FORWARD_STATUS;
       case 777: return PRIMARY_INDEX_HV_FANS_OVERRIDE_STATUS;
       ...
       case 260: return PRIMARY_INDEX_STEER_STATUS;
       case 80: return PRIMARY_INDEX_SET_CAR_STATUS;
       case 1028: return PRIMARY_INDEX_SET_PEDAL_CALIBRATION;
       ...
       case 773: return PRIMARY_INDEX_SET_RADIATOR_SPEED;
       case 805: return PRIMARY_INDEX_SET_PUMPS_SPEED;
       case 261: return PRIMARY_INDEX_SET_INVERTER_CONNECTION_STATUS;
       ...
       case 521: return PRIMARY_INDEX_HV_CELLS_VOLTAGE;
       case 553: return PRIMARY_INDEX_HV_CELLS_TEMP;
       case 585: return PRIMARY_INDEX_HV_CELL_BALANCING_STATUS;
       ...
       case 545: return PRIMARY_INDEX_LC_RESET;
