...
int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 803: return PRIMARY_INTERVAL_LV_STATUS;
       ...
       case 297: return PRIMARY_INTERVAL_LV_HEALTH_SIGNALS;
       case 329: return PRIMARY_INTERVAL_LV_FEEDBACKS;
       case 361: return PRIMARY_INTERVAL_SHUTDOWN_STATUS;
       case 1859: return PRIMARY_INTERVAL_LV_CAN_FLASH_ACK;
...
int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 777: return PRIMARY_INDEX_HV_FEEDBACKS_STATUS;
       case 809: return PRIMARY_INDEX_HV_IMD_STATUS;
       ...
       case 771: return PRIMARY_INDEX_ECU_FEEDBACKS;
       case 803: return PRIMARY_INDEX_LV_STATUS;
       case 841: return PRIMARY_INDEX_LV_CURRENTS;
       case 873: return PRIMARY_INDEX_LV_CELLS_VOLTAGE;
       case 905: return PRIMARY_INDEX_LV_TOTAL_VOLTAGE;
       case 937: return PRIMARY_INDEX_LV_CELLS_TEMP;
       case 969: return PRIMARY_INDEX_COOLING_STATUS;
       ...
       case 265: return PRIMARY_INDEX_INVERTER_CONNECTION_STATUS;
       case 521: return PRIMARY_INDEX_LV_ERRORS;
       case 297: return PRIMARY_INDEX_LV_HEALTH_SIGNALS;
       case 329: return PRIMARY_INDEX_LV_FEEDBACKS;
       case 361: return PRIMARY_INDEX_SHUTDOWN_STATUS;
       case 1827: return PRIMARY_INDEX_LV_CAN_FLASH_REQ;
       case 1859: return PRIMARY_INDEX_LV_CAN_FLASH_ACK;
       case 35: return PRIMARY_INDEX_MARKER;
       ...
       case 553: return PRIMARY_INDEX_SET_PTT_STATUS;
       case 585: return PRIMARY_INDEX_PTT_STATUS;
