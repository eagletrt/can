...
int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1320: return PRIMARY_INDEX_IVT_MSG_RESULT_WH;
       case 1319: return PRIMARY_INDEX_IVT_MSG_RESULT_AS;
       case 1318: return PRIMARY_INDEX_IVT_MSG_RESULT_W;
       case 1297: return PRIMARY_INDEX_IVT_MSG_RESPONSE;
       case 1317: return PRIMARY_INDEX_IVT_MSG_RESULT_T;
       case 1316: return PRIMARY_INDEX_IVT_MSG_RESULT_U3;
       case 1315: return PRIMARY_INDEX_IVT_MSG_RESULT_U2;
       case 1314: return PRIMARY_INDEX_IVT_MSG_RESULT_U1;
       case 1313: return PRIMARY_INDEX_IVT_MSG_RESULT_I;
       case 1041: return PRIMARY_INDEX_IVT_MSG_CMD;
...
void primary_watchdog_reset(primary_watchdog *watchdog, canlib_message_id id, canlib_watchdog_timestamp timestamp) {
    ...
    if (index < 159 && CANLIB_BITTEST_ARRAY(watchdog->activated, index)) {
