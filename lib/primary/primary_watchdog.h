...
static int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 545: return PRIMARY_INTERVAL_SPEED;
...
static int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 262: return PRIMARY_INDEX_SET_TLM_STATUS;
       case 257: return PRIMARY_INDEX_TLM_STATUS;
       case 1798: return PRIMARY_INDEX_STEER_SYSTEM_STATUS;
       ...
       case 1025: return PRIMARY_INDEX_PEDAL_CALIBRATION_ACK;
       case 81: return PRIMARY_INDEX_CAR_STATUS;
       case 33: return PRIMARY_INDEX_DAS_ERRORS;
       ...
       case 1830: return PRIMARY_INDEX_LV_CAN_FLASH_REQ;
       case 1862: return PRIMARY_INDEX_LV_CAN_FLASH_ACK;
       case 38: return PRIMARY_INDEX_MARKER;
       ...
       case 545: return PRIMARY_INDEX_SPEED;
       ...
       case 289: return PRIMARY_INDEX_CONTROL_OUTPUT;
       case 515: return PRIMARY_INDEX_LC_RESET;
       case 773: return PRIMARY_INDEX_HANDCART_STATUS;
       case 805: return PRIMARY_INDEX_HANDCART_SETTINGS;
       case 837: return PRIMARY_INDEX_HANDCART_SETTINGS_SET;
