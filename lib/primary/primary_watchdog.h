...
static int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1793: return PRIMARY_INTERVAL_STEER_SYSTEM_STATUS;
       case 776: return PRIMARY_INTERVAL_HV_VOLTAGE;
       case 808: return PRIMARY_INTERVAL_HV_CURRENT;
       case 840: return PRIMARY_INTERVAL_HV_TEMP;
       case 40: return PRIMARY_INTERVAL_HV_ERRORS;
       ...
       case 1857: return PRIMARY_INTERVAL_LV_CAN_FLASH_ACK;
       ...
       case 521: return PRIMARY_INTERVAL_SPEED;
...
static int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 262: return PRIMARY_INDEX_TIMESTAMP;
       case 294: return PRIMARY_INDEX_AMBIENT_TEMPERATURE;
       case 1072: return PRIMARY_INDEX_DATA_LOGGER;
       case 257: return PRIMARY_INDEX_SET_TLM_STATUS;
       case 265: return PRIMARY_INDEX_TLM_STATUS;
       case 1793: return PRIMARY_INDEX_STEER_SYSTEM_STATUS;
       case 776: return PRIMARY_INDEX_HV_VOLTAGE;
       case 808: return PRIMARY_INDEX_HV_CURRENT;
       case 840: return PRIMARY_INDEX_HV_TEMP;
       case 40: return PRIMARY_INDEX_HV_ERRORS;
       case 39: return PRIMARY_INDEX_HV_FANS_OVERRIDE;
       ...
       case 1033: return PRIMARY_INDEX_PEDAL_CALIBRATION_ACK;
       case 81: return PRIMARY_INDEX_CAR_STATUS;
       case 41: return PRIMARY_INDEX_DAS_ERRORS;
       ...
       case 1825: return PRIMARY_INDEX_LV_CAN_FLASH_REQ;
       case 1857: return PRIMARY_INDEX_LV_CAN_FLASH_ACK;
       case 33: return PRIMARY_INDEX_MARKER;
       ...
       case 519: return PRIMARY_INDEX_SET_CELL_BALANCING_STATUS;
       case 521: return PRIMARY_INDEX_SPEED;
       ...
       case 297: return PRIMARY_INDEX_CONTROL_OUTPUT;
       case 516: return PRIMARY_INDEX_LC_RESET;
       case 775: return PRIMARY_INDEX_HANDCART_STATUS;
       case 807: return PRIMARY_INDEX_HANDCART_SETTINGS;
       case 839: return PRIMARY_INDEX_HANDCART_SETTINGS_SET;
