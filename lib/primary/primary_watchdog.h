...
#define PRIMARY_INDEX_ECU_FEEDBACKS 62
#define PRIMARY_INDEX_LV_STATUS 63
#define PRIMARY_INDEX_LV_CURRENTS 64
#define PRIMARY_INDEX_LV_CELLS_VOLTAGE 65
#define PRIMARY_INDEX_LV_TOTAL_VOLTAGE 66
#define PRIMARY_INDEX_LV_CELLS_TEMP 67
#define PRIMARY_INDEX_COOLING_STATUS 68
#define PRIMARY_INDEX_SET_RADIATOR_SPEED 69
#define PRIMARY_INDEX_SET_PUMPS_SPEED 70
#define PRIMARY_INDEX_SET_INVERTER_CONNECTION_STATUS 71
#define PRIMARY_INDEX_INVERTER_CONNECTION_STATUS 72
#define PRIMARY_INDEX_LV_ERRORS 73
#define PRIMARY_INDEX_LV_HEALTH_SIGNALS 74
#define PRIMARY_INDEX_LV_FEEDBACKS 75
#define PRIMARY_INDEX_SHUTDOWN_STATUS 76
#define PRIMARY_INDEX_LV_CAN_FLASH_REQ 77
#define PRIMARY_INDEX_LV_CAN_FLASH_ACK 78
#define PRIMARY_INDEX_MARKER 79
#define PRIMARY_INDEX_HV_CELLS_VOLTAGE 80
#define PRIMARY_INDEX_HV_CELLS_TEMP 81
#define PRIMARY_INDEX_HV_CELL_BALANCING_STATUS 82
#define PRIMARY_INDEX_SET_CELL_BALANCING_STATUS 83
#define PRIMARY_INDEX_SPEED 84
#define PRIMARY_INDEX_INV_L_REQUEST 85
#define PRIMARY_INDEX_INV_R_REQUEST 86
#define PRIMARY_INDEX_INV_L_RESPONSE 87
#define PRIMARY_INDEX_INV_R_RESPONSE 88
#define PRIMARY_INDEX_CONTROL_OUTPUT 89
#define PRIMARY_INDEX_LC_RESET 90
#define PRIMARY_INDEX_HANDCART_STATUS 91
#define PRIMARY_INDEX_HANDCART_SETTINGS 92
#define PRIMARY_INDEX_HANDCART_SETTINGS_SET 93
#define PRIMARY_INDEX_SET_PTT_STATUS 94
#define PRIMARY_INDEX_PTT_STATUS 95
...
typedef struct {
    ...
    uint8_t timeout[12];
    canlib_watchdog_timestamp last_reset[96];
} primary_watchdog;
...
static int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 256: return PRIMARY_INTERVAL_TIMESTAMP;
       case 288: return PRIMARY_INTERVAL_AMBIENT_TEMPERATURE;
       case 1072: return PRIMARY_INTERVAL_DATA_LOGGER;
       case 263: return PRIMARY_INTERVAL_TLM_STATUS;
       ...
       case 257: return PRIMARY_INTERVAL_STEER_STATUS;
       case 81: return PRIMARY_INTERVAL_CAR_STATUS;
       case 39: return PRIMARY_INTERVAL_DAS_ERRORS;
       case 777: return PRIMARY_INTERVAL_LV_STATUS;
       ...
       case 294: return PRIMARY_INTERVAL_LV_HEALTH_SIGNALS;
       case 326: return PRIMARY_INTERVAL_LV_FEEDBACKS;
       case 358: return PRIMARY_INTERVAL_SHUTDOWN_STATUS;
       case 1865: return PRIMARY_INTERVAL_LV_CAN_FLASH_ACK;
       case 546: return PRIMARY_INTERVAL_HV_CELLS_VOLTAGE;
       case 578: return PRIMARY_INTERVAL_HV_CELLS_TEMP;
       case 610: return PRIMARY_INTERVAL_HV_CELL_BALANCING_STATUS;
       case 519: return PRIMARY_INTERVAL_SPEED;
       ...
       case 295: return PRIMARY_INTERVAL_CONTROL_OUTPUT;
...
static int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 256: return PRIMARY_INDEX_TIMESTAMP;
       case 288: return PRIMARY_INDEX_AMBIENT_TEMPERATURE;
       case 1072: return PRIMARY_INDEX_DATA_LOGGER;
       case 265: return PRIMARY_INDEX_SET_TLM_STATUS;
       case 263: return PRIMARY_INDEX_TLM_STATUS;
       ...
       case 34: return PRIMARY_INDEX_HV_CAN_FORWARD_STATUS;
       case 770: return PRIMARY_INDEX_HV_FANS_OVERRIDE_STATUS;
       case 774: return PRIMARY_INDEX_HV_FEEDBACKS_STATUS;
       case 806: return PRIMARY_INDEX_HV_IMD_STATUS;
       ...
       case 257: return PRIMARY_INDEX_STEER_STATUS;
       case 80: return PRIMARY_INDEX_SET_CAR_STATUS;
       case 1025: return PRIMARY_INDEX_SET_PEDAL_CALIBRATION;
       case 1031: return PRIMARY_INDEX_PEDAL_CALIBRATION_ACK;
       case 81: return PRIMARY_INDEX_CAR_STATUS;
       case 39: return PRIMARY_INDEX_DAS_ERRORS;
       case 80: return PRIMARY_INDEX_ECU_FEEDBACKS;
       case 777: return PRIMARY_INDEX_LV_STATUS;
       case 838: return PRIMARY_INDEX_LV_CURRENTS;
       case 870: return PRIMARY_INDEX_LV_CELLS_VOLTAGE;
       case 902: return PRIMARY_INDEX_LV_TOTAL_VOLTAGE;
       case 934: return PRIMARY_INDEX_LV_CELLS_TEMP;
       case 966: return PRIMARY_INDEX_COOLING_STATUS;
       ...
       case 262: return PRIMARY_INDEX_INVERTER_CONNECTION_STATUS;
       case 518: return PRIMARY_INDEX_LV_ERRORS;
       case 294: return PRIMARY_INDEX_LV_HEALTH_SIGNALS;
       case 326: return PRIMARY_INDEX_LV_FEEDBACKS;
       case 358: return PRIMARY_INDEX_SHUTDOWN_STATUS;
       ...
       case 546: return PRIMARY_INDEX_HV_CELLS_VOLTAGE;
       case 578: return PRIMARY_INDEX_HV_CELLS_TEMP;
       case 610: return PRIMARY_INDEX_HV_CELL_BALANCING_STATUS;
       case 520: return PRIMARY_INDEX_SET_CELL_BALANCING_STATUS;
       case 519: return PRIMARY_INDEX_SPEED;
       ...
       case 295: return PRIMARY_INDEX_CONTROL_OUTPUT;
       case 515: return PRIMARY_INDEX_LC_RESET;
       ...
       case 550: return PRIMARY_INDEX_SET_PTT_STATUS;
       case 582: return PRIMARY_INDEX_PTT_STATUS;
