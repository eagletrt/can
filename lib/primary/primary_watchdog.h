...
static int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 67: return PRIMARY_INTERVAL_TS_STATUS;
...
static int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1032: return PRIMARY_INDEX_STEER_VERSION;
       case 1064: return PRIMARY_INDEX_DAS_VERSION;
       case 1096: return PRIMARY_INDEX_HV_VERSION;
       case 1128: return PRIMARY_INDEX_LV_VERSION;
       case 1160: return PRIMARY_INDEX_TLM_VERSION;
       ...
       case 67: return PRIMARY_INDEX_TS_STATUS;
       ...
       case 768: return PRIMARY_INDEX_SET_CAR_STATUS;
       case 1024: return PRIMARY_INDEX_SET_PEDALS_RANGE;
       case 1056: return PRIMARY_INDEX_SET_STEERING_ANGLE_RANGE;
