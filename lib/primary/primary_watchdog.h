...
#define PRIMARY_INDEX_SET_PEDALS_CALIBRATION 58
#define PRIMARY_INDEX_PEDALS_CALIBRATION_ACK 59
...
static int primary_watchdog_index_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 1032: return PRIMARY_INDEX_SET_PEDALS_CALIBRATION;
       case 1033: return PRIMARY_INDEX_PEDALS_CALIBRATION_ACK;
