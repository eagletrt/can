...
static int primary_watchdog_interval_from_id(uint16_t message_id) {
    switch (message_id) {
       ...
       case 72: return PRIMARY_INTERVAL_SET_TS_STATUS_DAS;
       case 104: return PRIMARY_INTERVAL_SET_TS_STATUS_HANDCART;
       ...
       case 291: return PRIMARY_INTERVAL_LV_FEEDBACKS;
       case 323: return PRIMARY_INTERVAL_SHUTDOWN_STATUS;
