...
std::vector<std::string> primary_enum_fields_from_message(const std::string& msg_name)
{
	...
	if(msg_name == HV_FEEDBACK_STATUS) {
		ret.push_back("airn_open_com");
		ret.push_back("precharge_open_com");
		ret.push_back("airp_open_com");
		ret.push_back("airn_open_mec");
		ret.push_back("precharge_open_mec");
		ret.push_back("airp_open_mec");
		ret.push_back("sd_imd_fb");
		ret.push_back("sd_bms_fb");
		ret.push_back("ts_less_than_60v");
		ret.push_back("plausible_state_persisted");
		ret.push_back("plausible_state");
		ret.push_back("not_bms_fault_cockpit_led");
		ret.push_back("not_imd_fault_cockpit_led");
		ret.push_back("indicator_connected");
		ret.push_back("not_latch_reset");
		ret.push_back("plausible_state_latched");
		ret.push_back("not_bms_fault_latched");
		ret.push_back("not_imd_fault_latched");
		ret.push_back("not_ext_fault_latched");
		ret.push_back("imd_ok");
		ret.push_back("plausible_state_rc");
		ret.push_back("tsal_green");
		ret.push_back("probing_3v3");
		ret.push_back("sd_out");
		ret.push_back("sd_in");
		ret.push_back("sd_end");
		ret.push_back("v5_mcu");
	...
	if(msg_name == HV_IMD_STATUS) {
		...
		ret.push_back("feedback_not_imd_fault_cockpit_led");
		ret.push_back("feedback_not_imd_fault_latched");
	...
	if(msg_name == HV_FLASH_REQUEST) {
		ret.push_back("mainboard");
		ret.push_back("cellboard_id");
	}
	if(msg_name == HV_FLASH_RESPONSE) {
		ret.push_back("ready");
	}
	if(msg_name == HV_CELLS_TEMPERATURE) {
		ret.push_back("cellboard_id");
	}
	if(msg_name == HV_DISCHARGE_TEMPERATURE) {
		ret.push_back("cellboard_id");
	}
	if(msg_name == HV_FEEDBACK_DIGITAL) {
		ret.push_back("digital_airn_open_com");
		ret.push_back("digital_airp_open_com");
		ret.push_back("digital_sd_imd_fb");
		ret.push_back("digital_sd_bms_fb");
		ret.push_back("digital_precharge_open_com");
		ret.push_back("digital_precharge_open_mec");
		ret.push_back("digital_ts_less_than_60v");
		ret.push_back("digital_plausible_state_persisted");
		ret.push_back("digital_plausible_state");
		ret.push_back("digital_not_bms_fault_cockpit_led");
		ret.push_back("digital_not_imd_fault_cockpit_led");
		ret.push_back("digital_indicator_connected");
		ret.push_back("digital_not_latch_reset");
		ret.push_back("digital_plausible_state_latched");
		ret.push_back("digital_not_bms_fault_latched");
		ret.push_back("digital_not_imd_fault_latched");
		ret.push_back("digital_not_ext_fault_latched");
	}
	if(msg_name == HV_FEEDBACK_ENZOMMA) {
		ret.push_back("feedback");
		ret.push_back("status");
		ret.push_back("is_digital");
		ret.push_back("digital");
	}
	if(msg_name == HV_ERROR) {
		ret.push_back("group");
		ret.push_back("cellboard_id");
		ret.push_back("cellboard_group");
	}
...
std::vector<std::string> primary_enum_names_from_fields(const std::string& msg_name, const std::string& sgn_name)
{
	...
	if(msg_name == HV_FEEDBACK_STATUS)
	{
		...
		if(sgn_name == "precharge_open_com")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "precharge_open_mec")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "plausible_state_persisted")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "not_bms_fault_cockpit_led")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "not_imd_fault_cockpit_led")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "indicator_connected")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "plausible_state_latched")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "not_bms_fault_latched")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "not_imd_fault_latched")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "not_ext_fault_latched")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "plausible_state_rc")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
	...
	if(msg_name == HV_IMD_STATUS)
	{
		...
		if(sgn_name == "feedback_not_imd_fault_cockpit_led")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
		...
		if(sgn_name == "feedback_not_imd_fault_latched")
		{
			ret.push_back("low");
			ret.push_back("error");
			ret.push_back("high");
	...
	if(msg_name == HV_STATUS)
	{
		if(sgn_name == "status")
		{
			...
			ret.push_back("airn_check");
			ret.push_back("precharge_check");
			ret.push_back("airp_check");
			ret.push_back("ts_on");
			return ret;
		}
		if(sgn_name == "cellboard_0")
		{
			ret.push_back("init");
			ret.push_back("idle");
			ret.push_back("fatal");
	...
	if(msg_name == HV_ERROR)
	{
		...
		{
			ret.push_back("post");
			ret.push_back("over_current");
			ret.push_back("over_power");
			ret.push_back("under_voltage");
			ret.push_back("over_voltage");
			ret.push_back("under_temperature");
			ret.push_back("over_temperature");
			ret.push_back("can_communication");
			ret.push_back("current_sensor_communication");
			ret.push_back("cooling_under_temperature");
			ret.push_back("cooling_over_temperature");
			ret.push_back("cellboard_error");
			return ret;
		}
		if(sgn_name == "cellboard_id")
		{
