...
#define primary_STEER_SYSTEM_STATUS_INTERVAL 1000
#define primary_HV_VOLTAGE_INTERVAL 10
#define primary_HV_CURRENT_INTERVAL 10
#define primary_HV_TEMP_INTERVAL 100
#define primary_HV_ERRORS_INTERVAL 10
#define primary_HV_CAN_FORWARD_INTERVAL -1
#define primary_HV_CAN_FORWARD_STATUS_INTERVAL -1
#define primary_TS_STATUS_INTERVAL 10
...
#define primary_DAS_ERRORS_INTERVAL 10
#define primary_LV_CURRENT_INTERVAL 500
#define primary_LV_VOLTAGE_INTERVAL 100
#define primary_LV_TOTAL_VOLTAGE_INTERVAL 100
...
#define primary_HV_CELLS_VOLTAGE_INTERVAL 100
...
#define primary_INV_L_REQUEST_INTERVAL 10
#define primary_INV_R_REQUEST_INTERVAL 10
#define primary_INV_L_RESPONSE_INTERVAL 100
#define primary_INV_R_RESPONSE_INTERVAL 100
...
int primary_watchdog_interval_from_id(uint16_t message_id) {
    ...
    case 386:
        return primary_INV_R_RESPONSE_INTERVAL;
    case 16:
...
void primary_watchdog_timeout(primary_watchdog *watchdog, canlib_watchdog_timestamp timestamp) {
    ...
    if (
        ...
        && timestamp - watchdog->last_reset[primary_watchdog_index_INV_L_REQUEST] > primary_INV_L_REQUEST_INTERVAL
    ) {
    ...
    if (
        ...
        && timestamp - watchdog->last_reset[primary_watchdog_index_INV_R_REQUEST] > primary_INV_R_REQUEST_INTERVAL
    ) {
    ...
    if (
        ...
        && timestamp - watchdog->last_reset[primary_watchdog_index_INV_R_RESPONSE] > primary_INV_R_RESPONSE_INTERVAL
    ) {
