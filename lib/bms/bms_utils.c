...
int bms_enum_fields_from_name(const char *msg_name, const char *sgn_name, char **v)
{
	...
	if(!strcmp(msg_name, "CELLBOARD_FLASH"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "CELLBOARD_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_FLASH_REQUEST"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "cellboard_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_FLASH_RESPONSE"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "cellboard_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_DISCOVERY"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "cellboard_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_STATUS"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "cellboard_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_CELLS_VOLTAGE"))
	{
		if(!strcmp(sgn_name, "cellboard_id"))
		{
			sprintf(v[0], "cellboard_0");
	...
	if(!strcmp(msg_name, "CELLBOARD_BALANCING_STATUS"))
	{
		if(!strcmp(sgn_name, "status"))
		{
			sprintf(v[0], "stopped");
