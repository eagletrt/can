...
#define BMS_INDEX_CELLBOARD_FLASH 17
#define BMS_INDEX_CELLBOARD_FLASH_TX 18
#define BMS_INDEX_CELLBOARD_FLASH_RX 19
#define BMS_INDEX_CELLBOARD_FLASH_REQUEST 20
#define BMS_INDEX_CELLBOARD_FLASH_RESPONSE 21
#define BMS_INDEX_CELLBOARD_DISCOVERY 22
#define BMS_INDEX_CELLBOARD_VERSION 23
#define BMS_INDEX_CELLBOARD_STATUS 24
#define BMS_INDEX_CELLBOARD_CELLS_VOLTAGE 25
#define BMS_INDEX_CELLBOARD_CELLS_TEMPERATURE 26
#define BMS_INDEX_CELLBOARD_DISCHARGE_TEMPERATURE 27
#define BMS_INDEX_CELLBOARD_SET_BALANCING_STATUS 28
#define BMS_INDEX_CELLBOARD_BALANCING_STATUS 29
#define BMS_INDEX_CELLBOARD_ERROR 30
...
typedef struct {
    uint8_t activated[4];
    uint8_t timeout[4];
    canlib_watchdog_timestamp last_reset[31];
} bms_watchdog;
